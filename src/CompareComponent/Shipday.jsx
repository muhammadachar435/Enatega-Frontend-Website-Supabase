...
function Shipday() {
  ...
  return (
    ...
    <>
      ...
      {/* Content Start  */}
      <div className="sm:mt-26 desktop:mt-33 relative w-full sm:h-[530px]  mymob:h-[510px]  myiphone:h-[430px] tablet:h-[400px]  desktop:h-[380px] iox:h-[370px]">
        <img
          src="/Pictures/ShipdaybgColor.jpg"
          alt=""
          className="w-full sm:h-[530px]  mymob:h-[510px]  myiphone:h-[430px] tablet:h-[400px]  desktop:h-[380px] iox:h-[370px]"
        />
        <div className="absolute sm:px-[20px] tablet:pb-10 desktop:pb-6 mymob:px-[15px] tablet:px-[20px] desktop:px-8 iox:px-4 sm:w-[290px] mymob:w-[355px] myiphone:w-[420px] tablet:w-[728px] desktop:w-[964px] iox:w-[1150px] h-auto font-inter text-[#1A1D1E] iox:left-1/2 iox:-translate-x-1/2 top-1/2 -translate-y-1/2">
          ...
          <p className="sm:text-[32px] font-inter  sm:pt-3 desktop:pt-7 mymob:text-[33.5px] myiphone:text-[34.5px] tablet:text-[39px] desktop:text-[43.5px] iox:text-[50px] font-bold sm:leading-10 tablet:leading-11 desktop:leading-13.5 desktop:w-[964px] iox:w-[1140px] ">
            Enatega VS Shipday
          </p>
          ...
          <p className="sm:text-base tablet:text-[16.5px] font-[400] sm:my-1 desktop:w-[94%] iox:w-[88%]">
            {" "}
            When it comes to managing on-demand deliveries, finding the right
            software can make all the difference. In this comparison, we explore
            how Enatega and Shipday stack up to help you determine if Enatega is
            the alternative to Shipday that best meets your business needs
          </p>
        </div>
      </div>
      ...
      >
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 ">
          ...
          <p className="text-white mt-4 font-[400] font-inter sm:text-base tablet:text-[17px] sm:w-[240px] mymob:w-[300px] myiphone:w-[370px] tablet:w-[690px] desktop:w-[850px] iox:w-[1010px] px-2">
            Enatega is a versatile, fully customizable delivery platform
            designed to support diverse service sectors. With options for food,
            grocery, courier, and more, Enatega enables businesses to create
            tailored, branded experiences.
          </p>
          <p className="text-white mt-4 font-[400] font-inter sm:text-base tablet:text-[17px] sm:w-[240px] mymob:w-[300px] myiphone:w-[370px] tablet:w-[660px] desktop:w-[850px] iox:w-[1010px] px-2">
            Shipday, on the other hand, is a delivery management solution
            focused on real-time tracking and efficient dispatching for local
            businesses. While it offers quick setup options, customization is
            limited, making it ideal for straightforward delivery operations
            rather than complex, multi-service models.
          </p>
        </div>
      </motion.div>

      {/* Feature Comparison of Enatega and Shipday */}
          ...
          <div className="sm:overflow-x-auto tablet:overflow-none mt-10 pb-10 bg-white w-full max-w-[1140px] mx-auto rounded-xl">
            <table className="mx-8 text-base">
              ...
              <tr className=" border-b border-[#f3f3f3]">
                ...
                <td className="text-center py-5 px-6 text-[#222222] font-inter">
                  {" "}
                  Extensive customization for diverse services
                </td>
                <td className="text-center py-5 px-6 text-[#222222] font-inter">
              ...
              <tr className=" border-b border-[#f3f3f3]">
                ...
                <td className="text-center py-5 px-6 text-[#222222] font-inter">
                  {" "}
                  Fully white-labeled for brand control
                </td>
                <td className="text-center py-5 px-6 text-[#222222] font-inter">
                  Partially white-labeled
                </td>
              </tr>
              {/* 4rd row */}
              <tr className=" border-b border-[#f3f3f3]">
                ...
                <td className="text-center py-5 px-6 text-[#222222] font-inter">
                  {" "}
                  Advanced tracking with flexible options
                </td>
                <td className="text-center py-5 px-6 text-[#222222] font-inter">
                  Real-time tracking and efficient dispatch
                </td>
              </tr>
              {/* 5th row */}
              <tr className=" border-b border-[#f3f3f3]">
                ...
                <td className="text-center py-5 px-6 text-[#222222] font-inter">
                  {" "}
                  Multiple gateways with custom API compatibility
                </td>
                <td className="text-center py-5 px-6 text-[#222222] font-inter">
              ...
              <tr className=" border-b border-[#f3f3f3]">
                ...
                <td className="text-center py-5 px-6 text-[#222222] font-inter">
                  {" "}
                  Personalized support for onboarding and scaling
                </td>
                <td className="text-center py-5 px-6 text-[#222222] font-inter">
      ...
      {/* End Key Differences Between Enatega and ShipDay*/}

      {/*Section Why Enatega is an Ideal Alternative to Shipday*/}
      ...
      <div className="sm:my-10 desktop:my-16 sm:w-[280px] mymob:w-[335px] myiphone:w-[385px] h-auto tablet:w-[728px] desktop:w-[964px] iox:w-[1140px] mx-auto rounded-xl  ">
        ...
        >
          ...
          <p className="text-[#222222] sm:mt-2 tablet:mt-5 font-[400] font-inter sm:text-base tablet:text-[17px]    desktop:w-[800px] iox:w-[950px] mx-auto leading-[1.3rem]">
            Enatega’s extensive customization options and wide-ranging service
            applications make it a leading shipday alternative solution for
            businesses looking for a customizable shipday alternative app.
            Whether you need a white label shipday alternative app or an
            on-demand shipday alternative app that supports complex service
            requirements, Enatega’s flexibility and robust feature set are
            valuable assets.
          </p>
        </motion.div>
        <motion.div
        ...
        >
          ...
          <ul className="list-decimal my-6 desktop:w-[800px] iox:w-[950px] mx-auto px-8">
            ...
            <p className="text-[#222222] font-inter sm:text-[14px] mymob:text-base">
              Unlike Shipday, which is optimized for single-service delivery
              models, Enatega supports multiple industries, allowing businesses
              to expand their offerings seamlessly. This versatility makes
              Enatega a perfect choice for companies looking for apps like
              Shipday but with multi-service support.
            </p>
            <li className="font-bold font-inter text-[#1A1D1E] sm:text-[14px] mymob:text-base leading-5">
              Branding and User Experience Control
            </li>
            <p className="text-[#222222] font-inter sm:text-[14px] mymob:text-base">
              Enatega’s white-label options offer full control over branding and
              user interface design, ensuring a seamless brand experience for
              users. This makes Enatega an ideal alternative for Shipday for
              businesses that need more comprehensive branding capabilities.
            </p>
            <li className="font-bold font-inter text-[#1A1D1E] sm:text-[14px] mymob:text-base leading-5">
              Enhanced Payment and Tracking Options
            </li>
            <p className="text-[#222222] font-inter sm:text-[14px] mymob:text-base">
              While Shipday provides real-time tracking, Enatega offers more
              adaptable tracking features and multiple payment gateways,
              allowing businesses to create a streamlined customer experience
              that fits their specific market needs. This payment flexibility
              makes Enatega a top shipday similar solution with additional
              benefits.
            </p>
            <li className="font-bold font-inter text-[#1A1D1E] sm:text-[14px] mymob:text-base leading-5">
            ...
            <p className="text-[#222222] font-inter sm:text-[14px] mymob:text-base">
              Enatega provides personalized support for onboarding and
              scalability, designed to grow with your business. For companies
              aiming to expand, Enatega is an excellent shipday alternative app
              that supports business growth effectively.
            </p>
          </ul>
        </motion.div>
      </div>
      ...
      {/* Section  "Why Enatega Stands Out Among Shipday Competitors?" */}
      <div className="mx-auto relative  my-2 ">
        <img
          src="/Pictures/giftbgimg.jpg"
          alt=""
          className="sm:w-[280px] mymob:w-[335px] myiphone:w-[385px] sm:h-[440px] mymob:h-[400px] myiphone:h-[340px] tablet:w-[728px] tablet:h-[270px] desktop:h-[250px] desktop:w-[964px] iox:w-[1100px] mx-auto rounded-xl "
        />
        <motion.div
          variants={fadeIn("up", 0.2, "in")}
          initial="hidden"
        ...
        >
          ...
          <p className="text-[#222222] sm:mt-2 tablet:mt-3 font-[400] font-inter sm:text-base tablet:text-[17px] sm:w-[250px]  mymob:w-[305px]  myiphone:w-[355px] tablet:w-[699px]  desktop:w-[850px] iox:w-[1000px] mx-auto leading-[1.3rem]">
            For businesses seeking a customizable Shipday alternative app with
            expansive options for branding, user control, and industry
            versatility, Enatega offers an unmatched experience. With a flexible
            architecture and comprehensive support, Enatega is an ideal choice
            for businesses ready to innovate in the on-demand delivery space.
          </p>
        </motion.div>
      </div>
      {/*  End */}
