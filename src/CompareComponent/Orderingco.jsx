  ...
  return (
    ...
    <>
      ...
      <div className="sm:mt-26 desktop:mt-33 relative w-full sm:h-[480px]  mymob:h-[440px]  myiphone:h-[400px] tablet:h-[350px]  desktop:h-[370px] iox:h-[340px]">
        <img
          src="/Pictures/OrderingCobgColor.jpg"
          alt=""
        ...
        <div className="absolute sm:px-[20px] tablet:pb-10 desktop:pb-6 mymob:px-[15px] tablet:px-[20px] desktop:px-8 iox:px-4 sm:w-[290px] mymob:w-[355px] myiphone:w-[420px] tablet:w-[728px] desktop:w-[964px] iox:w-[1150px] h-auto font-inter text-[#1A1D1E] iox:left-1/2 iox:-translate-x-1/2 top-1/2 -translate-y-1/2">
          <div className="flex items-center space-x-1 w-full max-w-[300px] ">
            ...
            <div>
              <img
                src="/Pictures/Ordering.Co-logo.png"
                alt=""
                className="w-20 h-20"
              />
            </div>
          ...
          <p className="sm:text-base tablet:text-[16.5px] font-[400] sm:my-1 desktop:w-[94%] iox:w-[88%]">
            {" "}
            In the fast-growing on-demand delivery market, selecting the right
            software can set your business apart. This comparison explores
            Enatega and Ordering.co to help you identify the best ordering.co
            alternative for your unique business needs.
          </p>
        </div>
      </div>
      ...
      >
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 ">
          ...
          <p className="text-white mt-4 font-[400] font-inter sm:text-base tablet:text-[17px] sm:w-[240px] mymob:w-[300px] myiphone:w-[370px] tablet:w-[690px] desktop:w-[850px] iox:w-[1010px] px-2">
            Enatega is a robust, fully customizable white-label platform,
            supporting diverse delivery services. With flexibility at its core,
            Enatega enables businesses to tailor the app for specific
            industries, from food and groceries to specialized services like
            courier and beauty.
          </p>
          <p className="text-white mt-4 font-[400] font-inter sm:text-base tablet:text-[17px] sm:w-[240px] mymob:w-[300px] myiphone:w-[370px] tablet:w-[660px] desktop:w-[850px] iox:w-[1010px] px-2">
            Ordering.co is a versatile solution with tools for managing
            restaurant and retail delivery operations. Though its feature set is
            designed for quick startup, it offers limited customization for more
            niche services, making it primarily suited to standard delivery
            models.
          </p>
        </div>
      </motion.div>
          ...
          <div className="sm:overflow-x-auto tablet:overflow-none mt-10 pb-10 bg-white w-full max-w-[1140px] mx-auto rounded-xl">
            <table className="mx-8 text-base">
              ...
              <tr className=" border-b border-[#f3f3f3] ">
                ...
                <td className="text-center py-5 px-6 text-[#222222] font-inter">
                  Primarily food, retail, and restaurant
                </td>
              </tr>
              {/* 2nd row */}
              <tr className=" border-b border-[#f3f3f3]">
                ...
                <td className="text-center py-5 px-6 text-[#222222] font-inter">
                  {" "}
                  Full customization for unique requirements
                </td>
                <td className="text-center py-5 px-6 text-[#222222] font-inter">
              ...
              <tr className=" border-b border-[#f3f3f3]">
                ...
                <td className="text-center py-5 px-6 text-[#222222] font-inter">
                  {" "}
                  Fully white-labeled for branding control
                </td>
                <td className="text-center py-5 px-6 text-[#222222] font-inter">
              ...
              <tr className=" border-b border-[#f3f3f3]">
                ...
                <td className="text-center py-5 px-6 text-[#222222] font-inter">
                  {" "}
                  Multiple gateways including Stripe and custom APIs
                </td>
                <td className="text-center py-5 px-6 text-[#222222] font-inter">
              ...
              <tr className=" border-b border-[#f3f3f3]">
                ...
                <td className="text-center py-5 px-6 text-[#222222] font-inter">
                  {" "}
                  Design flexibility for branding and UI
                </td>
                <td className="text-center py-5 px-6 text-[#222222] font-inter">
      ...
      {/* End Key Differences Between Enatega and GOrdering.Co*/}

      {/*Section Why Enatega is an Ideal Ordering.co Alternative Solution */}
      ...
      <div className="sm:my-10 desktop:my-16 sm:w-[280px] mymob:w-[335px] myiphone:w-[385px] h-auto tablet:w-[728px] desktop:w-[964px] iox:w-[1140px] mx-auto rounded-xl  ">
        ...
        >
          ...
          <p className="text-[#222222] sm:mt-2 tablet:mt-5 font-[400] font-inter sm:text-base tablet:text-[17px]    desktop:w-[800px] iox:w-[950px] mx-auto leading-[1.3rem]">
            Enatega’s design allows businesses to customize each aspect, from
            user flows to branding, making it a strong alternative to
            Ordering.co for companies seeking a tailored solution. For
            businesses in need of an on-demand ordering.co alternative app that
            can adapt to various service requirements, Enatega’s flexibility and
            broad range of industry applications are unmatched.
          </p>
        </motion.div>
        <motion.div
          variants={fadeIn("up", 0.2, "in")}
        ...
        >
          <p className="font-inter mt-4 sm:text-[28px] tablet:text-[31px] desktop:text-[33px] iox:text-[35px] text-[#1A1D1E] sm:leading-8 tablet:leading-10 desktop:w-[800px] iox:w-[950px] font-bold mx-auto">
            Enatega’s Key Advantages as a Customizable Ordering.co Alternative
            App
          </p>
          <ul className="list-decimal my-6 desktop:w-[800px] iox:w-[950px] mx-auto px-8">
            ...
            <p className="text-[#222222] font-inter sm:text-[14px] mymob:text-base">
              While Ordering.co is primarily focused on food and retail, Enatega
              supports a wider variety of services, including beauty, courier,
              and grocery. This versatility positions Enatega as the go-to
              ordering.co alternative app for businesses with varied delivery
              needs.
            </p>
            <li className="font-bold font-inter text-[#1A1D1E] sm:text-[14px] mymob:text-base leading-5">
            ...
            <p className="text-[#222222] font-inter sm:text-[14px] mymob:text-base">
              Enatega enables extensive UI customization to ensure brand
              consistency, essential for businesses looking for apps like
              ordering.co but with full control over design elements. This makes
              Enatega an ideal white label ordering.co alternative app for
              companies seeking to stand out.
            </p>
            <li className="font-bold font-inter text-[#1A1D1E] sm:text-[14px] mymob:text-base leading-5">
              Flexible Payment Integrations
            </li>
            <p className="text-[#222222] font-inter sm:text-[14px] mymob:text-base">
              Enatega’s multiple payment gateways, including custom API options,
              allow for a more flexible transaction process. Compared to
              Ordering.co’s standard setup, Enatega is a preferred choice for
              businesses seeking an ordering.co alternative solution with
            ...
            <p className="text-[#222222] font-inter sm:text-[14px] mymob:text-base">
              With dedicated support and a scalable architecture, Enatega adapts
              to your business’s growth, making it an excellent ordering.co
              similar solution for companies that plan to expand.
            </p>
          </ul>
        </motion.div>
      </div>
      ...
      {/* Section  "Why Enatega Stands Out Among Ordering.co Competitors?" */}
      <div className="mx-auto relative my-2">
        ...
        >
          ...
          <p className="text-[#222222] sm:mt-2 tablet:mt-3 font-[400] font-inter sm:text-base tablet:text-[17px] sm:w-[250px]  mymob:w-[305px]  myiphone:w-[355px] tablet:w-[699px]  desktop:w-[850px] iox:w-[1000px] mx-auto leading-[1.3rem]">
            For businesses looking for a platform that supports full
            customization and branding flexibility, Enatega emerges as a leading
            alternative for Ordering.co. From advanced service compatibility to
            payment flexibility and UI control, Enatega is equipped to grow and
            adapt to your business’s unique service offerings.
          </p>
        </motion.div>
      </div>
      {/*  End */}
