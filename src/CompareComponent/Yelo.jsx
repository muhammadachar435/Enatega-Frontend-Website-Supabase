...
function Yelo() {
  ...
  return (
    ...
    <>
      ...
      {/* Content Start  */}
      <div className="sm:mt-26 desktop:mt-33 relative w-full sm:h-[520px]  mymob:h-[460px]  myiphone:h-[438px] tablet:h-[350px]  desktop:h-[370px] iox:h-[360px]">
        <img
          src="/Pictures/yeloBannerbgColor.jpg"
          alt=""
          className="w-full sm:h-[520px]  mymob:h-[460px]  myiphone:h-[438px] tablet:h-[350px]  desktop:h-[370px] iox:h-[360px]"
        />
        <div className="absolute sm:px-[20px] sm:pb-10 desktop:pb-6 mymob:px-[15px] tablet:px-[20px] desktop:px-8 iox:px-4 sm:w-[290px] mymob:w-[355px] myiphone:w-[420px] tablet:w-[728px] desktop:w-[964px] iox:w-[1150px] h-auto font-inter text-[#1A1D1E] iox:left-1/2 iox:-translate-x-1/2 top-1/2 -translate-y-1/2">
          <div className="flex items-center space-x-1 w-full max-w-[300px] ">
            ...
            <div>
              <img src="/Pictures/yelo.png" alt="" className="w-20 h-20" />
            </div>
          </div>
          ...
          <p className="text-lg sm:mt-2 tablet:mt-[14px] font-[600] font-inter capitalize text-[#1a1d1e] leading-5 desktop:w-[964px] iox:w-[1140px] ">
            Why Enatega is the Best Platform for Your Marketplace Needs
          </p>
          <p className="sm:text-base tablet:text-[16.5px] font-[400] sm:my-1 desktop:w-[94%] iox:w-[88%]">
            {" "}
            Choosing the right platform for your delivery or service marketplace
            is crucial for long-term success. In this comparison, we look at
            Enatega and Yelo to help you determine if Enatega might be the Yelo
            alternative that better meets your business requirements.
          </p>
        </div>
      </div>
      ...
      >
        <img
          ...
          alt=""
          className="sm:w-[280px] mymob:w-[335px] myiphone:w-[390px] sm:h-[660px] mymob:h-[600px] myiphone:h-[500px] tablet:w-[708px] tablet:h-[350px] desktop:h-[300px] iox:h-[300px] desktop:w-[964px] iox:w-[1100px]  mx-auto  rounded-xl "
        />
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 ">
          ...
          <p className="text-white mt-4 font-[400] font-inter sm:text-base tablet:text-[17px] sm:w-[240px] mymob:w-[300px] myiphone:w-[370px] tablet:w-[690px] desktop:w-[850px] iox:w-[1010px] px-2">
            Enatega offers a highly adaptable white-label delivery solution,
            tailored for multiple industries like food, grocery, laundry, and
            more. Designed with customization in mind, Enatega is well-suited to
            businesses looking to establish or expand their marketplace with a
            brand-focused, user-friendly experience.
          </p>
          <p className="text-white mt-4 font-[400] font-inter sm:text-base tablet:text-[17px] sm:w-[240px] mymob:w-[300px] myiphone:w-[370px] tablet:w-[660px] desktop:w-[850px] iox:w-[1010px] px-2">
            Yelo is a multi-vendor platform that supports on-demand delivery and
            various service categories. Positioned primarily as a Yelo
            marketplace platform, it offers pre-built solutions for quick
            launch, making it popular with startups and small businesses seeking
            a streamlined setup.
          </p>
        </div>
      </motion.div>

      {/* Feature Comparison of Enatega and Yelo */}
            ...
            <table className="mx-8 text-base">
              ...
              <tr className=" border-b border-[#f3f3f3] ">
                ...
                <td className="text-center py-5 px-6 text-[#222222] font-inter">
                  {" "}
                  Supports food, courier, beauty, and more
                </td>
                <td className="text-center py-5 px-6 text-[#222222] font-inter">
                  Primarily focuses on delivery marketplaces
                </td>
              </tr>
              {/* 2nd row */}
              <tr className=" border-b border-[#f3f3f3]">
                ...
                <td className="text-center py-5 px-6 text-[#222222] font-inter">
                  {" "}
                  Full customization, unique workflows
                </td>
                <td className="text-center py-5 px-6 text-[#222222] font-inter">
              ...
              <tr className=" border-b border-[#f3f3f3]">
                ...
                <td className="text-center py-5 px-6 text-[#222222] font-inter">
                  {" "}
                  Multiple gateways and custom integrations
                </td>
                <td className="text-center py-5 px-6 text-[#222222] font-inter">
                  Standard options
                </td>
              ...
              <tr className=" border-b border-[#f3f3f3]">
                ...
                <td className="text-center py-5 px-6 text-[#222222] font-inter">
                  {" "}
                  Personalized onboarding and scaling support
                </td>
                <td className="text-center py-5 px-6 text-[#222222] font-inter">
      ...
      {/* End Key Differences Between Enatega and Yelo*/}

      {/*Section Why Enatega is a Strong Alternative to Yelo */}
      ...
      <div className="sm:my-10 desktop:my-16 sm:w-[280px] mymob:w-[335px] myiphone:w-[385px] h-auto tablet:w-[728px] desktop:w-[964px] iox:w-[1140px] mx-auto rounded-xl  ">
        ...
        >
          ...
          <p className="text-[#222222] sm:mt-2 tablet:mt-5 font-[400] font-inter sm:text-base tablet:text-[17px]    desktop:w-[800px] iox:w-[950px] mx-auto leading-[1.3rem]">
            Enatega’s highly customizable features and broad service
            adaptability make it a prime alternative for Yelo, especially for
            businesses looking to establish a unique, branded experience across
            multiple industries. For those needing a yelo alternative app that
            extends beyond pre-built marketplace options, Enatega’s flexibility
            stands out among Yelo competitors.
          </p>
        </motion.div>
        <motion.div
          variants={fadeIn("up", 0.2, "in")}
        ...
        >
          <p className="font-inter mt-4 sm:text-[28px] tablet:text-[31px] desktop:text-[33px] iox:text-[35px] text-[#1A1D1E] sm:leading-8 tablet:leading-10 desktop:w-[800px] iox:w-[950px] font-bold mx-auto">
            Key Advantages of Enatega as a Customizable Yelo Alternative App
          </p>
          <ul className="list-decimal my-6 desktop:w-[800px] iox:w-[950px] mx-auto px-8">
            ...
            <p className="text-[#222222] font-inter sm:text-[14px] mymob:text-base">
              Enatega’s design is industry-agnostic, allowing businesses to
              tailor the platform for food, grocery, and more. This versatility
              makes Enatega an excellent choice among yelo alternatives for
              companies needing a wider service range.
            </p>
            <li className="font-bold font-inter text-[#1A1D1E] sm:text-[14px] mymob:text-base leading-5">
              Brand Identity Control
            </li>
            <p className="text-[#222222] font-inter sm:text-[14px] mymob:text-base">
              Enatega’s full white-label setup allows for deeper brand
              integration, making it an ideal white label Yelo alternative app.
              For businesses aiming to control every aspect of their
              marketplace, this brand flexibility is a valuable advantage over
              Yelo’s fixed design options.
            </p>
            <li className="font-bold font-inter text-[#1A1D1E] sm:text-[14px] mymob:text-base leading-5">
              Advanced Payment Flexibility
            </li>
            <p className="text-[#222222] font-inter sm:text-[14px] mymob:text-base">
              With multiple payment gateways and custom API options, Enatega
              goes beyond standard solutions. For businesses that need a yelo
              similar solution with extensive payment integration, Enatega
              provides enhanced flexibility to meet specific market demands.
            </p>
            <li className="font-bold font-inter text-[#1A1D1E] sm:text-[14px] mymob:text-base leading-5">
              Scalable Solutions and Dedicated Support
            </li>
            <p className="text-[#222222] font-inter sm:text-[14px] mymob:text-base">
              Enatega is designed to scale alongside your business, with
              personalized support to guide growth. This makes Enatega an
              appealing on-demand Yelo alternative app for companies with
      ...
      {/* Section  "Why Enatega Stands Out Among Yelo Competitors?" */}
      <div className="mx-auto relative my-2  ">
        ...
        >
          <p className="font-inter sm:text-[28px] tablet:text-[31px] desktop:text-[33px] iox:text-[35px] text-[#1A1D1E] sm:leading-8 tablet:leading-9.5 sm:w-[250px] mymob:w-[305px] myiphone:w-[355px] tablet:w-[699px] desktop:w-[850px] iox:w-[1000px] font-bold mx-auto">
            Why Enatega Stands Out Among Yelo Competitors?
          </p>
          <p className="text-[#222222] sm:mt-2 tablet:mt-3 font-[400] font-inter sm:text-base tablet:text-[17px] sm:w-[250px]  mymob:w-[305px]  myiphone:w-[355px] tablet:w-[699px]  desktop:w-[850px] iox:w-[1000px] mx-auto leading-[1.3rem]">
            For companies that want a marketplace app with expansive
            customization options, Enatega provides a strong alternative to
            Yelo. Its extensive feature set and full control over design and
            branding make Enatega a top choice for businesses ready to innovate
            in the on-demand delivery market.
          </p>
        </motion.div>
      </div>
      {/*  End */}
