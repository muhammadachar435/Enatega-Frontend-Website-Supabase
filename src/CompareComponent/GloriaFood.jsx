...
function GloriaFood() {
  ...
  return (
    ...
    <>
      ...
      {/* Content Start  */}
      <div className="sm:mt-26 desktop:mt-33 relative w-full sm:h-[480px]  mymob:h-[440px]  myiphone:h-[400px] tablet:h-[350px]  desktop:h-[370px] iox:h-[340px]">
        <img
          src="/Pictures/gloriaFoodbgColor.jpg"
          alt=""
          className="w-full sm:h-[480px]  mymob:h-[440px]  myiphone:h-[400px] tablet:h-[350px]  desktop:h-[370px] iox:h-[340px]"
        />
        <div className="absolute sm:px-[20px] tablet:pb-10 desktop:pb-6 mymob:px-[15px] tablet:px-[20px] desktop:px-8 iox:px-4 sm:w-[290px] mymob:w-[355px] myiphone:w-[420px] tablet:w-[728px] desktop:w-[964px] iox:w-[1150px] h-auto font-inter text-[#1A1D1E] iox:left-1/2 iox:-translate-x-1/2 top-1/2 -translate-y-1/2">
          <div className="flex items-center space-x-1 w-full max-w-[300px] ">
            ...
            <div>
              <img
                src="/Pictures/gloriaFood-logo.png"
                alt=""
                className="w-20 h-20"
              />
            </div>
          ...
          <p className="text-lg sm:mt-2 tablet:mt-5 font-[600] font-inter capitalize text-[#1a1d1e] leading-5 desktop:w-[964px] iox:w-[1140px] ">
          ...
          <p className="sm:text-base tablet:text-[16.5px] font-[400] sm:my-1 desktop:w-[94%] iox:w-[88%]">
            {" "}
            When deciding on an on-demand delivery platform, flexibility,
            branding, and support for various services are essential. Below, we
            compare Enatega and GloriaFood to help you find the ideal GloriaFood
            alternative that meets your specific needs.
          </p>
        </div>
      </div>
      ...
      >
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 ">
          ...
          <p className="text-white mt-4 font-[400] font-inter sm:text-base tablet:text-[17px] sm:w-[240px] mymob:w-[300px] myiphone:w-[370px] tablet:w-[690px] desktop:w-[850px] iox:w-[1010px] px-2">
            Enatega is a versatile, white-label delivery platform suited for a
            range of industries, from food and grocery delivery to niche
            services like beauty and dry cleaning. With full customization,
            Enatega allows businesses to create an app that reflects their
            unique brand and service model.
          </p>
          <p className="text-white mt-4 font-[400] font-inter sm:text-base tablet:text-[17px] sm:w-[240px] mymob:w-[300px] myiphone:w-[370px] tablet:w-[660px] desktop:w-[850px] iox:w-[1010px] px-2">
            GloriaFood is primarily designed as a restaurant ordering app,
            providing essential tools for food businesses looking to get started
            quickly. While straightforward, it has limited customization options
            and is focused mostly on food delivery, making it a more
            ...
            <table className="mx-8 text-base">
              ...
              <tr className=" border-b border-[#f3f3f3] ">
                ...
                <td className="text-center py-5 px-6 text-[#222222] font-inter">
                  {" "}
                  Fully customizable for diverse needs
                </td>
                <td className="text-center py-5 px-6 text-[#222222] font-inter">
              ...
              <tr className=" border-b border-[#f3f3f3]">
                ...
                <td className="text-center py-5 px-6 text-[#222222] font-inter">
                  {" "}
                  Food, grocery, beauty, courier, and more
                </td>
                <td className="text-center py-5 px-6 text-[#222222] font-inter">
      ...
      {/* End Key Differences Between Enatega and Gloria*/}

      {/*Section "Why Enatega is a Leading GloriaFood Alternative" */}
      ...
      <div className="sm:my-10 desktop:my-16 sm:w-[280px] mymob:w-[335px] myiphone:w-[385px] h-auto tablet:w-[728px] desktop:w-[964px] iox:w-[1140px] mx-auto rounded-xl  ">
        ...
        >
          ...
          <p className="text-[#222222] sm:mt-2 tablet:mt-5 font-[400] font-inter sm:text-base tablet:text-[17px]    desktop:w-[800px] iox:w-[950px] mx-auto leading-[1.3rem]">
            With Enatega, businesses have the freedom to modify both the design
            and functional features to suit their service needs, from food
            delivery to more complex requirements. This makes Enatega a strong
            alternative to GloriaFood for companies looking for an adaptable
            platform.
          </p>
          <p className="text-[#222222] sm:mt-2 tablet:mt-3 font-[400] font-inter sm:text-base tablet:text-[17px]    desktop:w-[800px] iox:w-[950px] mx-auto leading-[1.3rem]">
            For businesses in search of GloriaFood alternatives that offer
            white-label solutions and broad service compatibility, Enatega is a
            powerful choice. It offers flexibility for brand identity and is
            built to support a variety of delivery services, making it an ideal
            on-demand GloriaFood alternative app.
          </p>
        </motion.div>
        <motion.div
          variants={fadeIn("up", 0.2, "in")}
        ...
        >
          ...
          <ul className="list-decimal my-6 desktop:w-[800px] iox:w-[950px] mx-auto px-8">
            ...
            <p className="text-[#222222] font-inter sm:text-[14px] mymob:text-base">
              Enatega’s platform is fully adaptable, supporting businesses that
              need to customize services for different industries. GloriaFood,
              while practical for food ordering, may lack the adaptability
              needed for scaling outside food services, making Enatega a better
              GloriaFood app alternative.
            </p>
            <li className="font-bold font-inter text-[#1A1D1E] sm:text-[14px] mymob:text-base leading-5">
              Brand Control and User Experience
            </li>
            <p className="text-[#222222] font-inter sm:text-[14px] mymob:text-base">
              Enatega provides the tools to create a unique user interface that
              aligns with a business’s branding. For businesses wanting apps
              like GloriaFood but with full control over the user experience,
              Enatega stands out as a customizable GloriaFood alternative app.
            </p>
            <li className="font-bold font-inter text-[#1A1D1E] sm:text-[14px] mymob:text-base leading-5">
              Payment Flexibility
            </li>
            <p className="text-[#222222] font-inter sm:text-[14px] mymob:text-base">
              Enatega integrates various payment gateways, including Stripe, to
              streamline transactions for different market needs. GloriaFood’s
              limited payment setup might not meet the requirements for more
              complex operations, making Enatega a superior white-label
              GloriaFood alternative app solution.
            </p>
            <li className="font-bold font-inter text-[#1A1D1E] sm:text-[14px] mymob:text-base leading-5">
              Scalability for Multiple Services
            </li>
            <p className="text-[#222222] font-inter sm:text-[14px] mymob:text-base">
              Enatega supports a wide range of on-demand services, from
              groceries to courier deliveries, making it a scalable solution
              compared to GloriaFood, which is focused primarily on restaurant
              ordering. This versatility positions Enatega as the leading
              alternative for GloriaFood.
            </p>
          </ul>
        </motion.div>
      </div>
      ...
      {/* Section  "Enatega: Your Best Choice for a GloriaFood Alternative?" */}
      <div className="mx-auto relative  my-2 ">
        <img
          src="/Pictures/giftbgimg.jpg"
          alt=""
          className="sm:w-[280px] mymob:w-[335px] myiphone:w-[385px] sm:h-[500px] mymob:h-[420px] myiphone:h-[340px] tablet:w-[728px] tablet:h-[270px] desktop:h-[250px] desktop:w-[964px] iox:w-[1100px] mx-auto rounded-xl "
        />
        <motion.div
          variants={fadeIn("up", 0.2, "in")}
          initial="hidden"
        ...
        >
          ...
          <p className="text-[#222222] sm:mt-2 tablet:mt-3 font-[400] font-inter sm:text-base tablet:text-[17px] sm:w-[250px]  mymob:w-[305px]  myiphone:w-[355px] tablet:w-[699px]  desktop:w-[850px] iox:w-[1000px] mx-auto leading-[1.3rem]">
            For businesses seeking a white-label, scalable platform that goes
            beyond restaurant delivery, Enatega is an outstanding choice. With
            advanced customization, support for diverse services, and full
            payment integration, Enatega leads among GloriaFood competitors as a
            GloriaFood alternative that’s designed to grow with your brand and
