  ...
  return (
    ...
    <>
      ...
      <div className="w-full max-w-[1200px] mx-auto sm:mt-26 desktop:mt-34 p-5 h-auto">
        ...
        <p className="text-[#1A1D1E] leading-[1.4rem] font-inter my-[10px] text-[16.5px] font-[400] desktop:text-[17.5px]">
          Your privacy is valued and respected by Enatega. When using our
          website, we want you to understand what information is being gathered
          and how it will be used.
        </p>
        <p className="text-[#1A1D1E] leading-[1.4rem]  font-inter my-[10px] text-[16.5px] font-[400] desktop:text-[17.5px]">
          On our privacy page, you may learn more about our practices for
          gathering, using, safeguarding, and storing your personal data. We use
          your personal information to improve the site and offer the greatest
          services.
        </p>

        <p className="text-[#1A1D1E] leading-[1.4rem]  font-inter my-[10px] text-[16.5px] font-[400] desktop:text-[17.5px]">
          Using our website, you agree that your information will be collected
          and used as described in this policy.
        </p>

        <p className="text-lg font-inter text-[#222222] font-bold h-auto my-[10px]">
          What Information Do We Collect?
        </p>

        <p className="text-[#1A1D1E] leading-[1.4rem]  font-inter my-[10px] text-[16.5px] font-[400] desktop:text-[17.5px]">
          We collect valuable information from you by maintaining, providing,
          and improving our Platforms for our customers. Typically, this
          information is required when you register with the Site, create a
          login ID, and connect to or browse associated websites linked to or
        ...
        <p className="text-[#1A1D1E] leading-[1.4rem]  font-inter my-[10px] text-[16.5px] font-[400] desktop:text-[17.5px]">
          We might ask for your personal information, such as your name, contact
          number, email address, postal address, and other contact information.
        </p>
        ...
        <p className="text-[#1A1D1E] leading-[1.4rem]  font-inter my-[10px] text-[16.5px] font-[400] desktop:text-[17.5px]">
          The IP address of your computer; technical details about your computer
          or mobile device (such as the model, operating system, or browser)
        </p>

        <p className="text-[#1A1D1E] leading-[1.4rem]  font-inter my-[10px] text-[16.5px] font-[400] desktop:text-[17.5px]">
          The unique ID number of your mobile device (where available), as well
          as the geographic position of your device.
        </p>
        ...
        <p className="text-[#1A1D1E] leading-[1.4rem]  font-inter my-[10px] text-[16.5px] font-[400] desktop:text-[17.5px]">
          Only with your permission will we use your personal information. Most
          of the time, we will use the information we collect to do the
          following:
        </p>

        <ul className="list-disc px-2 my-[16px]">
          <li className="sm:text-base  leading-[1.4rem] font-inter text-[#000000] h-auto font-[400]">
            To deliver, enhance, and maintain our services to meet your needs
            better.
          </li>
          <li className="sm:text-base  leading-[1.4rem]  font-inter text-[#000000] h-auto  font-[400]">
            Use your data when required by law or for security purposes if you
          ...
          <li className="sm:text-base   leading-[1.4rem]  font-inter text-[#000000] h-auto  font-[400">
            To analyze service trends.
          </li>
          <li className="sm:sm:text-base   leading-[1.4rem]  font-inter text-[#000000] h-auto  font-[400]">
            Our customer support team may access this information to solve your
        ...
        <p className="text-[#1A1D1E] leading-[1.4rem]  font-inter my-[10px] text-[16.5px] font-[400] desktop:text-[17.5px]">
          Enatega recognizes the value of protecting your personal information
          and is committed to maintaining its security.
        </p>

        <p className="text-[#1A1D1E] leading-[1.4rem]  font-inter my-[10px] text-[16.5px] font-[400] desktop:text-[17.5px]">
          The Site has taken numerous measures to protect the privacy and
          security of your data, and your preferences for how it is used are
          respected. We take stringent security measures to guard against your
          data’s loss, misuse, disclosure, modification, unauthorized access,
          and destruction.
        </p>

        <p className="text-[#1A1D1E] leading-[1.4rem]  font-inter my-[10px] text-[16.5px] font-[400] desktop:text-[17.5px]">
          We regularly review and update our security measures to keep pace with
        ...
        <p className="text-[#1A1D1E] leading-[1.4rem]  font-inter my-[10px] text-[16.5px] font-[400] desktop:text-[17.5px]">
          If you permit us, we will share your personal information with
          businesses, organizations, and governmental entities; otherwise, we do
          not share or give away your personal information to anyone.
        </p>

        <p className="text-[#1A1D1E] leading-[1.4rem]  font-inter my-[10px] text-[16.5px] font-[400] desktop:text-[17.5px]">
          We understand that your personal information is sensitive and
          confidential, and we take great care to ensure that it is used only
        ...
        <p className="text-[#1A1D1E] leading-[1.4rem]  font-inter my-[10px] text-[16.5px] font-[400] desktop:text-[17.5px]">
          Enatega uses cookies in the same way as other websites to:
        </p>

        <ul className="list-disc px-2 my-[16px]">
          <li className="sm:text-base  leading-[1.4rem] font-inter text-[#000000] h-auto font-[400]">
            Improve your online browsing efficiency.
          </li>
          <li className="sm:text-base  leading-[1.4rem]  font-inter text-[#000000] h-auto  font-[400]">
            Check to see if you are currently logged in to our website.
          </li>
          <li className="sm:text-base  leading-[1.4rem]  font-inter text-[#000000] h-auto font-[400]">
            Make our services unique to your needs.
          </li>
        </ul>

        <p className="text-[#1A1D1E] leading-[1.4rem]  font-inter my-[10px] text-[16.5px] font-[400] desktop:text-[17.5px]">
          Cookies are little files on your computer’s hard drive, enabling us to
          recognize you more accurately. Cookies don’t provide us with any
        ...
        <p className="text-[#1A1D1E] leading-[1.4rem]  font-inter my-[10px] text-[16.5px] font-[400] desktop:text-[17.5px]">
          You have the right to request that we remove any of your personal
          information that we have stored, as well as the right to access any of
          that information and change, modify, or update it.
        </p>

        <p className="text-[#1A1D1E] leading-[1.4rem]  font-inter my-[10px] text-[16.5px] font-[400] desktop:text-[17.5px]">
          Additionally, let us know if you want us to send you promotional
          materials. You can let us know if you do not wish to receive marketing
          emails.
        </p>

        <p className="text-[#1A1D1E] leading-[1.4rem]  font-inter my-[10px] text-[16.5px] font-[400] desktop:text-[17.5px]">
          Once you have opted out, we will remove your email address from our
          marketing list, and you will no longer receive promotional emails from
          us. We take these requests seriously and will make every effort to
          fulfill them on time.
        </p>
        ...
        <p className="text-[#1A1D1E] leading-[1.4rem]  font-inter my-[10px] text-[16.5px] font-[400] desktop:text-[17.5px]">
          The Enatega privacy statement may be updated occasionally. We have the
          right to change this Policy at any time. However, you are encouraged
          to routinely check the privacy policy page for updates.
        </p>
        ...
        <p className="text-[#1A1D1E] leading-[1.4rem]  font-inter my-[10px] text-[16.5px] font-[400] desktop:text-[17.5px]">
          Please use the website’s contact information to ask any queries you
          may have regarding this privacy policy. We shall make every
          commercially reasonable effort to address any issues regarding a
          potential violation of this privacy policy.
        </p>
      </div>
