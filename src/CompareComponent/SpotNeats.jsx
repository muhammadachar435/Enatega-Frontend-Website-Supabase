  ...
  return (
    ...
    <>
      ...
      <div className="sm:mt-26 desktop:mt-33 relative w-full sm:h-[530px] mymob:h-[510px] myiphone:h-[430px] tablet:h-[400px] desktop:h-[380px] iox:h-[370px]">
        <img
          src="/Pictures/spotNeatbgcolor.jpg"
          alt=""
        ...
        <div className="absolute sm:px-[20px] sm:pb-10 desktop:pb-6 mymob:px-[15px] tablet:px-[20px] desktop:px-8 iox:px-4 sm:w-[290px] mymob:w-[355px] myiphone:w-[420px] tablet:w-[728px] desktop:w-[964px] iox:w-[1150px] h-auto font-inter text-[#1A1D1E] iox:left-1/2 iox:-translate-x-1/2 top-1/2 -translate-y-1/2">
          <div className="flex items-center space-x-1 w-full max-w-[300px] ">
            ...
            <div>
              <img
                src="/Pictures/spotNeats-logo.png"
                alt=""
                className="w-20 h-20"
              />
            </div>
          ...
          <p className="sm:text-[32px] sm:pt-3 desktop:pt-7 font-inter mymob:text-[33.5px] myiphone:text-[34.5px] tablet:text-[39px] desktop:text-[43.5px] iox:text-[50px] font-bold sm:leading-9 tablet:leading-11 desktop:leading-13.5 desktop:w-[964px] iox:w-[1140px] ">
          ...
          <p className="sm:text-base tablet:text-[16.5px] font-[400] sm:my-1 desktop:w-[94%] iox:w-[88%]">
            {" "}
            For businesses venturing into the on-demand delivery market,
            selecting a robust platform can be challenging. This comparison
            between Enatega and Spotneats provides an in-depth look to help you
            decide if Enatega is the right Spotneats alternative for your
            business goals.
          </p>
        </div>
      </div>
      ...
      >
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 ">
          ...
          <p className="text-white mt-4 font-[400] font-inter sm:text-base tablet:text-[17px] sm:w-[240px] mymob:w-[300px] myiphone:w-[370px] tablet:w-[690px] desktop:w-[850px] iox:w-[1010px] px-2">
            Enatega offers a versatile and customizable platform that serves
            multiple sectors, from food and grocery delivery to laundry and
            roadside assistance. This adaptability and its white-label approach
            make Enatega a popular choice among businesses seeking a tailored
            solution.
          </p>
          <p className="text-white mt-4 font-[400] font-inter sm:text-base tablet:text-[17px] sm:w-[240px] mymob:w-[300px] myiphone:w-[370px] tablet:w-[660px] desktop:w-[850px] iox:w-[1010px] px-2">
            Spotneats, in contrast, specializes in food delivery, focusing on
            rapid setup and simplified deployment for single-industry solutions.
            Its ready-made features and templates make it an efficient option
            for businesses prioritizing speed over extensive customization.
          </p>
        </div>
      </motion.div>

      {/* Feature Comparison of Enatega and SpotNeats */}
          ...
          <div className="sm:overflow-x-auto tablet:overflow-none mt-10 pb-10 bg-white w-full max-w-[1140px] mx-auto rounded-xl">
            <table className="mx-8 text-base">
              ...
              <tr className=" border-b border-[#f3f3f3]">
                ...
                <td className="text-center py-5 px-6 text-[#222222] font-inter">
                  {" "}
                  Fully customizable, tailored to business needs
                </td>
                <td className="text-center py-5 px-6 text-[#222222] font-inter">
              ...
              <tr className=" border-b border-[#f3f3f3]">
                ...
                <td className="text-center py-5 px-6 text-[#222222] font-inter">
                  {" "}
                  Yes, full white-label capability
                </td>
                <td className="text-center py-5 px-6 text-[#222222] font-inter">
              ...
              <tr className=" border-b border-[#f3f3f3]">
                ...
                <td className="text-center py-5 px-6 text-[#222222] font-inter">
                  {" "}
                  Multiple gateways and API compatibility
                </td>
                <td className="text-center py-5 px-6 text-[#222222] font-inter">
              ...
              <tr className=" border-b border-[#f3f3f3]">
                ...
                <td className="text-center py-5 px-6 text-[#222222] font-inter">
                  {" "}
                  Advanced real-time tracking with analytics
                </td>
                <td className="text-center py-5 px-6 text-[#222222] font-inter">
      ...
      {/* End Key Differences Between Enatega and SpotNeats*/}

      {/*Section Key Advantages of Enatega as a Customizable Spotneats Alternative App */}
        ...
        >
          ...
          <ul className="list-decimal my-6 desktop:w-[800px] iox:w-[950px] mx-auto px-8">
            ...
            <p className="text-[#222222] font-inter sm:text-[14px] mymob:text-base">
              While Spotneats is heavily focused on food delivery, Enatega’s
              versatile design can accommodate food, courier, grocery, and more.
              This multi-service capability positions Enatega as a top spotneats
              alternative solution for businesses aiming to scale and diversify.
            </p>
            <li className="font-bold font-inter text-[#1A1D1E] sm:text-[14px] mymob:text-base leading-5">
              Brand Control and White-Labeling
            </li>
            <p className="text-[#222222] font-inter sm:text-[14px] mymob:text-base">
              Enatega allows complete control over branding and user experience,
              supporting a true white label Spotneats alternative app.
              Businesses looking to establish a unique brand identity will find
              Enatega’s customization options more advantageous compared to
              Spotneats’ limited branding capabilities.
            </p>
            <li className="font-bold font-inter text-[#1A1D1E] sm:text-[14px] mymob:text-base leading-5">
              Enhanced Payment and Integration Options
            </li>
            <p className="text-[#222222] font-inter sm:text-[14px] mymob:text-base">
              With support for various payment gateways and API compatibility,
              Enatega provides a spotneats alternative app solution that offers
              greater flexibility in payment setup. This flexibility ensures
              that companies can choose the payment methods best suited to their
              target market.
            </p>
            <li className="font-bold font-inter text-[#1A1D1E] sm:text-[14px] mymob:text-base leading-5">
            ...
            <p className="text-[#222222] font-inter sm:text-[14px] mymob:text-base">
              Enatega offers tailored support for onboarding and scaling, ideal
              for companies that plan to grow over time. This support makes
              Enatega a reliable spotneats similar solution for businesses
              looking for long-term scalability.
            </p>
          </ul>
        </motion.div>
      </div>
      ...
      {/* Section  "Why Enatega Stands Out Among Spotneats Competitors?" */}
      <div className="mx-auto relative my-2  ">
        ...
        >
          ...
          <p className="text-[#222222] sm:mt-2 tablet:mt-3 font-[400] font-inter sm:text-base tablet:text-[17px] sm:w-[250px]  mymob:w-[305px]  myiphone:w-[355px] tablet:w-[699px]  desktop:w-[850px] iox:w-[1000px] mx-auto leading-[1.3rem]">
            As an all-in-one platform with strong customization capabilities,
            Enatega stands out as a leading alternative to Spotneats for
            businesses requiring a delivery app that’s highly adaptable and
            fully brandable. With personalized support, multi-industry
            flexibility, and advanced tracking, Enatega is a suitable solution
            for businesses ready to innovate in the on-demand service space.
          </p>
        </motion.div>
      </div>
      {/*  End */}
