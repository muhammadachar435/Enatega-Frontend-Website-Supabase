...
function Deonde() {
  ...
  return (
    ...
    <>
      ...
      {/* Content Start  */}
      <div className="sm:mt-26 desktop:mt-33 relative w-full sm:h-[530px]  mymob:h-[420px]  myiphone:h-[390px] tablet:h-[380px]  desktop:h-[390px] iox:h-[370px]">
        <img
          src="/Pictures/DeodebgColor.jpg"
          alt=""
          className="w-full sm:h-[530px]  mymob:h-[420px]  myiphone:h-[390px] tablet:h-[380px]  desktop:h-[390px] iox:h-[370px]"
        />
        <div className="absolute sm:px-[20px] tablet:pb-10 desktop:pb-6 mymob:px-[15px] tablet:px-[20px] desktop:px-8 iox:px-4 sm:w-[290px] mymob:w-[355px] myiphone:w-[420px] tablet:w-[728px] desktop:w-[964px] iox:w-[1150px] h-auto font-inter text-[#1A1D1E] iox:left-1/2 iox:-translate-x-1/2 top-1/2 -translate-y-1/2">
          ...
          <p className="text-lg sm:mt-2 tablet:mt-[14px] font-[600] font-inter capitalize text-[#1a1d1e] leading-5 desktop:w-[964px] iox:w-[1140px] ">
            Which Platform is the Best Fit for Your On-Demand Delivery Needs?
          </p>
          <p className="sm:text-base tablet:text-[16.5px] font-[400] sm:my-1 desktop:w-[94%] iox:w-[86%]">
            {" "}
            When selecting a delivery platform, finding a solution that aligns
            with your business goals, offers customization, and scales with your
            growth is key. Here’s a breakdown of how Enatega and DeOnDe compare,
            highlighting why Enatega might be the perfect alternative to DeOnDe.
          </p>
        </div>
      </div>
      ...
      >
        <img
          ...
          alt=""
          className="sm:w-[280px] mymob:w-[335px] myiphone:w-[390px] sm:h-[720px] mymob:h-[600px] myiphone:h-[500px] tablet:w-[708px] tablet:h-[350px] desktop:h-[300px] iox:h-[300px] desktop:w-[964px] iox:w-[1100px]  mx-auto  rounded-xl "
        />
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 ">
          ...
          <p className="text-white mt-4 font-[400] font-inter sm:text-base tablet:text-[17px] sm:w-[240px] mymob:w-[300px] myiphone:w-[370px] tablet:w-[690px] desktop:w-[850px] iox:w-[1010px] px-2">
            Enatega provides a highly adaptable, white-label delivery solution
            designed for a variety of sectors, including food, groceries, and
            more specialized services like laundry and beauty services
            on-demand. Enatega focuses on offering flexibility and
            customizability so that businesses of all sizes can customize the
            platform to fit their unique brand’s needs.
          </p>
          <p className="text-white mt-4 font-[400] font-inter sm:text-base tablet:text-[17px] sm:w-[240px] mymob:w-[300px] myiphone:w-[370px] tablet:w-[660px] desktop:w-[850px] iox:w-[1010px] px-2">
            DeOnDe is a delivery app solution with a primary focus on
            restaurants and food delivery. Known for its simplicity and ease of
            use, DeOnDe allows businesses to quickly launch a branded app with
            ready-to-use features, though it has limited customization options.
          </p>
        </div>
      </motion.div>
            ...
            <table className="mx-8 text-base">
              ...
              <tr className=" border-b border-[#f3f3f3] ">
                ...
                <td className="text-center py-5 px-6 text-[#222222] font-inter">
                  {" "}
                  Extensive, adaptable for many sectors
                </td>
                <td className="text-center py-5 px-6 text-[#222222] font-inter">
              ...
              <tr className=" border-b border-[#f3f3f3]">
                ...
                <td className="text-center py-5 px-6 text-[#222222] font-inter">
                  {" "}
                  Food, groceries, beauty, laundry, and more
                </td>
                <td className="text-center py-5 px-6 text-[#222222] font-inter">
                  Primarily food and restaurant delivery
                </td>
              </tr>
              {/* 3rd row */}
              <tr className=" border-b border-[#f3f3f3]">
                ...
                <td className="text-center py-5 px-6 text-[#222222] font-inter">
                  Yes, but with fewer customization options
                </td>
              </tr>
              {/* 4rd row */}
              <tr className=" border-b border-[#f3f3f3]">
                ...
                <td className="text-center py-5 px-6 text-[#222222] font-inter">
                  {" "}
                  Multiple options including Stripe integration
                </td>
                <td className="text-center py-5 px-6 text-[#222222] font-inter">
              ...
              <tr className=" border-b border-[#f3f3f3]">
                ...
                <td className="text-center py-5 px-6 text-[#222222] font-inter">
                  {" "}
                  Custom UI for a branded experience
                </td>
                <td className="text-center py-5 px-6 text-[#222222] font-inter">
      ...
      {/* End Key Differences Between Enatega and DeOnDe*/}

      {/*Section "Why Enatega is a Top DeOnDe Alternative" */}
      ...
      <div className="sm:my-10 desktop:my-16 sm:w-[280px] mymob:w-[335px] myiphone:w-[385px] h-auto tablet:w-[728px] desktop:w-[964px] iox:w-[1140px] mx-auto rounded-xl  ">
        <motion.div
          ...
          viewport={{ once: true, amount: 0.2 }}
        >
          <p className="font-inter sm:text-[28px] tablet:text-[31px] desktop:text-[33px] iox:text-[35px] text-[#1A1D1E] sm:leading-8 desktop:w-[800px] iox:w-[950px] font-bold mx-auto">
          ...
          <p className="text-[#222222] sm:mt-2 tablet:mt-5 font-[400] font-inter sm:text-base tablet:text-[17px]    desktop:w-[800px] iox:w-[950px] mx-auto leading-[1.3rem]">
            Enatega stands out with its comprehensive feature set and full
            customization options, making it an ideal DeOnDe alternative app
            solution for businesses looking for adaptability across various
            service types. With Enatega, users can manage anything from grocery
            and courier services to on-demand laundry and beauty, giving your
            business a unique position in the market.
          </p>
          <p className="text-[#222222] sm:mt-2 tablet:mt-3 font-[400] font-inter sm:text-base tablet:text-[17px]    desktop:w-[800px] iox:w-[950px] mx-auto leading-[1.3rem]">
            If you’re searching for DeOnDe alternatives that allow extensive
            branding and scalability, Enatega is a strong contender. The
            platform’s adaptability to multiple sectors and broad payment
            integration make it a compelling choice for businesses seeking a
            customizable DeOnDe alternative app.
          </p>
        </motion.div>
        <motion.div
          variants={fadeIn("up", 0.2, "in")}
          ...
          viewport={{ once: true, amount: 0.2 }}
        >
          <p className="font-inter mt-4 sm:text-[28px] tablet:text-[31px] desktop:text-[33px] iox:text-[35px] text-[#1A1D1E] sm:leading-8 desktop:w-[800px] iox:w-[950px] font-bold mx-auto">
          ...
          <ul className="list-decimal my-6 desktop:w-[800px] iox:w-[950px] mx-auto px-8">
            ...
            <p className="text-[#222222] font-inter sm:text-[14px] mymob:text-base">
              Enatega’s platform caters to businesses beyond just food delivery,
              allowing you to adapt its features for a range of services. In
              contrast, DeOnDe primarily focuses on restaurant delivery,
              limiting it as an alternative for DeOnDe when you need a solution
              for diverse delivery models.
            </p>
            <li className="font-bold font-inter text-[#1A1D1E] sm:text-[14px] mymob:text-base leading-5">
              Branding and User Experience
            </li>
            <p className="text-[#222222] font-inter sm:text-[14px] mymob:text-base">
              Enatega offers complete UI control, giving you the freedom to
              create an app that aligns with your brand’s look and feel. For
              companies looking for apps like DeOnDe but with greater
              customization potential, Enatega is an excellent white-label
              DeOnDe alternative app that allows for distinct brand identity.
            </p>
            <li className="font-bold font-inter text-[#1A1D1E] sm:text-[14px] mymob:text-base leading-5">
              Comprehensive Payment Options
            </li>
            <p className="text-[#222222] font-inter sm:text-[14px] mymob:text-base">
              Enatega supports multiple payment gateways, including Stripe,
              allowing for a smooth payment experience tailored to the needs of
              various markets. DeOnDe offers basic payment features, which may
              be less flexible for businesses with specific payment integration
              needs.
            </p>
            <li className="font-bold font-inter text-[#1A1D1E] sm:text-[14px] mymob:text-base leading-5">
            ...
            <p className="text-[#222222] font-inter sm:text-[14px] mymob:text-base">
              Whether your focus is food delivery, grocery, or even on-demand
              beauty services, Enatega’s flexible platform supports businesses
              and ventures of all sizes, making it an on-demand DeOnDe
              alternative app that can evolve and scale with your needs.
            </p>
          </ul>
        </motion.div>
      </div>
      ...
      {/* Section  "Choose Enatega as Your Customizable DeOnDe Alternative App?" */}
      <div className="mx-auto relative  my-2 ">
        <img
          src="/Pictures/giftbgimg.jpg"
          alt=""
          className="sm:w-[280px] mymob:w-[335px] myiphone:w-[385px] sm:h-[580px] mymob:h-[460px] myiphone:h-[380px] tablet:w-[728px] tablet:h-[270px] desktop:w-[964px] iox:w-[1100px] mx-auto rounded-xl "
        />
        <motion.div
          variants={fadeIn("up", 0.2, "in")}
          initial="hidden"
        ...
        >
          ...
          <p className="text-[#222222] sm:mt-2 tablet:mt-3 font-[400] font-inter sm:text-base tablet:text-[17px] sm:w-[250px]  mymob:w-[305px]  myiphone:w-[355px] tablet:w-[699px]  desktop:w-[850px] iox:w-[1000px] mx-auto leading-[1.3rem]">
            If your business seeks a delivery solution that goes beyond food
            services, Enatega provides a robust and flexible DeOnDe app
            alternative. From full white-label capabilities to extensive
            customization, Enatega empowers you to build an on-demand delivery
            app that is truly your own. With support for diverse services and
            advanced payment integration, Enatega proves to be the top choice
            among DeOnDe competitors for a scalable, customized delivery
            solution.
          </p>
        </motion.div>
      </div>
