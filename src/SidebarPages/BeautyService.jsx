...
function BeautyService() {
  ...
  return (
    ...
    <>
      ...
      {/* Content Start  */}
      <div className="sm:mt-26 desktop:mt-33 relative w-full sm:h-[370px] mymob:h-[270px] myiphone:h-[240px] tablet:h-[260px] desktop:h-[360px] iox:h-[370px]">
        <img
          src="/Pictures/BeautyServicesbgColor.jpg"
          alt=""
          className="w-full sm:h-[370px] mymob:h-[270px] myiphone:h-[240px] tablet:h-[260px] desktop:h-[360px] iox:h-[370px]"
        />
        <div className="absolute sm:px-[20px] mymob:px-[15px] tablet:px-[20px] desktop:px-8 iox:px-4 sm:w-[290px] mymob:w-[355px] myiphone:w-[420px] tablet:w-[728px] desktop:w-[964px] iox:w-[1150px] h-auto font-inter text-[#1A1D1E] iox:left-1/2 iox:-translate-x-1/2 top-1/2 -translate-y-1/2">
          ...
          <p className="sm:text-[32px] mymob:text-[33.5px] capitalize myiphone:text-[34.5px] tablet:text-[39px] desktop:text-[43.5px] iox:text-[50px] font-bold sm:leading-10 tablet:leading-11 desktop:leading-13.5 desktop:w-[964px] iox:w-[1140px] ">
            Offer On-Demand Beauty and Makeup Services at Home!
          </p>
          <p className="sm:text-base tablet:text-[16.5px] font-[400] sm:my-2 iox:my-[10px]">
            {" "}
            Aiming to expand your beauty services reach?
          </p>
        </div>
      </div>
      ...
      >
        <img
          ...
          alt=""
          className="sm:w-[260px] mymob:w-[335px] myiphone:w-[365px] sm:h-[620px] mymob:h-[520px] myiphone:h-[470px] tablet:w-[708px] tablet:h-[260px] desktop:h-[300px] desktop:w-[964px] iox:w-[1180px]  mx-auto  rounded-xl "
        />
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 ">
          <p className="text-white font-[400] font-inter sm:text-base tablet:text-[17px] sm:w-[200px] mymob:w-[255px] myiphone:w-[285px] tablet:w-[660px] desktop:w-[560px] iox:w-[660px]">
            If you’re looking to branch out from your salon and want to offer
            your customers convenience and accessibility, then you’ll need a
            good solution to achieve that. Enatega’s platform can be used to
            create a flexible and customizable beauty services scheduling
            solution designed to meet the demands of salons, beauticians, and
            freelance service providers. Whether you run a beauty salon or offer
            mobile beautician services, Enatega’s On-Demand Beauty Service App
            empowers businesses to streamline operations and deliver exceptional
      ...
      {/*  Simplifying Doorstep Salon Services */}
      <motion.div
        variants={fadeIn("up", 0.2, "in")}
        initial="hidden"
        whileInView="show"
      ...
      >
        <div className="desktop:hidden">
          <img
            src="/Pictures/BeautyServicesCart.jpg"
            alt=""
        ...
        <div className="desktop:w-[457px] iox:w-[600px] h-auto sm:mt-8 desktop:mt-0">
          ...
          <p className="text-[#222222] sm:text-base  iox:text-[17px]  mt-[12px] mb-[20px] leading-5.5 font-[400]  desktop:w-[90%] iox:w-[98%]">
            Enatega’s platform offers a comprehensive online salon platform that
            allows salons and beauticians to manage appointments, client
            communications, and payments—all from a single app. With the ability
            to customize a white label beauty services scheduling app,
            businesses can offer clients an easy way to book appointments, check
            availability, and receive reminders. This beauty services scheduling
            application is designed to help businesses reduce no-shows and
            ensure smoother daily operations.
          </p>

          <p className="text-[#222222] sm:text-base  iox:text-[17px]  mt-[12px] mb-[20px] leading-5.5 font-[400]  desktop:w-[90%] iox:w-[98%]">
            Whether it’s for hair styling, skincare, or spa treatments, the
            salon services scheduling app provides flexibility for businesses to
            list services, manage their schedules, and engage with customers
            effortlessly.
          </p>
          ...
          >
            {" "}
            Get Started now with salon appointment scheduling software solution
          </Link>
        </div>
      ...
      {/* Section  On-Demand Beauty and Mobile Services */}
      <div className="mx-auto relative   ">
        ...
        >
          <p className="font-inter sm:text-[28px] tablet:text-[31px] desktop:text-[33px] iox:text-[35px] text-[#1A1D1E] leading-7.5 sm:w-[250px] mymob:w-[305px] myiphone:w-[355px] tablet:w-[699px] desktop:w-[800px] iox:w-[950px] font-bold mx-auto">
            On-Demand Beauty and Mobile Services
          </p>
          <p className="text-[#222222] sm:mt-2 tablet:mt-3 font-[400] font-inter sm:text-base tablet:text-[17px] sm:w-[250px]  mymob:w-[305px]  myiphone:w-[355px] tablet:w-[699px]  desktop:w-[800px] iox:w-[950px] mx-auto leading-[1.3rem]">
            Enatega enables beauticians to offer beautician mobile services
            directly to clients’ homes or offices. The on demand beautician
            services feature allows customers to browse beauticians, select
            services, and schedule appointments from the convenience of their
            phone. The platform is perfect for beauticians who offer freelance
            services and need a reliable system to manage bookings and client
            interactions.
          </p>
          <p className="text-[#222222] sm:mt-2 tablet:mt-3 font-[400] font-inter sm:text-base tablet:text-[17px] sm:w-[250px]  mymob:w-[305px]  myiphone:w-[355px] tablet:w-[699px]  desktop:w-[800px] iox:w-[950px] mx-auto leading-[1.3rem]">
            For beauty parlours, Enatega’s platform can also act as a parlour
            app, making it easy for customers to discover nearby salons,
            schedule appointments, and receive notifications about upcoming
            bookings.
          </p>
      ...
      {/*Section Streamlining Operations for Salons */}
      ...
      <div className="sm:my-10 desktop:my-16 sm:w-[280px] mymob:w-[335px] myiphone:w-[385px] h-auto tablet:w-[728px] desktop:w-[964px] iox:w-[1140px] mx-auto rounded-xl  ">
        ...
        >
          <p className="font-inter sm:text-[28px] tablet:text-[31px] desktop:text-[33px] iox:text-[35px] text-[#1A1D1E] leading-7.5 desktop:w-[800px] iox:w-[950px] font-bold mx-auto">
            Streamlining Operations for Salons
          </p>
          <p className="text-[#222222] sm:mt-2 tablet:mt-3 font-[400] font-inter sm:text-base tablet:text-[17px]    desktop:w-[800px] iox:w-[950px] mx-auto leading-[1.3rem]">
            Salons can benefit from Enatega’s salon services scheduling
            platform, which allows them to manage multiple staff members,
            allocate resources, and track appointments in real-time. The salon
            services scheduling application enables businesses to update service
            availability, set working hours, and assign bookings to available
            staff. This level of control helps salon owners optimize their
            schedules and improve the customer experience by reducing wait times
        ...
        >
          <p className="font-inter mt-6 sm:text-[28px] tablet:text-[31px] desktop:text-[33px] iox:text-[35px] text-[#1A1D1E] leading-7.5 desktop:w-[800px] iox:w-[950px] font-bold mx-auto">
            Scalable and Customizable for Any Beauty Business
          </p>
          <p className="text-[#222222] sm:mt-2 tablet:mt-3 font-[400] font-inter sm:text-base tablet:text-[17px] desktop:w-[800px] iox:w-[950px] mx-auto leading-[1.3rem]">
            Whether you’re running a small beauty studio or a chain of salons,
            Enatega’s beauty services scheduling platform is scalable to meet
            your business needs. The platform’s modular nature allows businesses
            to add features as they grow, ensuring they can continue to deliver
            top-tier services as their customer base expands.
          </p>
        </motion.div>
      </div>
      {/* End */}

      {/*Section What Makes Enatega Stand Out */}
        ...
        <div className="sm:w-[280px] mymob:w-[335px] myiphone:w-[385px] tablet:w-[728px] desktop:w-[964px] iox:w-[1140px] py-[50px] mx-auto">
          ...
          >
            <p className="sm:text-[28px] tablet:text-[31.5px] desktop:text-[32.5px] iox:text-[35.5px] font-inter font-bold text-center sm:leading-7.5 desktop:leading-10 tablet:w-[96%] desktop:w-[86%] iox:w-[850px] mx-auto">
              What Makes Enatega Stand Out
            </p>
            <p className="sm:text-base tablet:text-[17px] font-inter text-center mt-[5px] desktop:w-[475px] iox:w-[500px] mx-auto text-[#222222] ">
              In the ever-evolving and competitive beauty services industry,
              here’s what makes Enatega’s salon scheduling app stand out:
            </p>
          </motion.div>
                ...
                <div className="flex items-center sm:space-x-3 tablet:space-x-3  my-3 ">
                  ...
                  <div>
                    <p className="text-[#1A1D1E] sm:text-[14px] tablet:text-[14.6px] font-sans font-medium desktop:w-[319px]">
                      Deployment in five business days
                    </p>
                  </div>
                </div>
                {/* 5th end */}
                ...
                <div className="flex items-center sm:space-x-3 tablet:space-x-3  my-3 ">
                  ...
                  <div>
                    <p className="text-[#1A1D1E] sm:text-[14px] tablet:text-[14.6px] font-sans font-medium tablet:w-[280px]">
                      Lifetime licensing pricing model
                    </p>
                  </div>
                </div>
                {/* 6th end */}
          ...
          >
            ...
            >
              {" "}
              Get Started now with salon appointment scheduling software
              solution
            </Link>
          </motion.span>
        </div>
      ...
      {/* Section "What’s Included in the Enatega Package"*/}
      ...
      <div className="sm:my-10 desktop:mt-20 sm:w-[280px] mymob:w-[335px] myiphone:w-[385px]  tablet:w-[708px] desktop:w-[820px] iox:w-[1000px] mx-auto rounded-xl  ">
        <div>
          ...
          >
            What’s Included in the Enatega Package
          </motion.p>
          ...
          <ul>
            ...
            >
              Enatega’s On Demand Beauty Service App offers a seamless
              experience for clients, allowing them to browse services, select
              beauticians or salons, and book appointments with ease. Customers
              can access detailed profiles of service providers, view ratings,
              and track the status of their appointments in real-time.
            </motion.p>
            ...
            <motion.p
              ...
              className="text-[#222222]  font-[400] font-inter sm:text-base tablet:text-[17px]    desktop:w-[800px] iox:w-[980px] leading-[1.3rem]"
            >
              Salon owners can take full control of their operations through
              Enatega’s white label salon services scheduling solution. The app
              provides features like real-time appointment tracking, staff
              management, and inventory tracking, all from a single dashboard.
              This powerful scheduling platform allows salons to operate more
              efficiently and improve overall customer satisfaction.
            </motion.p>
            ...
            <motion.p
              ...
              className="text-[#222222]  font-[400] font-inter sm:text-base tablet:text-[17px]    desktop:w-[800px] iox:w-[980px] leading-[1.3rem]"
            >
              The white label salon services scheduling app includes a
              comprehensive admin dashboard that allows businesses to manage all
              aspects of their beauty services. From appointment management to
              customer feedback, the platform provides insightful data that
              helps businesses optimize their services and grow.
            </motion.p>
          </ul>
          ...
          >
            Why Choose Enatega for Your Salon?
          </motion.p>
          <motion.p
            variants={fadeIn("up", 0.2, "in")}
            initial="hidden"
          ...
          >
            Enatega’s white label beauty services scheduling solution provides
            everything you need to manage and grow your beauty business. From
            salons to freelance beauticians, the platform is designed to
            streamline scheduling, improve client communication, and optimize
            operations. With its flexible and user-friendly interface, Enatega
            ensures that businesses of all sizes can offer a professional,
            on-demand beauty service experience.
          </motion.p>
          <motion.p
            variants={fadeIn("up", 0.2, "in")}
            initial="hidden"
          ...
          >
            Start transforming your beauty services today with Enatega’s
            customizable white label beauty services scheduling app, and deliver
            the convenience and quality your clients expect!
          </motion.p>
        </div>
      </div>
