...
function BorkuDelievery() {
  ...
  return (
    ...
    <>
      ...
      <div className=" z-1 bg-[#ffe5dc] relative sm:mt-26 iox:mt-[130px] w-full sm:h-[72vh] mymob:h-[70vh] myiphone:h-[74vh]  tablet:h-[70vh] desktop:h-[75vh] biglap:h-[80vh] ">
        <div>
          <img
            loading="lazy"
            src="/Pictures/borkuBgColor.jpg"
            alt=""
      ...
      {/* Section What is BorkuDelievery */}
      <div className="fixed sm:top-[80px] tablet:top-[100px] bottom-10 left-1/2  -translate-x-1/2   sm:w-[280px] mymob:w-[335px] z-[-1] myiphone:w-[385px] tablet:w-[728px] desktop:w-[954px] iox:w-[1140px] h-auto  mx-auto sm:mt-7 mymob:mt-0 ">
        <img
          loading="lazy"
          src="/Pictures/borkuAfrican.jpg"
          alt="Sample"
          className=" sm:w-[265px] mx-auto sm:h-[550px] mymob:h-[650px] mymob:w-[320px] myiphone:h-[680px] myiphone:w-[370px]  tablet:h-[550px] tablet:w-[715px] desktop:h-[650px] desktop:w-[939px] iox:h-[850px] iox:w-[1090px] biglap:h-[1800px]"
        />
      </div>
      <motion.div
        ...
        className="opacity-90  sm:w-[280px] mymob:w-[335px] myiphone:w-[385px]  tablet:w-[668px] desktop:w-[850px] iox:w-[950px] mx-auto  px-[20px] py-[30px] "
      >
        ...
        <p className=" text-white sm:text-sm mymob:text-base tablet:text-base tablet:w-[668px] desktop:w-[850px] iox:w-[950px] sm:mt-3 mymob:mt-2 font-inter bg-transparent py-1 ">
          Borku is an emerging food delivery app centered on African cuisine,
          developed on Enatega and customized by Ninjas Code. With a focus on
          cultural authenticity and user convenience, Borku aims to create a
          seamless experience for users craving African flavors. Although Borku
          remains a work in progress, this case study highlights the significant
          steps taken to establish a unique and culturally focused platform.
        </p>
      </motion.div>
      {/* </div> */}
      {/* End Section What is BorkuDelievery */}
      ...
      <div className="bg-white border-white border pb-5">
        <div className="bg-white z-1">
          ...
          >
            ...
            <p className="text-[#222222] text-base mt-[10px] mb-[20px] leading-5.5 font-[400] iox:w-[964px]">
              Borku was created to celebrate the diversity of African cuisine
              through a specialized food delivery platform. To achieve this, the
              team focused on a few key areas:
            </p>
            <ul className="list-disc px-8">
              <li className="text-[#1A1D1E] text-lg font-semibold leading-5">
                Customized Menu Items:{" "}
                <span className="text-base font-[400] text-[#222222]">
                  {" "}
                  Borku required menu options that reflected various African
                  cuisines, showcasing the rich culinary heritage across the
                  continent.
                </span>
              </li>
              <li className="text-[#1A1D1E] text-lg font-semibold leading-5">
                ...
                <span className="text-base font-[400] text-[#222222]">
                  {" "}
                  A UI and UX overhaul was needed to offer users an engaging,
                  easy-to-navigate platform that embraced African-themed
                  aesthetics.
                </span>
              </li>
              <li className="text-[#1A1D1E] text-lg font-semibold leading-5">
                ...
                <span className="text-base font-[400] text-[#222222]">
                  {" "}
                  To attract both riders and restaurants, Borku needed a
                  simplified onboarding process with forms tailored to each
                  group.
                </span>
              </li>
              <li className="text-[#1A1D1E] text-lg font-semibold leading-5">
        ...
        {/* End Section The Vision: Showcasing African Cuisine */}
        ...
        <motion.div
          ...
          whileInView={"show"}
          viewport={{ once: true, amount: 0.1 }}
          className="sm:w-full  iox:w-[1030px] h-auto font-inter mx-auto bg-[#ecf7f3] py-[60px] sm:px-[30px] desktop:px-[34px] iox:px-[60px] my-10 rounded-xl"
        >
          <p className="text-[#1A1D1E] sm:text-[28px] tablet:text-[31px] desktop:text-[32px] iox:text-[35px] mb-[12px] font-bold capitalize leading-8">
            Key Development Highlights
          </p>
          <ul className="">
            ...
            <p className="text-[#222222] text-base mt-[10px] mb-[20px] leading-5.5 font-[400] ">
              To emphasize the diversity of African food, Borku’s team created
              unique menu options that cater to regional tastes. This
              customization allows restaurants to highlight popular dishes, from
              West African Jollof rice to North African tagines, providing users
              with a variety of options they won’t find on typical food delivery
              platforms.
            </p>
            <li className="text-[#1A1D1E] text-lg font-semibold leading-5">
            ...
            <p className="text-[#222222] text-base mt-[10px] mb-[20px] leading-5.5 font-[400] ">
              Given the goal of creating a culturally resonant and user-friendly
              platform, Borku received a comprehensive UI and UX revamp. The
              design incorporates vibrant, authentic African elements, making
              the app visually appealing while offering smooth navigation for
              users.
            </p>
            <li className="text-[#1A1D1E] text-lg font-semibold leading-5">
            ...
            <p className="text-[#222222] text-base mt-[10px] mb-[20px] leading-5.5 font-[400] ">
              To encourage engagement with the platform, Borku introduced custom
              forms to help new riders and restaurants join the network. These
              forms collect essential information and guide each party through
              the onboarding process, making it easier for vendors and drivers
              to start operating on Borku.
            </p>
            <li className="text-[#1A1D1E] text-lg font-semibold leading-5">
              Secure and Convenient Stripe Payment Integration
            </li>
            <p className="text-[#222222] text-base mt-[10px] mb-[20px] leading-5.5 font-[400] ">
              For reliable and versatile payment handling, Borku integrated
              Stripe, providing users with a secure, familiar method for
              completing transactions. This setup also ensures that payments are
              processed quickly and efficiently, enhancing the overall user
              experience.
            </p>
          </ul>
        </motion.div>

        {/* End Key Development Highlights */}
        ...
        >
          ...
          <div className="desktop:w-[457px] iox:w-[545px] h-auto">
            ...
            <p className="text-[#222222] sm:text-base  iox:text-[17px]  mt-[12px] mb-[20px] leading-5.5 font-[400]  desktop:w-[90%]">
              Borku’s journey is just beginning. With the foundational features
              now in place, the team is focusing on fine-tuning the user
              experience and exploring potential enhancements to expand Borku’s
              appeal. Future updates will continue to celebrate African cuisine,
              expanding options and improving usability.
            </p>
          </div>
