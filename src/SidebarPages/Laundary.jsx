...
function Laundary() {
  ...
  return (
    ...
    <>
      ...
      {/* Content Start  */}
      <div className="sm:mt-26 desktop:mt-33 relative w-full sm:h-[430px] mymob:h-[330px] myiphone:h-[290px] tablet:h-[280px] desktop:h-[360px] iox:h-[370px]">
        <img
          src="/Pictures/laudrybgColor.jpg"
          alt=""
          className="w-full sm:h-[430px] mymob:h-[330px] myiphone:h-[290px] tablet:h-[280px] desktop:h-[360px] iox:h-[370px]"
        />
        <div className="absolute sm:px-[20px] mymob:px-[15px] tablet:px-[20px] desktop:px-8 iox:px-4 sm:w-[290px] mymob:w-[355px] myiphone:w-[420px] tablet:w-[728px] desktop:w-[964px] iox:w-[1150px] h-auto font-inter text-[#1A1D1E] iox:left-1/2 iox:-translate-x-1/2 top-1/2 -translate-y-1/2">
          <p className="sm:text-[22px] font-[500] sm:my-2 iox:my-[6px] ">
            Laundry On-Demand Services
          </p>
          <p className="sm:text-[32px] mymob:text-[33.5px] capitalize myiphone:text-[34.5px] tablet:text-[39px] desktop:text-[43.5px] iox:text-[50px] font-bold sm:leading-10 tablet:leading-11 desktop:leading-13.5 desktop:w-[964px] iox:w-[1140px] ">
            Deliver Laundry Services Right to Your Customers’ Doorsteps
          </p>
          <p className="sm:text-base tablet:text-[16.5px] font-[400] sm:my-2 desktop:my-[10px]">
            {" "}
            Get ready to take your laundry services online and capture
            customers’ attention with Enatega’s laundry service app.
          </p>
        </div>
      </div>
      ...
      >
        <img
          ...
          alt=""
          className="sm:w-[260px] mymob:w-[335px] myiphone:w-[365px] sm:h-[620px] mymob:h-[480px] myiphone:h-[470px] tablet:w-[708px] tablet:h-[260px] desktop:h-[300px] desktop:w-[964px] iox:w-[1180px]  mx-auto  rounded-xl "
        />
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 ">
          <p className="text-white font-[400] font-inter sm:text-base tablet:text-[17px] sm:w-[200px] mymob:w-[255px] myiphone:w-[285px] tablet:w-[660px] desktop:w-[560px] iox:w-[660px]">
            Nowadays, everyone expects convenience and efficiency in all aspects
            of their lives, including laundry. Enatega’s multi vendor platform
            can be customized to function as a cutting-edge laundry on-demand
            services solution that allows businesses to deliver fast, seamless
            laundry and dry cleaning services directly to their customers’
            doorsteps. Whether you’re running a laundromat, dry cleaner, or an
            on-demand laundry service, Enatega provides the tools you need to
      ...
      {/*  Streamlined Laundry Operations for All Business Sizes */}
      <motion.div
        variants={fadeIn("up", 0.2, "in")}
        initial="hidden"
        whileInView="show"
        viewport={{ once: true, amount: 0.2 }}
        className="sm:w-[280px] mymob:w-[335px] myiphone:w-[385px] tablet:w-[728px] desktop:w-[964px] iox:w-[1140px] font-inter mx-auto sm:my-10 tablet:my-20 desktop:flex desktop:justify-evenly desktop:space-x-14 iox:space-x-36 desktop:items-center"
      >
        <div className="desktop:hidden">
          <img
            src="/Pictures/luadryCart.jpg"
            alt=""
            className="mymob:w-[251px] myiphone:w-[288px] tablet:w-[545px] h-auto mx-auto "
          />
        </div>
        <div className="desktop:w-[457px] iox:w-[600px] h-auto sm:mt-8 desktop:mt-0">
          ...
          <p className="text-[#222222] sm:text-base  iox:text-[17px]  mt-[12px] mb-[20px] leading-5.5 font-[400]  desktop:w-[90%] iox:w-[98%]">
            Enatega’s flexible platform makes it easy for businesses to build a
            comprehensive on-demand laundry services solution. With features
            that allow vendors to manage orders, track deliveries, and
            communicate with couriers, Enatega is perfect for businesses seeking
            to offer a high-quality online laundry service. This laundry service
            app simplifies the entire process from booking to delivery, ensuring
            customer satisfaction with every wash.
          </p>

          <p className="text-[#222222] sm:text-base  iox:text-[17px]  mt-[12px] mb-[20px] leading-5.5 font-[400]  desktop:w-[90%] iox:w-[98%]">
            Businesses can also launch their own white-label laundry delivery
            app to offer customers a fully branded experience. Whether offering
            simple laundry services or advanced dry cleaning options, businesses
            can customize the platform to suit their needs and provide a
            seamless, branded experience to their customers.
          </p>

          <Link
            to="/contactus"
            className="sm:py-2 tablet:py-3 px-1 text-center sm:w-[280px] mymob:w-[335px] myiphone:w-[385px] tablet:w-[728px] desktop:w-[485px]  mx-auto  text-wrap align-center inline-block rounded-md font-inter text-base font-semibold text-[#000000]   border-t-[#a6d1b6]  border-b-3 border-l border-r border-[#558567]  shadow-[inset_0_4px_6px_rgba(0,0,0,0.1),inset_0_1px_2px_rgba(255,255,255,1)]"
            style={{
              backgroundImage:
                " linear-gradient(180deg, #86cba0 0, #6cb487 100%)",
            }}
          >
            {" "}
            Get Started now with for our laundry service delivery app solution
          </Link>
        </div>
      ...
      {/* Section  On-Demand Laundry and Dry Cleaning */}
      <div className="mx-auto relative   ">
        <img
          src="/Pictures/giftbgimg.jpg"
          alt=""
          className="sm:w-[280px] mymob:w-[335px] myiphone:w-[385px] sm:h-[750px] mymob:h-[650px] myiphone:h-[560px] tablet:w-[728px] tablet:h-[420px]  desktop:h-[440px] desktop:w-[964px] iox:w-[1140px] mx-auto rounded-xl "
        />
        <motion.div
          variants={fadeIn("up", 0.2, "in")}
          initial="hidden"
        ...
        >
          ...
          <p className="text-[#222222] sm:mt-2 tablet:mt-3 font-[400] font-inter sm:text-base tablet:text-[17px] sm:w-[250px]  mymob:w-[305px]  myiphone:w-[355px] tablet:w-[699px]  desktop:w-[800px] iox:w-[950px] mx-auto leading-[1.3rem]">
            The modern customer wants quick, reliable service at their
            fingertips. With Enatega’s on demand laundry delivery app, customers
            can request services such as laundry pick-up, washing, and delivery
            with just a few clicks. The platform’s easy-to-use app for laundry
            and dry cleaning allows customers to schedule services at their
            convenience, track their orders in real-time, and get updates on the
            status of their laundry.
          </p>
          <p className="text-[#222222] sm:mt-2 tablet:mt-3 font-[400] font-inter sm:text-base tablet:text-[17px] sm:w-[250px]  mymob:w-[305px]  myiphone:w-[355px] tablet:w-[699px]  desktop:w-[800px] iox:w-[950px] mx-auto leading-[1.3rem]">
            For dry cleaning services, businesses can use Enatega’s customizable
            dry cleaning app to ensure that even delicate items are handled with
            care. This ensures that customers receive the best service whether
            they are sending in regular laundry or specialized dry cleaning
            items.
          </p>

          <Link
            to="/contactus"
            className=" sm:py-2 tablet:py-3 sm:px-3 tablet:px-0 mt-4 text-center sm:w-[250px] mymob:w-[305px]  myiphone:w-[355px]  tablet:w-[600px]  desktop:w-[560px] mx-auto  text-wrap align-center inline-block rounded-md font-inter text-base font-semibold text-[#000000]   border-t-[#a6d1b6]  border-b-[3px] border-l border-r border-[#558567]  shadow-[inset_0_4px_6px_rgba(0,0,0,0.1),inset_0_1px_2px_rgba(255,255,255,1)]"
            style={{
              backgroundImage:
                " linear-gradient(180deg, #86cba0 0, #6cb487 100%)",
            }}
      ...
      {/*Section "Manage Operations with Ease" */}
      ...
      <div className="sm:my-10 desktop:my-16 sm:w-[280px] mymob:w-[335px] myiphone:w-[385px] h-auto tablet:w-[728px] desktop:w-[964px] iox:w-[1140px] mx-auto rounded-xl  ">
        ...
        >
          ...
          <p className="text-[#222222] sm:mt-2 tablet:mt-3 font-[400] font-inter sm:text-base tablet:text-[17px]    desktop:w-[800px] iox:w-[950px] mx-auto leading-[1.3rem]">
            Enatega’s laundry delivery app offers businesses full control over
            their operations, helping them manage everything from pick-up
            schedules to delivery times. The platform is designed to support
            high volumes of orders while maintaining efficient workflows.
            Whether you’re managing a single location or multiple vendors,
            Enatega’s laundry apps provide the flexibility you need to grow.
          </p>
          <p className="text-[#222222] sm:mt-2 tablet:mt-3 font-[400] font-inter sm:text-base tablet:text-[17px]    desktop:w-[800px] iox:w-[950px] mx-auto leading-[1.3rem]">
            With its automated dispatch system and integrated communication
            tools, the platform simplifies the coordination between vendors,
            couriers, and customers. The laundry service application includes
            features like real-time tracking, delivery notifications, and
            automated invoicing, ensuring a smooth and hassle-free experience
        ...
        <motion.div
          ...
          viewport={{ once: true, amount: 0.2 }}
        >
          <p className="font-inter mt-6 sm:text-[28px] tablet:text-[31px] desktop:text-[33px] iox:text-[35px] text-[#1A1D1E] leading-7.5 desktop:w-[800px] iox:w-[950px] font-bold mx-auto">
            Scalable and Ready for Growth
          </p>
          <p className="text-[#222222] sm:mt-2 tablet:mt-3 font-[400] font-inter sm:text-base tablet:text-[17px] desktop:w-[800px] iox:w-[950px] mx-auto leading-[1.3rem]">
            Enatega’s on-demand laundry and dry cleaning solution is scalable
            and flexible, making it ideal for businesses of any size. Whether
            you’re running a local laundromat or expanding into a larger
            operation, Enatega’s platform can grow with your business. The
            laundry delivery app is designed to accommodate new services,
            locations, and customers as your business expands.
          </p>
        </motion.div>
      </div>
      {/* End */}

      {/*Section "Scale Your Laundry Services Delivery Business With Enatega" */}
        ...
        <div className="sm:w-[280px] mymob:w-[335px] myiphone:w-[385px] tablet:w-[728px] desktop:w-[964px] iox:w-[1140px] py-[50px] mx-auto">
          ...
          >
            <p className="sm:text-[28px] tablet:text-[31.5px] desktop:text-[32.5px] iox:text-[35.5px] font-inter font-bold text-center sm:leading-7.5 desktop:leading-10 tablet:w-[96%] desktop:w-[86%] iox:w-[850px] mx-auto">
              Scale Your Laundry Services Delivery Business With Enatega
            </p>
            <p className="sm:text-base tablet:text-[17px] font-inter text-center mt-[5px] desktop:w-[475px] iox:w-[500px] mx-auto text-[#222222] ">
              Taking your laundry business on an online platform to provide
              on-demand laundry services at home is the smartest step to scale
              your growth quickly. Here’s what Enatega’s laundry delivery
              services app offers to help you become a leader in the laundry
              services industry.
            </p>
          </motion.div>

          {/* Part for above Section */}
          <motion.div
            variants={fadeIn("up", 0.2, "in")}
            initial="hidden"
            whileInView="show"
            viewport={{ once: true, amount: 0.2 }}
            className="bg-white shadow-lg rounded-2xl sm:mt-4 tablet:mt-8 sm:p-4 tablet:py-6 desktop:py-8 iox:w-[1140px] mx-auto "
          >
            {/* 1st box */}
            <div className="w-full tablet:w-[96%]  tablet:grid tablet:grid-cols-3 mx-auto">
              ...
              <div className="iox:w-[400px]">
                ...
                <div className="flex items-center sm:space-x-3 tablet:space-x-3  my-3 ">
                  ...
                  <div>
                    <p className="text-[#1A1D1E] sm:text-[14px] tablet:text-[14.6px] font-sans font-medium tablet:w-[280px]">
      ...
      {/* Section "What’s Included in the Laundry On-Demand Package" */}
      ...
      <div className="sm:my-10 desktop:mt-20 sm:w-[280px] mymob:w-[335px] myiphone:w-[385px]  tablet:w-[708px] desktop:w-[820px] iox:w-[1000px] mx-auto rounded-xl  ">
        <div>
          <motion.p
            ...
            whileInView="show"
            viewport={{ once: true, amount: 0.2 }}
            className="font-inter sm:text-[28px] tablet:text-[31px] desktop:text-[33px] iox:text-[35px] text-[#1A1D1E] sm:leading-7 tablet:leading-9 desktop:w-[650px] iox:w-[800px]  font-bold mb-4"
          >
            What’s Included in the Laundry On-Demand Package
          </motion.p>
          ...
          <ul>
            ...
            >
              The laundry app offers customers a seamless experience for booking
              services, tracking orders, and making payments. Customers can
              choose from various service options such as standard laundry, dry
              cleaning, or special requests. Real-time tracking and status
              updates keep them informed throughout the process.
            </motion.p>
            ...
            <motion.p
              ...
              className="text-[#222222]  font-[400] font-inter sm:text-base tablet:text-[17px]    desktop:w-[800px] iox:w-[980px] leading-[1.3rem]"
            >
              Enatega’s rider app is designed to support couriers with tools
              like optimized routing, delivery updates, and time management
              features. This ensures that couriers can handle laundry pick-ups
              and deliveries efficiently, making the laundry service apps clone
              more effective and reliable for businesses and their customers.
            </motion.p>
            ...
            <motion.p
              ...
              className="text-[#222222]  font-[400] font-inter sm:text-base tablet:text-[17px]    desktop:w-[800px] iox:w-[980px] leading-[1.3rem]"
            >
              The admin dashboard provides a comprehensive overview of the
              entire laundry operation. Businesses can monitor all aspects of
              their services, from managing delivery zones to analyzing
              performance metrics. This feature-packed laundry and dry cleaning
              application ensures full control over daily operations.
            </motion.p>
            ...
            <motion.p
              ...
              className="text-[#222222]  font-[400] font-inter sm:text-base tablet:text-[17px]    desktop:w-[800px] iox:w-[980px] leading-[1.3rem]"
            >
              The vendor app allows laundromats and dry cleaners to manage
              orders, update statuses, and communicate with customers. This
              all-in-one solution enables businesses to manage their services
              and streamline their operations. It’s the perfect tool for
              businesses offering on demand laundry service.
            </motion.p>
          </ul>
          ...
          <motion.p
            ...
            whileInView="show"
            viewport={{ once: true, amount: 0.2 }}
            className="font-inter sm:text-[28px] tablet:text-[31px] desktop:text-[33px] iox:text-[35px] text-[#1A1D1E] sm:leading-7.5 tablet:leading-9 desktop:w-[600px] iox:w-[850px]  font-bold"
          >
            Why Choose Enatega for Your Laundry Business?
          </motion.p>
          <motion.p
            variants={fadeIn("up", 0.2, "in")}
            initial="hidden"
          ...
          >
            Enatega offers a comprehensive, customizable solution for businesses
            looking to launch or improve their on-demand laundry services
            solution. With its robust infrastructure and easy-to-use interface,
            the platform provides everything you need to deliver a top-tier
            laundry and dry cleaning app experience. Enatega’s focus on
            efficiency and customer satisfaction makes it the go-to platform for
            modern laundry businesses.
          </motion.p>
          <motion.p
            variants={fadeIn("up", 0.2, "in")}
            initial="hidden"
            whileInView="show"
            viewport={{ once: true, amount: 0.2 }}
            className="text-[#222222] font-[400] my-2 font-inter sm:text-base tablet:text-[17px]    desktop:w-[800px] iox:w-[980px] leading-[1.3rem]"
          >
            Start transforming your laundry operations today with Enatega’s
            white-label laundry delivery app, and give your customers the fast,
            convenient service they deserve!
          </motion.p>
        </div>
      </div>
