...
function GiftDelievery() {
  ...
  return (
    ...
    <>
      ...
      {/* Content Start  */}
      <div className="sm:mt-26 desktop:mt-33 relative w-full sm:h-[300px]  mymob:h-[280px]  myiphone:h-[220px] tablet:h-[275px] desktop:h-[300px] iox:h-[310px]">
        <img
          src="/Pictures/giftbgColor.jpg"
          alt=""
          className="w-full sm:h-[300px] mymob:h-[280px] myiphone:h-[220px] tablet:h-[275px] desktop:h-[300px] iox:h-[310px]"
        />
        <div className="absolute sm:px-[20px] mymob:px-[15px] tablet:px-[20px] desktop:px-8 iox:px-4 sm:w-[290px] mymob:w-[355px] myiphone:w-[420px] tablet:w-[728px] desktop:w-[964px] iox:w-[1150px] h-auto font-inter text-[#1A1D1E] iox:left-1/2 iox:-translate-x-1/2 top-1/2 -translate-y-1/2">
          <p className="sm:text-[22px] font-[500] sm:my-2 iox:my-[12px] leading-[1.4rem] ">
            Gift Delivery
          </p>
          <p className="sm:text-[32px] mymob:text-[33.5px] capitalize myiphone:text-[34.5px] tablet:text-[39px] desktop:text-[43.5px] iox:text-[50px] font-bold sm:leading-9 tablet:leading-10 desktop:w-[964px] iox:w-[1140px] ">
            A Gift Delivery Solution That Keeps on Giving!
          </p>
          <p className="sm:text-base tablet:text-[16.5px] font-[400] sm:my-2 desktop:my-[10px]">
            {" "}
            Optimize your gift delivery operations with Enatega’s readymade gift
      ...
      >
        <img
          ...
          alt=""
          className="sm:w-[260px] mymob:w-[335px] myiphone:w-[365px] sm:h-[400px] mymob:h-[320px] myiphone:h-[300px] tablet:w-[708px] tablet:h-[180px] desktop:w-[964px] iox:w-[1180px]  mx-auto  rounded-xl "
        />
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 ">
          <p className="text-white font-[400] font-inter sm:text-base tablet:text-[17px] sm:w-[200px] mymob:w-[255px] myiphone:w-[285px] tablet:w-[650px] desktop:w-[900px] iox:w-[680px]">
            Enatega is not just for food. it’s also an adaptable platform for
            businesses looking to provide apps to deliver gifts. Whether you’re
            an independent gift shop or managing a multi-vendor marketplace,
            Enatega’s on-demand gift delivery solution allows you to offer
            customers a seamless way to send thoughtful gifts with just a few
            clicks.
          </p>
        </div>
      </motion.div>
      ...
      {/*  Your Solution to Getting Gifts Delivered */}
      <motion.div
        variants={fadeIn("up", 0.2, "in")}
        initial="hidden"
        whileInView="show"
      ...
      >
        ...
        <div className="desktop:w-[457px] iox:w-[545px] h-auto sm:mt-2 desktop:mt-0">
          ...
          <p className="text-[#222222] sm:text-base  iox:text-[17px]  mt-[12px] mb-[20px] leading-5.5 font-[400]  desktop:w-[90%]">
            Enatega can be customized to serve as a comprehensive app solution
            for businesses that want to tap into the growing market of online
            gift orders.
          </p>
          <p className="text-[#222222] sm:text-base iox:text-[17px] mt-[12px] mb-[20px] leading-5.5 font-[400]  desktop:w-[90%]">
            With features like real-time tracking, flexible delivery options,
            and an intuitive online gift ordering system, your customers can
            easily select and send gifts, ensuring a memorable and hassle-free
            experience.
          </p>
          ...
          >
            {" "}
            Get Started now with our on-demand gift delivery solution
          </Link>
        </div>
      ...
      {/* End Your Solution to Getting Gifts Delivered */}

      {/* Section  Get On Demand ..... */}
      <div className="mx-auto relative   ">
        <img
          src="/Pictures/giftbgimg.jpg"
          alt=""
          className="sm:w-[280px] mymob:w-[335px] myiphone:w-[385px] sm:h-[500px] mymob:h-[460px] myiphone:h-[440px] tablet:w-[728px] tablet:h-[300px] desktop:h-[350px] desktop:w-[964px] iox:w-[1140px] mx-auto rounded-xl "
        />
        <motion.div
          variants={fadeIn("up", 0.2, "in")}
          initial="hidden"
        ...
        >
          ...
          <p className="text-[#222222] sm:mt-2 tablet:mt-3 font-[400] font-inter sm:text-base tablet:text-[17px] sm:w-[250px]  mymob:w-[305px]  myiphone:w-[355px] tablet:w-[699px]  desktop:w-[800px] iox:w-[950px] mx-auto leading-[1.3rem]">
            As the demand for instant services grows, an on-demand delivery app
            allows your business to provide swift and reliable deliveries. With
            Enatega, customers can select from a variety of gifts, schedule
            deliveries, and even add personalized notes, all within a
            user-friendly online gift ordering app. This flexibility enhances
      ...
      {/* End Section Get on Demand */}

      {/*Section A Flexible Solution  For Gift Solution*/}
      ...
      <div className="sm:my-10 desktop:my-16 h-auto sm:w-[280px] mymob:w-[335px] myiphone:w-[385px]  tablet:w-[728px] desktop:w-[964px] iox:w-[1140px] mx-auto rounded-xl  ">
        ...
        >
          <p className="font-inter sm:text-[28px] tablet:text-[31px] desktop:text-[33px] iox:text-[35px] text-[#1A1D1E] leading-7.5 desktop:w-[800px] iox:w-[950px] font-bold mx-auto">
            A Flexible Solution for Gift Vendors
          </p>
          <p className="text-[#222222] sm:mt-2 tablet:mt-3 font-[400] font-inter sm:text-base tablet:text-[17px]    desktop:w-[800px] iox:w-[950px] mx-auto leading-[1.3rem]">
            Enatega’s delivery software is perfect for small businesses and
            large vendors alike. Whether you’re offering same-day or scheduled
            delivery, the platform’s gift ordering system makes managing orders
            simple. You can track delivery statuses, handle multiple orders
            simultaneously, and streamline your entire operation with ease.
          </p>
        </motion.div>
        <motion.div
          variants={fadeIn("up", 0.2, "in")}
        ...
        >
          <p className="font-inter mt-6 sm:text-[28px] tablet:text-[31px] desktop:text-[33px] iox:text-[35px] text-[#1A1D1E] leading-7.5 desktop:w-[800px] iox:w-[950px] font-bold mx-auto">
            Apps to Deliver Gifts Anytime
          </p>
          <p className="text-[#222222] sm:mt-2 tablet:mt-3 font-[400] font-inter sm:text-base tablet:text-[17px] desktop:w-[800px] iox:w-[950px] mx-auto leading-[1.3rem]">
            With Enatega, you can create specialized apps for gift delivery that
            cater to a wide variety of needs, from birthdays and anniversaries
            to holidays and corporate gifting. This delivery service app
            provides all the tools your customers need to place orders and your
            delivery team requires to fulfill them efficiently.
          </p>
        </motion.div>
      </div>

      {/* Revamp Your Gift Delivery App Experience With Enatega*/}
        ...
        <div className="sm:w-[280px] mymob:w-[335px] myiphone:w-[385px] tablet:w-[728px] desktop:w-[964px] iox:w-[1140px] py-[50px] mx-auto">
          ...
          >
            ...
            <p className="sm:text-base tablet:text-[17px] font-inter text-center mt-[5px] desktop:w-[475px] iox:w-[500px] mx-auto text-[#222222] ">
              Opt for Enatega’s on-demand gift delivery app development and
              launch a branded app for your gift delivery business.
            </p>
            <p className="sm:text-base tablet:text-[17px] font-inter mt-[2px] text-center desktop:w-[475px] iox:w-[500px] mx-auto  text-[#222222] ">
              Here’s what makes Enatega the top choice for gift delivery app
                ...
                <div className="flex items-center sm:space-x-3 tablet:space-x-3  my-3 ">
                  ...
                  <div>
                    <p className="text-[#1A1D1E] sm:text-[14px] tablet:text-[14.6px] font-sans font-medium desktop:w-[319px]">
                      Separate rider, customer, and restaurant apps
                    </p>
                  </div>
                </div>
                {/* 5th end */}
      ...
      {/*Section Enatega's On-Demand Gift Delivery App Package*/}
      ...
      <div className="sm:my-10 desktop:mt-20 sm:w-[280px] mymob:w-[335px] myiphone:w-[385px]  tablet:w-[708px] desktop:w-[820px] iox:w-[1000px] mx-auto rounded-xl  ">
        <div>
          <motion.p
            ...
            whileInView="show"
            viewport={{ once: true, amount: 0.2 }}
            className="font-inter sm:text-[28px] tablet:text-[31px] desktop:text-[33px] iox:text-[35px] text-[#1A1D1E] sm:leading-7 tablet:leading-9 desktop:leading-10 desktop:w-[800px] iox:w-[650px]  font-bold mb-4"
          >
            Enatega's On-Demand Gift Delivery App Package
          </motion.p>
          ...
          <ul>
            ...
            >
              Enatega’s on-demand gift delivery app offers a smooth and
              convenient experience for your customers. They can browse and
              place orders through a user-friendly interface featuring real-time
              order tracking, tipping options, discounts, and a feedback system.
              This gift delivery app solution makes sending gifts as easy as a
              few clicks.
            </motion.p>
            ...
            <motion.p
              ...
              className="text-[#222222]  font-[400] font-inter sm:text-base tablet:text-[17px]    desktop:w-[800px] iox:w-[980px] leading-[1.3rem]"
            >
              Equip your delivery team with Enatega’s dedicated rider app,
              ensuring timely and accurate deliveries. The rider app includes a
              dual-alert system, order history access, and address mapping,
              helping your team meet the demands of swift on-demand gift
              delivery.
            </motion.p>
            ...
            <motion.p
              ...
              className="text-[#222222]  font-[400] font-inter sm:text-base tablet:text-[17px]    desktop:w-[800px] iox:w-[980px] leading-[1.3rem]"
            >
              Managing your gift delivery business becomes effortless with
              Enatega’s admin dashboard. Oversee delivery zones, schedules, and
              order statuses while ensuring smooth operations with this
              centralized tool for managing your online gift delivery platform.
            </motion.p>
            ...
            <motion.p
              ...
              className="text-[#222222]  font-[400] font-inter sm:text-base tablet:text-[17px]    desktop:w-[800px] iox:w-[980px] leading-[1.3rem]"
            >
              Whether you run a gift shop or manage multiple vendors, Enatega’s
              vendor app allows you to centralize order details, update product
              availability, and manage deliveries. This is essential for
              maintaining efficient gift delivery services while providing
          ...
          >
            Why Choose Enatega to Deliver Gifts?
          </motion.p>
          <motion.p
            variants={fadeIn("up", 0.2, "in")}
            initial="hidden"
          ...
          >
            Enatega’s flexibility and comprehensive feature set make it the
            ideal solution for gift ordering services. Whether you operate a
            small boutique or a large multi-vendor platform, Enatega adapts to
            your unique business needs with ease. With features like real-time
            tracking, customizable delivery options, and seamless vendor
            management, the platform ensures a smooth and efficient operation
