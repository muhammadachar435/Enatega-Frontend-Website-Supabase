...
function MedicineDelievery() {
  ...
  return (
    ...
    <>
      ...
      {/* Content Start  */}
      <div className="sm:mt-26 desktop:mt-33 relative w-full sm:h-[380px] mymob:h-[320px] myiphone:h-[280px] tablet:h-[290px] desktop:h-[310px] iox:h-[320px]">
        <img
          src="/Pictures/Medicinecolorbg.jpg"
          alt=""
          className="w-full sm:h-[380px] mymob:h-[320px] myiphone:h-[280px] tablet:h-[290px] desktop:h-[310px] iox:h-[320px]"
        />
        <div className="absolute sm:px-[20px] mymob:px-[15px] tablet:px-[20px] desktop:px-8 iox:px-4 sm:w-[290px] mymob:w-[355px] myiphone:w-[420px] tablet:w-[728px] desktop:w-[964px] iox:w-[1150px] h-auto font-inter text-[#1A1D1E] iox:left-1/2 iox:-translate-x-1/2 top-1/2 -translate-y-1/2">
          ...
          <p className="sm:text-[32px] mymob:text-[33.5px] capitalize myiphone:text-[34.5px] tablet:text-[39px] desktop:text-[43.5px] iox:text-[50px] font-bold sm:leading-10 tablet:leading-11 desktop:leading-13.5 desktop:w-[964px] iox:w-[1140px] ">
            Transforming Medicine Delivery Services
          </p>
          <p className="sm:text-base tablet:text-[16.5px] font-[400] sm:my-2 desktop:my-[10px]">
            {" "}
            Elevate your customer’s delivery experience with Enatega’s
            ready-to-use 100% customizable medicine delivery app.
          </p>
        </div>
      </div>
      ...
      >
        <img
          ...
          alt=""
          className="sm:w-[260px] mymob:w-[335px] myiphone:w-[365px] sm:h-[460px] mymob:h-[360px] myiphone:h-[340px] tablet:w-[708px] tablet:h-[260px] desktop:h-[240px] desktop:w-[964px] iox:w-[1180px]  mx-auto  rounded-xl "
        />
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 ">
          <p className="text-white font-[400] font-inter sm:text-base tablet:text-[17px] sm:w-[200px] mymob:w-[255px] myiphone:w-[285px] tablet:w-[650px] desktop:w-[542px] iox:w-[640px]">
            Enatega is a versatile multivendor delivery platform initially built
            for food delivery but easily customizable for various industries,
            including healthcare. One of the most significant applications of
            Enatega is as an online medicine delivery app, providing a
            comprehensive solution for pharmacies and healthcare providers eager
            to tap into the booming demand for convenient medicine delivery.
          </p>
        </div>
      </motion.div>
      ...
      {/*  A Customized Medicine Ordering Solution */}
      <motion.div
        variants={fadeIn("up", 0.2, "in")}
        initial="hidden"
        whileInView="show"
      ...
      >
        ...
        <div className="desktop:w-[457px] iox:w-[545px] h-auto sm:mt-2 desktop:mt-0">
          ...
          <p className="text-[#222222] sm:text-base  iox:text-[17px]  mt-[12px] mb-[20px] leading-5.5 font-[400]  desktop:w-[90%]">
            Enatega empowers pharmacies to create a bespoke medicine delivery
            solution that aligns with their brand and customer expectations.
            Whether you are a pharmacy owner or an entrepreneur looking to
            establish a multi-vendor marketplace, our platform simplifies the
            entire process of managing orders, inventory, and deliveries.
            Enatega delivers a seamless, scalable pharmacy delivery software
            that allows customers to access a wide variety of medicines at their
            fingertips.
          </p>
          ...
          >
            {" "}
            Get Started now with our White label Pharmacy app solution
          </Link>
        </div>
      ...
      {/* End  A Customized Medicine Ordering Solution */}

      {/* Section  On-Demand Pharmacy Delivery */}
      <div className="mx-auto relative   ">
        ...
        >
          ...
          <p className="text-[#222222] sm:mt-2 tablet:mt-3 font-[400] font-inter sm:text-base tablet:text-[17px] sm:w-[250px]  mymob:w-[305px]  myiphone:w-[355px] tablet:w-[699px]  desktop:w-[800px] iox:w-[950px] mx-auto leading-[1.3rem]">
            In an era where consumers seek immediate gratification, on-demand
            pharmacy delivery apps have become vital. With Enatega, you can
            provide your customers with an efficient and user-friendly online
            pharmacy delivery app where they can browse, select, and receive
            their medications quickly and safely. As more individuals prefer the
            convenience of online shopping, having an accessible pharmacy
            delivery platform will help your business stay relevant in a
            competitive market.
          </p>
          <Link
            to="/contactus"
      ...
      {/* End Section On-Demand Pharmacy Delivery*/}

      {/*Section "A Flexible Platform for Growing Pharmacies" */}

      <div className="sm:my-10 desktop:my-14 sm:w-[280px] mymob:w-[335px] myiphone:w-[385px] h-auto py-2 tablet:w-[728px] desktop:w-[810px] iox:w-[950px] mx-auto rounded-xl  ">
        <motion.div
          variants={fadeIn("up", 0.2, "in")}
          initial="hidden"
          whileInView="show"
        ...
        >
          <p className="font-inter sm:text-[28px] tablet:text-[31px] desktop:text-[33px] iox:text-[35px] text-[#1A1D1E] sm:leading-7.5 desktop:leading-9 desktop:w-[600px] desktop:mx-0 iox:w-[750px] font-bold mx-auto desktop:tracking-wide">
            A Flexible Platform for Growing Pharmacies
          </p>
          <p className="text-[#222222] sm:mt-2 tablet:mt-3 font-[400] font-inter sm:text-base tablet:text-[17px]    desktop:w-[800px] iox:w-[850px] desktop:mx-0 mx-auto leading-[1.3rem]">
            Whether you are enhancing your existing services or launching a new
            pharmacy delivery app platform, Enatega is designed to accommodate
            your growth. Its robust infrastructure supports small and large
            pharmacies alike, ensuring smooth operations and an optimal user
            experience. Moreover, Enatega ensures adherence to local healthcare
            regulations, making it the perfect platform for pharmacies venturing
            into the medicine delivery market.
          </p>
        </motion.div>
      </div>

      {/*  End "A Flexible Platform for Growing Pharmacies" */}

      {/* Enatega- Scaling Your Medicine Delivery Growth In No Time */}
        ...
        <div className="sm:w-[280px] mymob:w-[335px] myiphone:w-[385px] tablet:w-[728px] desktop:w-[964px] iox:w-[1140px] py-[50px] mx-auto">
          ...
          >
            ...
            <p className="sm:text-base tablet:text-[17px] font-inter text-center mt-[5px] desktop:w-[475px] iox:w-[500px] mx-auto text-[#222222] ">
              Set up your online delivery app and dispatch the highest-quality
              healthcare supplies to your customers with Enatega. Here’s what
              makes Enatega the best choice for your delivery business:
            </p>
          </motion.div>

          {/* Why Choose Enatega Liquor Delivery App [Part] */}
          <motion.div
            variants={fadeIn("up", 0.2, "in")}
            initial="hidden"
            whileInView="show"
            ...
            <div className="w-full tablet:w-[96%] tablet:grid tablet:grid-cols-3  mx-auto">
              ...
              <div>
                ...
                <div className="flex items-center  sm:space-x-2 tablet:space-x-3 mx-auto my-3 ">
                  ...
                  <div>
                    <p className="text-[#1A1D1E] sm:text-[14px] tablet:text-[14.6px] font-sans font-medium ">
                      No per delivery additional charges
                    </p>
                  </div>
                </div>
                {/* 1st end */}
                ...
                <div className="flex items-center sm:space-x-3 tablet:space-x-3  my-3 ">
                  ...
                  <div>
                    <p className="text-[#1A1D1E] sm:text-[14px] tablet:text-[14.6px] font-sans font-medium">
                      Quick five business days app deployment
                    </p>
                  </div>
                </div>
                {/* 2nd end */}
      ...
      {/* End "Enatega- Scaling Your Medicine Delivery Growth In No Time"  */}

      {/* Section Enatega’s Medicine Delivery App Package */}
      ...
      <div className="sm:my-10 desktop:mt-20 sm:w-[280px] mymob:w-[335px] myiphone:w-[385px]  tablet:w-[708px] desktop:w-[820px] iox:w-[1000px] mx-auto rounded-xl  ">
        <div>
          ...
          <ul>
            ...
            >
              Enatega’s medicine delivery app is designed with customers in
              mind, offering a simple yet efficient experience. Users can easily
              browse available medications and place orders through an intuitive
              interface that includes real-time tracking, secure payment
              methods, and a ratings system. This feature-rich on-demand
              pharmacy delivery app ensures that customers enjoy a smooth
            ...
            <motion.p
              ...
              className="text-[#222222]  font-[400] font-inter sm:text-base tablet:text-[17px]    desktop:w-[800px] iox:w-[980px] leading-[1.3rem]"
            >
              Equip your delivery personnel with Enatega’s specialized rider
              app. Featuring efficient route navigation, order history
              management, and real-time GPS tracking, the rider app facilitates
              punctual and reliable deliveries. This tool is essential for
              addressing the specific challenges of medicine delivery, ensuring
              your team can meet customer expectations effectively.
            </motion.p>
            ...
            <motion.p
              ...
              className="text-[#222222]  font-[400] font-inter sm:text-base tablet:text-[17px]    desktop:w-[800px] iox:w-[980px] leading-[1.3rem]"
            >
              Optimize your pharmacy operations with Enatega’s powerful admin
              dashboard. This centralized management tool allows you to oversee
              all aspects of your delivery service, including tracking delivery
              zones, order statuses, and inventory levels. The dashboard is
              particularly useful for managing pharmacy delivery software,
              offering complete oversight of your operations.
            </motion.p>
            ...
            <motion.p
              ...
              className="text-[#222222]  font-[400] font-inter sm:text-base tablet:text-[17px]    desktop:w-[800px] iox:w-[980px] leading-[1.3rem]"
            >
              For pharmacies offering delivery services, Enatega’s vendor app
              serves as a comprehensive management tool. It allows you to
              oversee orders, manage medication availability, and provide
              real-time updates to customers, all from a single, cohesive
              platform. This app is crucial for running a successful pharmacy
              ordering and delivery system, ensuring effective communication
          ...
          >
            Why Choose Enatega for Delivering Medicine?
          </motion.p>
          <motion.p
            variants={fadeIn("up", 0.2, "in")}
            initial="hidden"
          ...
          >
            Enatega’s adaptability and robust features make it the ideal choice
            for pharmacies looking to expand into medicine delivery. Whether
            you’re a small local pharmacy or a large healthcare network, Enatega
            supports a variety of operational models with ease. With essential
            features such as secure user authentication, location-based
            services, and real-time tracking, our platform ensures compliance
            with local regulations while enhancing the overall customer
            experience.
          </motion.p>
          <motion.p
            variants={fadeIn("up", 0.2, "in")}
            ...
            className="text-[#222222] font-[400] font-inter sm:text-base tablet:text-[17px]    desktop:w-[800px] iox:w-[980px] leading-[1.3rem]"
          >
            Kickstart your medicine business today with Enatega’s white-label
            medicine delivery app solution and explore new opportunities for
            growth!
          </motion.p>
        </div>
      </div>
