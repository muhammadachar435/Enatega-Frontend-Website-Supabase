...
function DocumentDelievery() {
  ...
  return (
    ...
    <>
            ...
            <div className="m-2 pr-1 border-r  border-slate-300">
              ...
              <div className="flex items-center space-x-4 mb-8">
                <div className="w-[23px] h-[22px]">
                  <img
                    loading="lazy"
                    src="/Pictures/DocumentDelievery.png"
                    alt=""
                ...
                <div>
                  <Link
                    ...
                    className="font-inter text-base font-bold hover:text-sky-600 duration-300"
                  >
                    DocumentDelievery Assistance Services Solution
                  </Link>
                </div>
              </div>
      ...
      {/* Content Start  */}
      <div className="sm:mt-26 desktop:mt-33 relative w-full sm:h-[350px] mymob:h-[250px] myiphone:h-[230px] tablet:h-[280px] desktop:h-[320px]">
        <img
          src="/Pictures/docdeliverybgColor.jpg"
          alt=""
          className="w-full sm:h-[350px] mymob:h-[250px] myiphone:h-[230px]  tablet:h-[280px]  desktop:h-[320px] "
        />
        <div className="absolute sm:px-[20px] mymob:px-[15px] tablet:px-[20px] desktop:px-8 iox:px-4 sm:w-[290px] mymob:w-[355px] myiphone:w-[420px] tablet:w-[728px] desktop:w-[964px] iox:w-[1150px] h-auto font-inter text-[#1A1D1E] iox:left-1/2 iox:-translate-x-1/2 top-1/2 -translate-y-1/2">
          <p className="sm:text-[22px] font-[500] sm:my-2 iox:my-[6px] leading-[1.4rem] ">
            Document Delivery
          </p>
          ...
          <p className="sm:text-base tablet:text-[16.5px] font-[400] sm:my-2 desktop:my-[10px]">
            {" "}
            Unlock quick growth for your document delivery business with
            Enatega’s document courier service.
          </p>
        </div>
      </div>
      ...
      >
        <img
          ...
          alt=""
          className="sm:w-[260px] mymob:w-[335px] myiphone:w-[365px] sm:h-[500px] mymob:h-[380px] myiphone:h-[360px] tablet:w-[708px] tablet:h-[220px] desktop:h-[240px] iox:h-[220px] desktop:w-[964px] iox:w-[1180px]  mx-auto  rounded-xl bg-no-repeat "
        />
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 ">
          <p className="text-white font-[400] font-inter sm:text-base tablet:text-[17px] sm:w-[200px] mymob:w-[255px] myiphone:w-[285px] tablet:w-[660px] desktop:w-[560px] iox:w-[660px]">
            In industries like legal and professional services, timely and
            secure document delivery is critical. Enatega’s platform offers an
            efficient and customizable solution designed to handle the unique
            demands of legal and official document services. Whether delivering
            contracts, legal notices, or sensitive documents, Enatega’s
            on-demand delivery solution ensures that documents reach their
      ...
      {/*  Deliver Legal Documents with Ease */}
      <motion.div
        variants={fadeIn("up", 0.2, "in")}
        initial="hidden"
        whileInView="show"
      ...
      >
        <div className="desktop:hidden">
          <img
            src="/Pictures/docCart.jpg"
            alt=""
            className="mymob:w-[251px] myiphone:w-[288px] tablet:w-[545px] h-auto mx-auto "
          />
        </div>
        <div className="desktop:w-[457px] iox:w-[700px] h-auto sm:mt-8 desktop:mt-0">
          ...
          <p className="text-[#222222] sm:text-base  iox:text-[17px]  mt-[12px] mb-[20px] leading-5.5 font-[400]  desktop:w-[90%] iox:w-[98%]">
            With Enatega, businesses can launch a reliable legal document
            delivery solution that streamlines operations for law firms, legal
            departments, and notary services.
          </p>

          <p className="text-[#222222] sm:text-base  iox:text-[17px]  mt-[12px] mb-[20px] leading-5.5 font-[400]  desktop:w-[90%] iox:w-[98%]">
            The platform enables professionals to manage deliveries of sensitive
            documents with full tracking, automated notifications, and delivery
            confirmations. This solution ensures that both senders and
            recipients have full visibility throughout the process, giving
            clients peace of mind.
          </p>
          <p className="text-[#222222] sm:text-base  iox:text-[17px]  mt-[12px] mb-[20px] leading-5.5 font-[400]  desktop:w-[90%] iox:w-[98%]">
            By offering delivery services, businesses can deliver an efficient
            and easy-to-use experience to their customers. The app allows
            clients to upload documents, request deliveries, and track their
            status—all while ensuring that legal documents are handled with the
            highest level of security and discretion.
          </p>

          <Link
            to="/contactus"
            className="sm:py-2 tablet:py-3 px-1 text-center sm:w-[280px] mymob:w-[335px] myiphone:w-[385px] tablet:w-[728px] desktop:w-[430px] iox:w-[520px] mx-auto  text-wrap align-center inline-block rounded-md font-inter text-base font-semibold text-[#000000]   border-t-[#a6d1b6]  border-b-3 border-l border-r border-[#558567]  shadow-[inset_0_4px_6px_rgba(0,0,0,0.1),inset_0_1px_2px_rgba(255,255,255,1)]"
            style={{
              backgroundImage:
                " linear-gradient(180deg, #86cba0 0, #6cb487 100%)",
            }}
          >
            {" "}
            Get Started now with for our document delivery app solution
          </Link>
        </div>
      ...
      {/* Section  "A Customizable Roadside Services Solution" */}
      <div className="mx-auto relative   ">
        <img
          src="/Pictures/giftbgimg.jpg"
          alt=""
          className="sm:w-[280px] mymob:w-[335px] myiphone:w-[385px] sm:h-[800px] mymob:h-[650px] myiphone:h-[600px] tablet:w-[728px] tablet:h-[420px]  desktop:h-[440px] desktop:w-[964px] iox:w-[1140px] mx-auto rounded-xl "
        />
        <motion.div
          variants={fadeIn("up", 0.2, "in")}
          initial="hidden"
        ...
        >
          <p className="font-inter sm:text-[28px] tablet:text-[31px] desktop:text-[33px] iox:text-[35px] text-[#1A1D1E] leading-7.5 sm:w-[250px] mymob:w-[305px] myiphone:w-[355px] tablet:w-[699px] desktop:w-[800px] iox:w-[950px] font-bold mx-auto">
            Document Delivery for Legal Professional
          </p>
          <p className="text-[#222222] sm:mt-2 tablet:mt-3 font-[400] font-inter sm:text-base tablet:text-[17px] sm:w-[250px]  mymob:w-[305px]  myiphone:w-[355px] tablet:w-[699px]  desktop:w-[800px] iox:w-[950px] mx-auto leading-[1.3rem]">
            Enatega’s platform makes it easy for legal professionals to request
            deliveries at a moment’s notice. Whether it’s filing important
            papers with the court or delivering sensitive contracts, this
            on-demand legal document delivery solution provides immediate access
            to delivery services. Clients can request pick-ups and have their
            documents delivered in a secure, reliable manner.
          </p>
          <p className="text-[#222222] sm:mt-2 tablet:mt-3 font-[400] font-inter sm:text-base tablet:text-[17px] sm:w-[250px]  mymob:w-[305px]  myiphone:w-[355px] tablet:w-[699px]  desktop:w-[800px] iox:w-[950px] mx-auto leading-[1.3rem]">
            For businesses or law firms that need to frequently deliver official
            documents, Enatega’s legal document delivery app is customizable to
            fit their specific needs. The platform also integrates with existing
            business tools, ensuring that legal documents can be seamlessly
            transferred and tracked through every stage of the process.
          </p>
      ...
      {/*Section "Get Documents Delivered Securely and Reliably" */}
      ...
      <div className="sm:my-10 desktop:my-16 sm:w-[280px] mymob:w-[335px] myiphone:w-[385px] h-auto tablet:w-[728px] desktop:w-[964px] iox:w-[1140px] mx-auto rounded-xl  ">
        ...
        >
          <p className="font-inter sm:text-[28px] tablet:text-[31px] desktop:text-[33px] iox:text-[35px] text-[#1A1D1E] leading-7.5 desktop:w-[800px] iox:w-[950px] font-bold mx-auto">
            Get Documents Delivered Securely and Reliably
          </p>
          <p className="text-[#222222] sm:mt-2 tablet:mt-3 font-[400] font-inter sm:text-base tablet:text-[17px]    desktop:w-[800px] iox:w-[950px] mx-auto leading-[1.3rem]">
            In the legal industry, confidentiality and speed are essential.
            Enatega provides businesses with the tools they need to ensure
            documents are securely delivered without unnecessary delays. With
            built-in tracking and secure access, the platform guarantees that
            sensitive information remains protected from start to finish.
          </p>
          <p className="text-[#222222] sm:mt-2 tablet:mt-3 font-[400] font-inter sm:text-base tablet:text-[17px]    desktop:w-[800px] iox:w-[950px] mx-auto leading-[1.3rem]">
            Businesses can also offer delivery online through the platform,
            providing their clients with the ability to request documents
            remotely. The customizable white label app ensures full transparency
            and secure handling of critical documents at every stage of the
            delivery.
          </p>
        </motion.div>
        <motion.div
        ...
        >
          <p className="font-inter mt-6 sm:text-[28px] tablet:text-[31px] desktop:text-[33px] iox:text-[35px] text-[#1A1D1E] leading-7.5 desktop:w-[800px] iox:w-[950px] font-bold mx-auto">
            A Scalable Solution for Legal Services
          </p>
          <p className="text-[#222222] sm:mt-2 tablet:mt-3 font-[400] font-inter sm:text-base tablet:text-[17px] desktop:w-[800px] iox:w-[950px] mx-auto leading-[1.3rem]">
            Whether you’re a small law firm or a large legal services provider,
            Enatega’s platform can scale to meet your needs. The flexibility of
            the system allows businesses to add new delivery routes, manage
            multiple couriers, and expand service offerings without sacrificing
      ...
      {/*Section "Enabling Your Document Delivery Service’s Success With Enatega" */}
        ...
        <div className="sm:w-[280px] mymob:w-[335px] myiphone:w-[385px] tablet:w-[728px] desktop:w-[964px] iox:w-[1140px] py-[50px] mx-auto">
          ...
          >
            <p className="sm:text-[28px] tablet:text-[31.5px] desktop:text-[32.5px] iox:text-[35.5px] font-inter font-bold text-center sm:leading-7.5 desktop:leading-10 tablet:w-[96%] desktop:w-[86%] iox:w-[850px] mx-auto">
              Enabling Your Document Delivery Service’s Success With Enatega
            </p>
            <p className="sm:text-base tablet:text-[17px] font-inter text-center mt-[5px] desktop:w-[475px] iox:w-[500px] mx-auto text-[#222222] ">
              Launching your own document delivery app successfully in such
              cut-throat competition might seem impossible but Enatega is here
              to turn the impossible into possible.
            </p>
            <p className="sm:text-base tablet:text-[17px] font-inter text-center mt-[5px] desktop:w-[475px] iox:w-[500px] mx-auto text-[#222222] ">
              Here’s what Enatega’s document delivery app offers to help you
          ...
          >
            {/* 1st box */}
            <div className="w-full tablet:w-[96%] tablet:flex tablet:justify-between iox:justify-start iox:space-x-80 mx-auto">
              {/* part 1 */}
              <div>
                {/* 1st row Start */}
              ...
              <div className="iox:w-[400px]">
                ...
                <div className="flex items-center sm:space-x-3 tablet:space-x-3  my-3 ">
                  ...
                  <div>
                    <p className="text-[#1A1D1E] sm:text-[14px] tablet:text-[14.6px] font-sans font-medium">
                      Separate customers, users, and riders app
                    </p>
                  </div>
                </div>
                {/* 4th end */}
      ...
      {/* Section "What’s Included in Enatega’s Document Delivery Package" */}
      ...
      <div className="sm:my-10 desktop:mt-20 sm:w-[280px] mymob:w-[335px] myiphone:w-[385px]  tablet:w-[708px] desktop:w-[820px] iox:w-[1000px] mx-auto rounded-xl  ">
        <div>
          ...
          >
            What’s Included in Enatega’s Document Delivery Package
          </motion.p>
          ...
          <ul>
            ...
            >
              The customer app provides a streamlined experience for users.
              Clients can request delivery of legal documents, upload files, and
              track the status of deliveries in real-time. The app includes
              options for secure payments and notifications, ensuring that
              clients are informed at every step.
            </motion.p>
            ...
            <motion.p
              ...
              className="text-[#222222]  font-[400] font-inter sm:text-base tablet:text-[17px]    desktop:w-[800px] iox:w-[980px] leading-[1.3rem]"
            >
              Enatega’s courier app supports service providers in managing
              document deliveries efficiently. Couriers receive job
              notifications, track delivery routes, and handle real-time updates
              through the courier app. This app makes it easy for service
              providers to manage deliveries and ensure the timely arrival of
              important documents.
            </motion.p>
            ...
            <motion.p
              ...
              className="text-[#222222]  font-[400] font-inter sm:text-base tablet:text-[17px]    desktop:w-[800px] iox:w-[980px] leading-[1.3rem]"
            >
              The Enatega platform includes a powerful admin dashboard that
              allows businesses to manage all aspects of their delivery
              operations. From tracking performance to managing courier
              assignments, the dashboard offers complete control over the
              delivery process.{" "}
            </motion.p>
          </ul>
          ...
          <motion.p
            ...
            whileInView="show"
            viewport={{ once: true, amount: 0.2 }}
            className="font-inter sm:text-[28px] tablet:text-[31px] desktop:text-[33px] iox:text-[35px] text-[#1A1D1E] sm:leading-7.5 tablet:leading-9 desktop:w-[600px] iox:w-[650px]  font-bold"
          >
            Why Choose Enatega to Deliver Documents?
          </motion.p>
          <motion.p
            variants={fadeIn("up", 0.2, "in")}
            initial="hidden"
          ...
          >
            Enatega is the perfect choice for businesses looking to offer
            reliable, secure, and customizable document delivery services. With
            a focus on confidentiality, speed, and user experience, the platform
            ensures that sensitive legal documents are delivered with care.
            Whether you need a white label document delivery app for branded
            services or a fully integrated delivery platform, Enatega has the
            solution for you.
          </motion.p>
          <motion.p
            variants={fadeIn("up", 0.2, "in")}
          ...
          >
            Start offering fast and secure delivery services with Enatega’s
            white label delivery solution today!
          </motion.p>
        </div>
      </div>
...
export default DocumentDelievery;
