...
function FoodBeverage() {
  ...
  return (
    ...
    <>
      ...
      {/* Content Start  */}
      <div className="sm:mt-26 desktop:mt-33 relative w-full sm:h-[380px] mymob:h-[310px] myiphone:h-[280px] desktop:h-[330px] iox:h-[320px] ">
        <img
          src="/Pictures/foodbgcolor.jpg"
          alt=""
          className="w-full sm:h-[380px] mymob:h-[310px] myiphone:h-[280px] desktop:h-[330px] iox:h-[320px] "
        />
        <div className="absolute sm:px-[20px] mymob:px-[15px] tablet:px-[20px] desktop:px-8 iox:px-4 sm:w-[290px] mymob:w-[355px] myiphone:w-[420px] tablet:w-[728px] desktop:w-[964px] iox:w-[1150px] h-auto font-inter text-[#1A1D1E] iox:left-1/2 iox:-translate-x-1/2 top-1/2 -translate-y-1/2">
          ...
          <p className="sm:text-[32px] mymob:text-[33.5px] capitalize myiphone:text-[34.5px] tablet:text-[39px] desktop:text-[43.5px] iox:text-[50px] font-bold sm:leading-10 tablet:leading-11 desktop:leading-13.5 desktop:w-[964px] iox:w-[1140px] ">
            Manage Food and Beverage Delivery with Ease
          </p>
          <p className="sm:text-base tablet:text-[16.5px] font-[400] sm:my-2 desktop:my-[10px]">
            {" "}
            Get the ready-to-use food and beverage delivery solution and launch
            your online delivery operations in just five business days
          </p>
        </div>
      </div>
      ...
      >
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 ">
          <p className="text-white font-[400] font-inter sm:text-base tablet:text-[17px] sm:w-[200px] mymob:w-[255px] myiphone:w-[285px] tablet:w-[650px] desktop:w-[542px] iox:w-[640px]">
            The food and beverage industry is rapidly evolving, and businesses
            need innovative tools to stay competitive. Enatega provides a
            customizable food and beverage delivery platform designed to
            streamline operations, enhance customer experiences, and boost
            efficiency. Whether managing a single restaurant or a chain of
            outlets, Enatega offers an all-in-one solution tailored to the
            unique demands of the food and beverage market.
          </p>
        </div>
      </motion.div>
      ...
      {/*  Streamlined Food and Beverage Operations */}
      <motion.div
        variants={fadeIn("up", 0.2, "in")}
        initial="hidden"
        whileInView="show"
      ...
      >
        ...
        <div className="desktop:w-[457px] iox:w-[600px] h-auto sm:mt-8 desktop:mt-0">
          ...
          <p className="text-[#222222] sm:text-base  iox:text-[17px]  mt-[12px] mb-[20px] leading-5.5 font-[400]  desktop:w-[90%]">
            Enatega simplifies every aspect of running any food or beverage shop
            through its comprehensive food ordering and delivery system.
            Restaurants, cafes, and beverage vendors can easily manage orders,
            update menus, track deliveries, and communicate with couriers in
            real-time. This powerful delivery software solution helps businesses
            optimize workflows, reduce errors, and ensure on-time delivery.
          </p>

          <p className="text-[#222222] sm:text-base  iox:text-[17px]  mt-[12px] mb-[20px] leading-5.5 font-[400]  desktop:w-[90%]">
            Additionally, businesses can launch their own white-label food and
            beverage delivery app solution, allowing them to offer customers a
            fully branded, intuitive app experience. This ensures that the
            company maintains its unique identity while offering customers the
            convenience of ordering directly through the app.
          </p>
          ...
          >
            {" "}
            Get Started now with food and beverage delivery solution
          </Link>
        </div>
      ...
      {/* End  Streamlined Food and Beverage Operationsn */}

      {/* Section  On-Demand Delivery for Businesses*/}
      <div className="mx-auto relative   ">
        ...
        >
          <p className="font-inter sm:text-[28px] tablet:text-[31px] desktop:text-[33px] iox:text-[35px] text-[#1A1D1E] leading-7.5 sm:w-[250px] mymob:w-[305px] myiphone:w-[355px] tablet:w-[699px] desktop:w-[800px] iox:w-[950px] font-bold mx-auto">
            On-Demand Delivery for Businesses
          </p>
          <p className="text-[#222222] sm:mt-2 tablet:mt-3 font-[400] font-inter sm:text-base tablet:text-[17px] sm:w-[250px]  mymob:w-[305px]  myiphone:w-[355px] tablet:w-[699px]  desktop:w-[800px] iox:w-[950px] mx-auto leading-[1.3rem]">
            With the growing demand for fast service, Enatega enables businesses
            to offer an efficient on-demand food and beverage delivery app.
            Customers can order their favorite meals or beverages from local
            vendors and track the status of their deliveries in real-time. This
            ensures customers receive their orders quickly, enhancing customer
      ...
      {/*Section "A Flexible Platform for Growing Pharmacies" */}

      {/*Section Comprehensive Software for Vendors */}

      <div className="sm:my-10 desktop:my-16 h-auto sm:w-[280px] mymob:w-[335px] myiphone:w-[385px] tablet:w-[728px]  desktop:w-[964px] iox:w-[1140px] mx-auto rounded-xl  ">
        <motion.div
          variants={fadeIn("up", 0.2, "in")}
          initial="hidden"
          whileInView="show"
        ...
        >
          <p className="font-inter sm:text-[28px] tablet:text-[31px] desktop:text-[33px] iox:text-[35px] text-[#1A1D1E] leading-7.5 desktop:w-[800px] iox:w-[950px] font-bold mx-auto">
            Comprehensive Software for Vendors
          </p>
          <p className="text-[#222222] sm:mt-2 tablet:mt-3 font-[400] font-inter sm:text-base tablet:text-[17px]    desktop:w-[800px] iox:w-[950px] mx-auto leading-[1.3rem]">
            Enatega’s app platform is designed to support vendors with features
            such as order management, inventory tracking, and real-time
            communication with delivery couriers. The beverage ordering and
            delivery system allows businesses to handle high volumes of orders
            while maintaining accuracy and timeliness.
          </p>
          <p className="text-[#222222] sm:mt-2 tablet:mt-3 font-[400] font-inter sm:text-base tablet:text-[17px]    desktop:w-[800px] iox:w-[950px] mx-auto leading-[1.3rem]">
            Automated dispatch and route optimization features help businesses
            streamline deliveries, ensuring that food and drinks arrive fresh
            and on time. This flexibility makes it an ideal food and beverage
            solution for businesses looking to enhance their delivery services
        ...
        >
          ...
          <p className="text-[#222222] sm:mt-2 tablet:mt-3 font-[400] font-inter sm:text-base tablet:text-[17px] desktop:w-[800px] iox:w-[950px] mx-auto leading-[1.3rem]">
            Enatega’s food and beverage delivery software solution is scalable,
            making it suitable for businesses of all sizes. Whether you’re a
            small local business or a large food and beverage chain, Enatega
            adapts to meet your operational needs. With its robust
            infrastructure, businesses can easily add new features as they grow,
      ...
      {/*Section  Scale Your Food And Beverage Delivery Operations With Enatega */}
        ...
        <div className="sm:w-[280px] mymob:w-[335px] myiphone:w-[385px] tablet:w-[728px] desktop:w-[964px] iox:w-[1140px] py-[50px] mx-auto">
          ...
          >
            <p className="sm:text-[28px] tablet:text-[31.5px] desktop:text-[32.5px] iox:text-[35.5px] font-inter font-bold text-center sm:leading-7.5 desktop:leading-10 tablet:w-[96%] desktop:w-[86%] iox:w-[850px] mx-auto">
              Scale Your Food And Beverage Delivery Operations With Enatega
            </p>
            <p className="sm:text-base tablet:text-[17px] font-inter text-center mt-[5px] desktop:w-[475px] iox:w-[500px] mx-auto text-[#222222] ">
              Take your business to the next level with Enatega’s restaurant
              delivery software which is the leading food delivery solution in
              the market today.
            </p>
            <p className="sm:text-base tablet:text-[17px] font-inter text-center desktop:w-[540px] iox:w-[550px] mx-auto text-[#222222] ">
              Here’s what makes it the best option for food and beverage
              delivery:
            </p>
          </motion.div>
      ...
      {/* Section "What’s Included in Enatega’s Food and Beverage Package"*/}
      ...
      <div className="sm:my-10 desktop:mt-20 sm:w-[280px] mymob:w-[335px] myiphone:w-[385px]  tablet:w-[708px] desktop:w-[820px] iox:w-[1000px] mx-auto rounded-xl  ">
        <div>
          ...
          >
            Enatega’s Medicine Delivery App Package
          </motion.p>
          ...
          <ul>
            ...
            >
              The food and beverage app offers a seamless experience for
              customers, allowing them to browse menus, place orders, and track
              their deliveries with ease. The app includes features such as
              real-time order tracking, secure payments, special offers, and
            ...
            <motion.p
              ...
              className="text-[#222222]  font-[400] font-inter sm:text-base tablet:text-[17px]    desktop:w-[800px] iox:w-[980px] leading-[1.3rem]"
            >
              The rider app empowers delivery personnel with tools to manage
              deliveries efficiently. With GPS navigation, real-time updates,
              and delivery instructions, couriers can ensure accurate and timely
              service. This is a key feature of Enatega’s delivery platform,
              ensuring that couriers stay on track and manage multiple
              deliveries smoothly.
            </motion.p>
            ...
            <motion.p
              ...
              className="text-[#222222]  font-[400] font-inter sm:text-base tablet:text-[17px]    desktop:w-[800px] iox:w-[980px] leading-[1.3rem]"
            >
              The admin dashboard offers full visibility into the business’s
              operations, making it easy to manage delivery zones, order
              statuses, and performance analytics. This feature-packed food and
              beverage delivery app platform gives businesses the insights they
              need to continuously improve their services and operations.
            </motion.p>
            ...
            <motion.p
              ...
              className="text-[#222222]  font-[400] font-inter sm:text-base tablet:text-[17px]    desktop:w-[800px] iox:w-[980px] leading-[1.3rem]"
            >
              endors can manage their orders, update menu items, and track
              deliveries from a single platform. Enatega’s food and beverage
              delivery software simplifies the entire process for restaurant
              owners and managers, ensuring seamless communication between
              customers, couriers, and vendors.
            </motion.p>
          </ul>
          ...
          >
            Enatega’s food and beverage delivery platform offers a fully
            customizable solution that can handle everything from order
            management to delivery tracking. By streamlining operations and
            offering a user-friendly customer experience, it’s the ideal
            platform for businesses looking to improve their food and beverage
            delivery service.
          </motion.p>
          <motion.p
            variants={fadeIn("up", 0.2, "in")}
            ...
            className="text-[#222222] font-[400] font-inter sm:text-base tablet:text-[17px]    desktop:w-[800px] iox:w-[980px] leading-[1.3rem]"
          >
            Elevate your food or beverage shop’s services with Enatega today,
            and provide customers with a fast, reliable, and personalized
            ordering experience!
          </motion.p>
        </div>
      </div>
