...
function CourierDelievery() {
  ...
  return (
    ...
    <>
      ...
      {/* Content Start  */}
      <div className="sm:mt-26 desktop:mt-33 relative w-full sm:h-[330px] mymob:h-[310px] myiphone:h-[250px] tablet:h-[280px] desktop:h-[320px]">
        <img
          src="/Pictures/CourierbgColor.jpg"
          alt=""
          className="w-full sm:h-[330px] mymob:h-[310px] myiphone:h-[280px] desktop:h-[320px] "
        />
        <div className="absolute sm:px-[20px] mymob:px-[15px] tablet:px-[20px] desktop:px-8 iox:px-4 sm:w-[290px] mymob:w-[355px] myiphone:w-[420px] tablet:w-[728px] desktop:w-[964px] iox:w-[1150px] h-auto font-inter text-[#1A1D1E] iox:left-1/2 iox:-translate-x-1/2 top-1/2 -translate-y-1/2">
          ...
          <p className="sm:text-[32px] mymob:text-[33.5px] capitalize  myiphone:text-[34.5px] tablet:text-[39px] desktop:text-[43.5px] iox:text-[50px] font-bold sm:leading-10 tablet:leading-11 desktop:leading-13.5 desktop:w-[964px] iox:w-[1140px] ">
            Deliver Mail and Parcels with Courier Delivery
          </p>
          <p className="sm:text-base tablet:text-[16.5px] font-[400] sm:my-2 desktop:my-[10px]">
            {" "}
            Kickstart your courier and parcel delivery ready-to-use on-demand
            courier app to streamline your courier delivery operations.
          </p>
        </div>
      </div>
      ...
      >
        <img
          ...
          alt=""
          className="sm:w-[260px] mymob:w-[335px] myiphone:w-[365px] sm:h-[500px] mymob:h-[400px] myiphone:h-[350px] tablet:w-[708px] tablet:h-[260px] desktop:h-[240px] desktop:w-[964px] iox:w-[1180px]  mx-auto  rounded-xl "
        />
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 ">
          <p className="text-white font-[400] font-inter sm:text-base tablet:text-[17px] sm:w-[200px] mymob:w-[255px] myiphone:w-[285px] tablet:w-[650px] desktop:w-[542px] iox:w-[640px]">
            The logistics industry is rapidly evolving, and businesses need
            innovative solutions to keep pace with customer expectations.
            Enatega’s multi vendor platform goes beyond traditional
            applications, transforming into a state-of-the-art courier delivery
            solution that caters to a wide range of parcel delivery services.
            Designed to be flexible and scalable, this platform helps businesses
            to offer seamless and efficient courier and mail delivery services.
          </p>
        </div>
      </motion.div>
      ...
      {/*  Simplifying Parcel Management and Delivery*/}
      <motion.div
        variants={fadeIn("up", 0.2, "in")}
        initial="hidden"
        whileInView="show"
      ...
      >
        <div className="desktop:hidden">
          <img
            src="/Pictures/CourierDeliver.jpg"
            alt=""
        ...
        <div className="desktop:w-[457px] iox:w-[600px] h-auto sm:mt-8 desktop:mt-0">
          ...
          <p className="text-[#222222] sm:text-base  iox:text-[17px]  mt-[12px] mb-[20px] leading-5.5 font-[400]  desktop:w-[90%] iox:w-[96%]">
            Enatega’s customizable courier delivery platform streamlines the
            entire parcel delivery process, from order management to final
            delivery. Whether it’s for a local courier service or nationwide
            logistics, this platform provides businesses with the necessary
            tools to handle operations efficiently. Through Enatega, companies
            can develop their own courier delivery app that connects customers,
            couriers, and vendors with real-time tracking and detailed delivery
            status updates.
          </p>

          <p className="text-[#222222] sm:text-base  iox:text-[17px]  mt-[12px] mb-[20px] leading-5.5 font-[400]  desktop:w-[90%] iox:w-[96%]">
            With Enatega’s parcel delivery software, businesses can easily
            integrate features like automatic route optimization and delivery
            scheduling, ensuring that customers receive parcels on time while
            reducing operational costs. This user-friendly system simplifies the
            way couriers manage deliveries, providing instant access to all
          ...
          >
            {" "}
            Get Started now with our courier service app solution
          </Link>
        </div>
      ...
      {/* Section  On-Demand Parcel and Courier Services */}
      <div className="mx-auto relative   ">
        <img
          src="/Pictures/giftbgimg.jpg"
          alt=""
          className="sm:w-[280px] mymob:w-[335px] myiphone:w-[385px] sm:h-[800px] mymob:h-[700px] myiphone:h-[600px] tablet:w-[728px] tablet:h-[420px]  desktop:h-[400px] desktop:w-[964px] iox:w-[1140px] mx-auto rounded-xl "
        />
        <motion.div
          variants={fadeIn("up", 0.2, "in")}
          initial="hidden"
        ...
        >
          <p className="font-inter sm:text-[28px] tablet:text-[31px] desktop:text-[33px] iox:text-[35px] text-[#1A1D1E] leading-7.5 sm:w-[250px] mymob:w-[305px] myiphone:w-[355px] tablet:w-[699px] desktop:w-[800px] iox:w-[950px] font-bold mx-auto">
            On-Demand Parcel and Courier Services
          </p>
          <p className="text-[#222222] sm:mt-2 tablet:mt-3 font-[400] font-inter sm:text-base tablet:text-[17px] sm:w-[250px]  mymob:w-[305px]  myiphone:w-[355px] tablet:w-[699px]  desktop:w-[800px] iox:w-[950px] mx-auto leading-[1.3rem]">
            Customers today expect fast and flexible delivery options. Enatega’s
            platform allows businesses to build a highly functional on-demand
            courier delivery app, where customers can schedule or request
            immediate parcel pickups with just a few clicks. This application
            for courier service includes live tracking, giving customers full
            visibility into their deliveries, fostering trust and improving
            customer loyalty.
          </p>
          <p className="text-[#222222] sm:mt-2 tablet:mt-3 font-[400] font-inter sm:text-base tablet:text-[17px] sm:w-[250px]  mymob:w-[305px]  myiphone:w-[355px] tablet:w-[699px]  desktop:w-[800px] iox:w-[950px] mx-auto leading-[1.3rem]">
            Whether handling urgent documents, packages, or bulk deliveries,
            businesses can benefit from Enatega’s advanced courier delivery
            software solution. The software provides automated dispatching and
            real-time delivery tracking, allowing couriers to stay efficient and
            on schedule, even in high-demand situations.
          </p>
      ...
      {/*Section Optimized for Multi Vendor Operations */}
      ...
      <div className="sm:my-10 desktop:my-16 sm:w-[280px] mymob:w-[335px] myiphone:w-[385px] h-auto tablet:w-[728px] desktop:w-[964px] iox:w-[1140px] mx-auto rounded-xl  ">
        ...
        >
          <p className="font-inter sm:text-[28px] tablet:text-[31px] desktop:text-[33px] iox:text-[35px] text-[#1A1D1E] leading-7.5 desktop:w-[800px] iox:w-[950px] font-bold mx-auto">
            Optimized for Multi Vendor Operations
          </p>
          <p className="text-[#222222] sm:mt-2 tablet:mt-3 font-[400] font-inter sm:text-base tablet:text-[17px]    desktop:w-[800px] iox:w-[950px] mx-auto leading-[1.3rem]">
            Enatega stands out by offering full support for multi vendor
            businesses, making it ideal for courier companies that work with
            multiple vendors or delivery partners. This courier delivery system
            provides vendors with easy access to inventory and delivery data,
            helping them coordinate with couriers and ensure smooth operations
            across multiple channels.
          </p>
          <p className="text-[#222222] sm:mt-2 tablet:mt-3 font-[400] font-inter sm:text-base tablet:text-[17px]    desktop:w-[800px] iox:w-[950px] mx-auto leading-[1.3rem]">
            Vendors can use the platform to update parcel statuses in real-time,
            track orders from dispatch to delivery, and manage multiple courier
            relationships seamlessly. Enatega’s parcel delivery app offers both
            scalability and flexibility, making it perfect for businesses
            looking to expand their courier services across different regions.
          </p>
        </motion.div>
      </div>
      {/*  End */}

      {/*Section  Transform Your Courier Delivery Experience With Enatega */}
        ...
        <div className="sm:w-[280px] mymob:w-[335px] myiphone:w-[385px] tablet:w-[728px] desktop:w-[964px] iox:w-[1140px] py-[50px] mx-auto">
          ...
          >
            <p className="sm:text-[28px] tablet:text-[31.5px] desktop:text-[32.5px] iox:text-[35.5px] font-inter font-bold text-center sm:leading-7.5 desktop:leading-10 tablet:w-[96%] desktop:w-[86%] iox:w-[850px] mx-auto">
              Transform Your Courier Delivery Experience With Enatega
            </p>
            <p className="sm:text-base tablet:text-[17px] font-inter text-center mt-[5px] desktop:w-[475px] iox:w-[500px] mx-auto text-[#222222] ">
              Take your courier delivery business to new heights by enabling
              online courier delivery services.
            </p>
            <p className="sm:text-base tablet:text-[17px] font-inter text-center desktop:w-[540px] iox:w-[550px] mx-auto text-[#222222] ">
              Here’s what makes Enatega the leading courier delivery app
              provider:
            </p>
          </motion.div>
                ...
                <div className="flex items-center sm:space-x-3 tablet:space-x-3  my-3 ">
                  ...
                  <div>
                    <p className="text-[#1A1D1E] sm:text-[14px] tablet:text-[14.6px] font-sans font-medium tablet:w-[280px]">
                      Separate apps for riders, customers, and restaurants
                    </p>
                  </div>
                </div>
                {/* 6th end */}
      ...
      {/* Section "Key Features for Successful Courier Services Customer App"*/}
      ...
      <div className="sm:my-10 desktop:mt-20 sm:w-[280px] mymob:w-[335px] myiphone:w-[385px]  tablet:w-[708px] desktop:w-[820px] iox:w-[1000px] mx-auto rounded-xl  ">
        <div>
          ...
          >
            Key Features for Successful Courier Services Customer App
          </motion.p>
          ...
          <ul>
            ...
            <motion.p
              ...
              className="text-[#222222]  font-[400] font-inter sm:text-base tablet:text-[17px]    desktop:w-[800px] iox:w-[980px] leading-[1.3rem]"
            >
              Enatega’s dedicated rider app is built to handle the fast pace of
              courier services. With GPS navigation, delivery instructions, and
              route optimization, the app ensures efficient, timely deliveries.
            </motion.p>
            ...
            <motion.p
              ...
              className="text-[#222222]  font-[400] font-inter sm:text-base tablet:text-[17px]    desktop:w-[800px] iox:w-[980px] leading-[1.3rem]"
            >
              The admin dashboard provides detailed insights into every part of
              the business, from delivery metrics to performance analysis. This
              makes it simple to manage zones, schedules, and couriers all in
              one place, ensuring smooth operations.
            </motion.p>
            ...
            <motion.p
              ...
              className="text-[#222222]  font-[400] font-inter sm:text-base tablet:text-[17px]    desktop:w-[800px] iox:w-[980px] leading-[1.3rem]"
            >
              The vendor app enables businesses to manage their couriers,
              parcels, and inventory in one place, making communication and
              order management easier.
            </motion.p>
          </ul>
          ...
          >
            Enatega’s courier delivery software offers a highly adaptable
            infrastructure that allows businesses to scale as their operations
            grow. Its modular design ensures that new features can be added with
            ease, whether the business focuses on local deliveries or expands
            into national logistics. For companies looking to develop an
            advanced courier service application, Enatega delivers a
            technology-driven solution that’s built for growth.
          </motion.p>
          <motion.p
            variants={fadeIn("up", 0.2, "in")}
            initial="hidden"
          ...
          >
            By harnessing the power of Enatega’s courier delivery solution,
            businesses can optimize operations, reduce costs, and improve the
            customer experience. Its all-in-one platform addresses the evolving
            needs of the logistics industry, making it the ultimate choice for
            companies ready to take their courier services to the next level.
          </motion.p>
          <motion.p
            variants={fadeIn("up", 0.2, "in")}
            initial="hidden"
            ...
            className="text-[#222222] font-[400] font-inter sm:text-base tablet:text-[17px]    desktop:w-[800px] iox:w-[980px] leading-[1.3rem]"
          >
            Start revolutionizing your delivery operations today with Enatega’s
            innovative courier delivery software solution, and provide your
            customers with the fast, reliable service they demand.
          </motion.p>
        </div>
      </div>
...
export default CourierDelievery;
