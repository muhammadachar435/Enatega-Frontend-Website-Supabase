...
function EasyEats() {
  ...
  return (
    ...
    <>
      ...
      {/* Content */}
      <div className="relative  sm:mt-26 iox:mt-[130px] w-full sm:h-[95vh] mymob:h-[70vh] tablet:h-[75vh]">
        <div>
          <img
            loading="lazy"
            src="/Pictures/easy-eats-banner.jpg"
            alt=""
            className="w-full sm:h-[95vh] mymob:h-[70vh] tablet:h-[75vh]"
          />
        </div>
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
          ...
          {/* Text */}
          <div className="sm:leading-8 tablet:leading-10  desktop:leading-12 font-inter mt-2 sm:w-[280px]  mymob:w-[335px] myiphone:w-[376px] tablet:w-[708px] desktop:w-[465px] desktop:h-auto desktop:mx-auto iox:w-[510px] iox:h-auto iox:leading-14 biglap:w-[1280px] biglap:h-auto mb-5 text-center ">
            ...
            <p className="text-[#222222] text-[17px] mt-2 ">
              Easy Eats Campus food delivery company
            </p>
          </div>
        </div>
      </div>
      ...
      {/* Section What is EasyEats */}
      <motion.div
        variants={fadeIn("up", 0.2)}
        initial="hidden"
        whileInView={"show"}
        viewport={{ once: true, amount: 0.1 }}
        className="relative sm:w-[280px] mymob:w-[335px] myiphone:w-[385px] tablet:w-[728px] desktop:w-[954px] iox:w-[1140px] h-auto  mx-auto sm:mt-7 mymob:mt-0"
      >
        <img
          loading="lazy"
          src="/Pictures/easy-eatsbackgroud.jpg"
          alt="Sample"
          className="sm:w-[280px] z-[-1] mymob:w-[335px] sm:h-[440px] mymob:h-[550px] myiphone:h-[475px] tablet:h-[350px] myiphone:w-[385px] tablet:w-[705px] desktop:w-[930px] desktop:h-[320px] iox:w-[1140px] iox:h-[300px]  bg-no-repeat bg-center bg-fixed bg-cover rounded-2xl"
        />
        <motion.div
          variants={fadeIn("up", 0.2)}
          initial="hidden"
          whileInView={"show"}
          viewport={{ once: true, amount: 0.1 }}
          className="bg-black opacity-50 z-[50] absolute sm:top-0  sm:px-5 mymob:px-6 mymob:py-10 myiphone:px-5 desktop:px-10 iox:px-26 font-inter rounded-2xl"
        >
          <p className=" text-white sm:text-[28px] tablet:text-[31.5px] iox:text-4xl font-bold bg-transparent py-1 tracking-wide tablet:w-[668px] desktop:w-[850px] iox:w-[950px] sm:mt-3 mymob:mt-2 tablet:mt-4 iox:mt-5 tablet:mx-auto capitalize">
            Introduction
          </p>
          <p className=" text-white sm:text-sm mymob:text-base tablet:text-base tablet:w-[668px] desktop:w-[800px] iox:w-[950px] sm:mt-3 mymob:mt-2 font-inter bg-transparent py-1 rounded">
            Easy Eats is a campus and dormitory food delivery service developed
            by Ninjas Code and powered by Enatega. Easy Eats is specifically
            made for college students who want food delivered to their dorm
            rooms or within their college campuses.
          </p>
          <p className=" text-white sm:text-sm mymob:text-base tablet:text-base tablet:w-[668px] desktop:w-[790px] iox:w-[950px] sm:mt-3 mymob:mt-2  font-inter bg-transparent py-1 rounded">
            It stands out from other food delivery services like UberEats and
            Grubhub by focusing on employing only student drivers and having
            more options available for college students than they would normally
            get on other similar services, while also emphasising student
            focused features.
          </p>
        </motion.div>
      </motion.div>
      {/* End Section What is EasyEats */}

      {/* EASY EATS: Getting Started*/}
      <motion.div
        variants={fadeIn("up", 0.2)}
        initial="hidden"
        whileInView={"show"}
      ...
      >
        ...
        <p className="text-[#222222] text-base mt-[10px] mb-[20px] leading-5.5 font-[400] iox:w-[964px]">
          Easy Eats started out as a passion project by a few college students,
          looking to make their fellow academic’s life easier on campus. The
          pioneers of the project started out by entering the Greenlight Maine
          competition. The competition focuses on entrepreneurs and innovators
          from all industries, and also encourages college students to present
          their ideas in order to get funding and get their startup up and
          running.
        </p>
        <p className="text-[#222222] text-base mt-[10px] mb-[20px] leading-5.5 font-[400] iox:w-[964px]">
          Before that however, Easy Eats reached out to the Ninjas Code team in
          order to help set up a solution that would cater to college students
          while still providing all of the features that most competitors have
          in the same space. They needed an app that would get early investors
          interested while providing a unique user experience that couldn’t be
          found in any of the competing apps. Thanks to the customizability of
          the Enatega solution, the process of building the perfect college food
          delivery app was made a lot smoother. That isn’t to say that there
          weren’t a few hurdles along the way; that’s just how software
          development works!
        </p>
        <hr className="text-gray-100 border-[1.8px] sm:mt-8 tablet:mt-18" />
      </motion.div>

      {/* End Section EASY EATS: Getting Started */}
      ...
      >
        ...
        <p className="text-[#222222] text-base mt-[10px] mb-[20px] leading-5.5 font-[400] iox:w-[964px]">
          The Easy Eats team laid out the features and customizations that they
          needed for their unique food delivery application. As is standard with
          any development process, Ninjas Code began by gathering the
          requirements of the Easy Eats team and created a step by step process
          of implementing the required features. A clear roadmap was created in
          order to keep the development on track and to provide a clear vision
          of the timelines that the project was expected to follow.
        </p>
        <ul className="">
          ...
          <p className="text-[#222222] text-base mt-[10px] mb-[20px] leading-5.5 font-[400] iox:w-[964px]">
            The first thing that the Ninjas Code team needed to focus on was
            creating a clean and user friendly user experience for the college
            students who would not only be using the app to order food but also
            deliver it themselves. The design team from Ninjas Code crafted a
            sleek and intuitive user interface that was in line with the Easy
            Eats brand. With an easy user onboarding flow and a modern user
            experience, the team brought Easy Eats vision to life.
          </p>
          <li className="text-[#1A1D1E] text-lg font-semibold leading-5">
            Student-Focused Features
          </li>
          <p className="text-[#222222] text-base mt-[10px] mb-[20px] leading-5.5  font-[400]  iox:w-[964px]">
            As the target audience for Easy Eats was mainly college students,
            the features had to be focused around them as well. The big one
            being the ability to order food directly to your dorm room with a
            few friends. Group ordering was added to the app to cater to college
            students who were sharing their dorm room with one or more of their
            fellow dorm mates.
          </p>
          <li className="text-[#1A1D1E] text-lg font-semibold leading-5">
          ...
          <p className="text-[#222222] text-base mt-[12px] mb-[20px] leading-5.5 font-[400]  iox:w-[964px]">
            The riders for the Easy Eats app were all going to be other
            students. This was crucial to make quick deliveries directly to dorm
            rooms as student drivers were expected to be knowledgeable about the
            college’s locations and could deliver the student’s orders directly
            to their dorm room without getting lost.
          </p>
          <p className="text-[#222222] text-base mt-[12px] mb-[20px] leading-5.5 font-[400]  iox:w-[964px]">
            The Ninjas Code team made sure that the rider onboarding process for
            students was easy and straight-forward so that Easy Eats could
            onboard as many riders as quickly as possible.
          </p>
          <li className="text-[#1A1D1E] text-lg font-semibold leading-5">
            Automatic Payment for Riders and Restaurants
          </li>
          <p className="text-[#222222] text-base mt-[12px] mb-[20px] leading-5.5 font-[400]  iox:w-[964px]">
            The development team added a wallet feature for riders and
            restaurants to make the payment function automated while being
            easily accessible. Both the restaurants and riders could get their
            funds transferred to their accounts directly from their wallets
            almost immediately whenever they wanted.
          </p>
        </ul>
        <hr className="text-gray-100 border-[1.8px] sm:mt-8 tablet:mt-18" />
      </motion.div>
      {/* End Section The Development Journey */}
      ...
      >
        ...
        <p className="text-[#222222] sm:text-base  iox:text-[17px]  mt-[12px] mb-[20px] leading-5.5 font-[400]  desktop:w-[90%]">
          Once all of the requested features for version 1.0 were ready, the app
          was ready for launch. The Easy Eats pioneers joined the Greenlight
          Maine competition and presented their app to the judges. After
          presenting all of their apps unique features, the Easy Eats team won
          the competition along with $25,000 which went into expanding their
          operations.
        </p>
        <p className="text-[#222222] sm:text-base iox:text-[17px] mt-[12px] mb-[20px] leading-5.5 font-[400]  desktop:w-[90%]">
          Afterwards, they launched the app across their own College in Maine
          and expanded operations to other surrounding Universities as well.
        </p>
        <div className="w-full relative ">
          {!showVideo ? (
            <div className="">
              <img
                loading="lazy"
                src="/Pictures/easy-eats-thumbnail.jpg"
                alt="Video Thumbnail"
                className="sm:w-full sm:max-w-[400px]  sm:h-[215px] tablet:w-full tablet:max-w-[700px] tablet:h-[400px] desktop:w-full desktop:max-w-[800px] mx-auto  iox:w-full iox:max-w-[800px] iox:h-[446px]"
              />
              <img
                loading="lazy"
              ...
              <button
                onClick={handlePlay}
                className="absolute cursor-pointer h-4 text-center sm:top-1/2 sm:left-[50%] transform -translate-x-1/2 -translate-y-1/2 w-[20px]"
              ></button>
            </div>
          ) : (
            <iframe
              loading="lazy"
              src="https://player.vimeo.com/video/1074277173?autoplay=1&muted=1&controls=1&h=75bb142950"
              width="100%"
              height="100%"
              frameBorder="0"
      ...
      >
        <div className="desktop:hidden">
          ...
          <img
            loading="lazy"
            src="/Pictures/easyEatsConclusion.jpg"
            alt=""
            className=""
          />
        </div>
        <div className="desktop:w-[457px] iox:w-[545px] h-auto">
          ...
          <p className="text-[#222222] sm:text-base  iox:text-[17px]  mt-[12px] mb-[20px] leading-5.5 font-[400]  desktop:w-[90%]">
            Easy Eats is a prime example of how a focused, community-driven
            approach can create a successful and impactful service. By
            understanding and addressing the unique needs of college students,
            and making the most of their strategic partnerships, Easy Eats has
            carved out a niche in the local food delivery market. The journey
            from a passion project to a thriving business is a testament to what
            a good idea and steely determination can help achieve.
          </p>
        </div>
