...
function LiquorDelievery() {
  ...
  return (
    ...
    <>
      ...
      {/* Content Start  */}
      <div className="sm:mt-26 desktop:mt-33 relative w-full sm:h-[380px] mymob:h-[320px] myiphone:h-[260px] tablet:h-[290px] desktop:h-[380px] iox:h-[310px]">
        <img
          src="/Pictures/LiquorbgColor.jpg"
          alt=""
          className="w-full sm:h-[380px] mymob:h-[320px] myiphone:h-[260px] tablet:h-[290px] desktop:h-[380px] iox:h-[310px]"
        />
        <div className="absolute sm:px-[20px] mymob:px-[15px] tablet:px-[20px] desktop:px-8 iox:px-4 sm:w-[290px] mymob:w-[355px] myiphone:w-[420px] tablet:w-[728px] desktop:w-[964px] iox:w-[1150px] h-auto font-inter text-[#1A1D1E] iox:left-1/2 iox:-translate-x-1/2 top-1/2 -translate-y-1/2">
          ...
          <p className="sm:text-[32px] mymob:text-[33.5px] capitalize myiphone:text-[34.5px] tablet:text-[39px] desktop:text-[43.5px] iox:text-[50px] font-bold sm:leading-10 tablet:leading-11 desktop:leading-13.5 desktop:w-[964px] iox:w-[1140px] ">
            A Versatile Multi Vendor Liquor Delivery Solution
          </p>
          <p className="sm:text-base tablet:text-[16.5px] font-[400] sm:my-2 desktop:my-[10px]">
            {" "}
            Struggling to meet your sales target? Take your liquor business to
            new heights and boost profits with Enatega’s app that delivers
            liquor.
          </p>
        </div>
      </div>
      ...
      >
        <img
          ...
          alt=""
          className="sm:w-[260px] mymob:w-[335px] myiphone:w-[365px] sm:h-[400px] mymob:h-[320px] myiphone:h-[300px] tablet:w-[708px] tablet:h-[260px] desktop:h-[200px] desktop:w-[964px] iox:w-[1180px]  mx-auto  rounded-xl bg-no-repeat bg-cover "
        />
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 ">
          <p className="text-white font-[400] font-inter sm:text-base tablet:text-[17px] sm:w-[200px] mymob:w-[255px] myiphone:w-[285px] tablet:w-[650px] desktop:w-[542px] iox:w-[640px]">
            Enatega is a powerful multi vendor delivery platform designed
            primarily for food delivery services but highly adaptable for other
            industries. One of its most compelling use cases is as an On-Demand
            Liquor Delivery App, offering a feature rich solution for businesses
            looking to enter the growing online alcohol delivery market.
          </p>
        </div>
      </motion.div>
      ...
      >
        ...
        <div className="desktop:w-[457px] iox:w-[545px] h-auto sm:mt-2 desktop:mt-0">
          ...
          <p className="text-[#222222] sm:text-base  iox:text-[17px]  mt-[12px] mb-[20px] leading-5.5 font-[400]  desktop:w-[90%]">
            With Enatega, businesses can launch a fully customizable liquor
            delivery app tailored to their brand image and consumer demands.
            Whether you’re a liquor store owner or an entrepreneur interested in
            creating a marketplace of vendors, this platform makes it easy to
            manage orders, inventory, and deliveries.
          </p>
          <p className="text-[#222222] sm:text-base  iox:text-[17px]  mt-[12px] mb-[20px] leading-5.5 font-[400]  desktop:w-[90%]">
            Enatega provides an efficient, scalable, and easy-to-use alcohol
            delivery software that connects customers to a wide range of liquor
          ...
          >
            {" "}
            Get Started now with our app for liquor delivery solution
          </Link>
        </div>
      ...
      {/* End  Customizable LiquorDelievery Delivering Software*/}

      {/* Section  On-Demand Alcohol Delivery*/}
      <div className="mx-auto relative   ">
        ...
        >
          ...
          <p className="text-[#222222] sm:mt-2 tablet:mt-3 font-[400] font-inter sm:text-base tablet:text-[17px] sm:w-[250px]  mymob:w-[305px]  myiphone:w-[355px] tablet:w-[699px]  desktop:w-[800px] iox:w-[950px] mx-auto leading-[1.3rem]">
            Customers are increasingly looking for convenience, and on-demand
            alcohol delivery apps are rising in popularity. With Enatega, you
            can offer your customers an intuitive and reliable alcohol delivery
            service app where they can browse, order, and have their favourite
            liquor delivered to their doorstep. As more people prefer shopping
            from home, offering an online alcohol delivery platform ensures your
            business stays competitive and accessible.
          </p>
          <Link
            to="/contactus"
      ...
      {/* End Section On-Demand Alcohol Delivery*/}

      {/*Section "A Flexible Platform for Growing Businesses" */}

      <div className="sm:my-10 desktop:my-16 sm:w-[280px] mymob:w-[335px] myiphone:w-[385px] h-auto py-2 tablet:w-[728px] desktop:w-[810px] iox:w-[950px] mx-auto rounded-xl  ">
        <motion.div
          variants={fadeIn("up", 0.2, "in")}
          initial="hidden"
          whileInView="show"
        ...
        >
          <p className="font-inter sm:text-[28px] tablet:text-[31px] desktop:text-[33px] iox:text-[35px] text-[#1A1D1E] sm:leading-7.5 desktop:leading-9 desktop:w-[600px] desktop:mx-0 iox:w-[750px] font-bold mx-auto desktop:tracking-wide">
            A Flexible Platform for Growing Businesses
          </p>
          <p className="text-[#222222] sm:mt-2 tablet:mt-3 font-[400] font-inter sm:text-base tablet:text-[17px]    desktop:w-[800px] iox:w-[940px] desktop:mx-0 mx-auto leading-[1.3rem]">
            Whether you’re expanding from a food delivery service or launching
            an entirely new liquor delivery app, Enatega offers flexibility and
            scalability to grow with your business. Its robust backend supports
            the needs of both small and large enterprises, ensuring smooth
            operations for vendors and a user-friendly experience for customers.
          </p>
          <p className="text-[#222222] sm:mt-2 tablet:mt-3 font-[400] font-inter sm:text-base tablet:text-[17px]    desktop:w-[800px] iox:w-[940px] desktop:mx-0 mx-auto leading-[1.3rem]">
            Enatega not only simplifies operations for businesses but also
            ensures compliance with local liquor laws, making it the ideal
            platform for companies looking to enter the alcohol delivery app
            market.
          </p>
        </motion.div>
      </div>
        ...
        <div className="sm:w-[280px] mymob:w-[335px] myiphone:w-[385px] tablet:w-[728px] desktop:w-[964px] iox:w-[1140px] py-[50px] mx-auto">
          ...
          >
            ...
            <p className="sm:text-base tablet:text-[17px] font-inter text-center mt-[5px] desktop:w-[475px] iox:w-[500px] mx-auto text-[#222222] ">
              Opt for Enatega’s on-demand liquor delivery app development and
              get a customizable branded app for your liquor business. Here’s
              why you should choose Enatega as your liquor delivery app
      ...
      {/* End Why Choose Enatega Liquor Delivery App*/}

      {/*Section Enatega's On-Demand LiquorDelievery Shopping App Package */}
      ...
      <div className="sm:my-10 desktop:mt-20 sm:w-[280px] mymob:w-[335px] myiphone:w-[385px]  tablet:w-[708px] desktop:w-[820px] iox:w-[1000px] mx-auto rounded-xl  ">
        <div>
          ...
          >
            Enatega's On-Demand Liquor Delivery App Package
          </motion.p>
          ...
          <ul>
            ...
            >
              Enatega’s on-demand alcohol delivery app offers a seamless and
              intuitive experience for your customers. They can easily browse
              and place orders through a user-friendly interface that features
              real-time order tracking, tipping options, exclusive discounts,
              and a customer feedback system. This liquor delivery app ensures a
              smooth and satisfying experience every time.
            </motion.p>
            ...
            <motion.p
              ...
              className="text-[#222222]  font-[400] font-inter sm:text-base tablet:text-[17px]    desktop:w-[800px] iox:w-[980px] leading-[1.3rem]"
            >
              Empower your delivery team with Enatega’s dedicated rider app. It
              comes equipped with a dual-alert system, time management tools,
              order history access, and accurate address mapping to ensure
              timely and efficient deliveries. The rider app makes it easy for
              your team to handle the unique challenges of alcohol delivery
              service.
            </motion.p>
            ...
            <motion.p
              ...
              className="text-[#222222]  font-[400] font-inter sm:text-base tablet:text-[17px]    desktop:w-[800px] iox:w-[980px] leading-[1.3rem]"
            >
              Simplify your business operations with Enatega’s comprehensive
              admin dashboard. It allows you to manage your entire delivery
              business including delivery zones, schedules, and order statuses
              with ease. This centralized tool is ideal for overseeing alcohol
              delivery apps, giving you full control over your operations from
              one platform.
            </motion.p>
            ...
            <motion.p
              ...
              className="text-[#222222]  font-[400] font-inter sm:text-base tablet:text-[17px]    desktop:w-[800px] iox:w-[980px] leading-[1.3rem]"
            >
              For liquor stores and restaurants offering delivery services,
              Enatega’s vendor app provides an all-in-one solution. Manage
              orders, update availability, and keep customers informed with
              real-time status updates, all from a single platform. This app is
              essential for running a successful online alcohol delivery
              platform and ensures smooth communication between vendors and
              customers.
            </motion.p>
          </ul>
          ...
          >
            Why Choose Enatega for Delivering Alcohol?
          </motion.p>
          <motion.p
            variants={fadeIn("up", 0.2, "in")}
            initial="hidden"
          ...
          >
            Enatega’s flexibility and robust set of features make it the perfect
            solution for liquor delivery services. Whether you’re a small local
            vendor or a large distributor, Enatega supports a variety of
            business models with ease. With features like account verification,
            geofencing, and real-time tracking, the platform ensures compliance
            with local regulations while enhancing the customer experience.
          </motion.p>
          <motion.p
            variants={fadeIn("up", 0.2, "in")}
            initial="hidden"
            ...
            className="text-[#222222] font-[400] font-inter sm:text-base tablet:text-[17px]    desktop:w-[800px] iox:w-[980px] leading-[1.3rem]"
          >
            So, kickstart your liquor delivery service with Enatega’s
            multivendor solution and tap into new revenue streams today!
          </motion.p>
        </div>
      </div>
...
export default LiquorDelievery;
