...
function FlowerDelievery() {
  ...
  return (
    ...
    <>
      ...
      {/* Content Start  */}
      <div className="sm:mt-26 desktop:mt-33 relative w-full sm:h-[420px] mymob:h-[360px] myiphone:h-[290px] tablet:h-[290px] desktop:h-[390px]">
        <img
          src="/Pictures/flowerbgcolor.jpg"
          alt=""
          className="w-full sm:h-[420px] mymob:h-[360px] myiphone:h-[290px] tablet:h-[290px] desktop:h-[390px]"
        />
        <div className="absolute sm:px-[20px] mymob:px-[15px] tablet:px-[20px] desktop:px-8 iox:px-4 sm:w-[290px] mymob:w-[355px] myiphone:w-[420px] tablet:w-[728px] desktop:w-[964px] iox:w-[1150px] h-auto font-inter text-[#1A1D1E] iox:left-1/2 iox:-translate-x-1/2 top-1/2 -translate-y-1/2">
          ...
          <p className="sm:text-[32px] mymob:text-[33.5px] capitalize  myiphone:text-[34.5px] tablet:text-[39px] desktop:text-[43.5px] iox:text-[50px] font-bold  sm:leading-10 tablet:leading-11 desktop:leading-13.5  desktop:w-[964px] iox:w-[1140px] ">
            Generate Some Buzz With Your Own Flower Delivery Solution
          </p>
          <p className="sm:text-base tablet:text-[16.5px] font-[400] sm:my-2 desktop:my-[10px]">
            {" "}
            Streamline your floral business delivery operations with Enatega’s
            flower app delivery solution and scale your business growth in no
            time.
          </p>
        </div>
      </div>
      ...
      >
        <img
          ...
          alt=""
          className="sm:mt-6 mymob:mt-0  sm:w-[260px] mymob:w-[335px] myiphone:w-[365px] sm:h-[500px] mymob:h-[400px] myiphone:h-[350px] tablet:w-[708px] tablet:h-[260px] desktop:h-[230px] desktop:w-[964px] iox:w-[1180px]  mx-auto  rounded-xl "
        />
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 ">
          <p className="text-white font-[400] font-inter sm:text-base tablet:text-[17px] sm:w-[200px] mymob:w-[255px] myiphone:w-[285px] tablet:w-[650px] desktop:w-[542px] iox:w-[680px]">
            Enatega is a versatile platform that can be used for many other
            things besides food delivery. Thanks to its versatility, it can also
            accommodate businesses looking to offer flower delivery services.
            Whether you’re a local florist or manage a multi-vendor marketplace,
            Enatega’s powerful delivery solution empowers your business to
            provide seamless and efficient delivery experiences for every
            occasion, from everyday orders to special events.
          </p>
        </div>
      </motion.div>
      ...
      <div className="mx-auto bg-[#effbf1] my-10 ">
        <div className="sm:w-[280px] mymob:w-[335px] myiphone:w-[385px] tablet:w-[728px] desktop:w-[964px] iox:w-[1140px] py-[50px] mx-auto">
          ...
          >
            ...
            <p className="text-base font-[400] font-inter text-center my-[5px] desktop:w-[475px] iox:w-[500px] mx-auto ">
      ...
      >
        ...
        <div className="desktop:w-[457px] iox:w-[545px] h-auto sm:mt-2 desktop:mt-0">
          ...
          <p className="text-[#222222] sm:text-base  iox:text-[17px]  mt-[12px] mb-[20px] leading-5.5 font-[400]  desktop:w-[90%]">
            Enatega is designed in a way to be fully adaptable as a flower
            delivery app solution, helping businesses tap into the growing
            demand for online flower orders. With intuitive features like
            real-time tracking, dynamic delivery options, and an extensive
            online flower ordering system, your customers can easily browse,
            choose, and send flowers, ensuring a smooth and delightful
          ...
          >
            {" "}
            Get Started now with the best flower delivery app solution
          </Link>
        </div>
      ...
      {/* End Flower Ordering App Solution */}

      {/* Section "Flower and Bouquet Delivery" */}
      <div className="mx-auto relative   ">
        ...
        >
          ...
          <p className="text-[#222222] sm:mt-2 tablet:mt-3 font-[400] font-inter sm:text-base tablet:text-[17px] sm:w-[250px]  mymob:w-[305px]  myiphone:w-[355px] tablet:w-[699px]  desktop:w-[800px] iox:w-[950px] mx-auto leading-[1.3rem]">
            As customers increasingly seek immediate services, Enatega enables
            businesses to launch an on-demand flower delivery app that delivers
            on speed and reliability. Customers can choose from a wide selection
            of floral arrangements, and personalize their orders—all within an
            easy-to-use online flower delivery app. This on-demand convenience
      ...
      {/* End Section Get on Demand flower Delivery */}

      {/*Section A Versatile Solution for Florists */}
      ...
      <div className="sm:my-10 desktop:my-16 sm:w-[280px] mymob:w-[335px] myiphone:w-[385px] h-auto tablet:w-[728px] desktop:w-[964px] iox:w-[1140px] mx-auto rounded-xl  ">
        ...
        >
          <p className="font-inter sm:text-[28px] tablet:text-[31px] desktop:text-[33px] iox:text-[35px] text-[#1A1D1E] leading-7.5 desktop:w-[800px] iox:w-[950px] font-bold mx-auto">
            A Versatile Solution for Florists
          </p>
          <p className="text-[#222222] sm:mt-2 tablet:mt-3 font-[400] font-inter sm:text-base tablet:text-[17px]    desktop:w-[800px] iox:w-[950px] mx-auto leading-[1.3rem]">
            Enatega’s delivery software offers the flexibility needed by
            florists of all sizes. Whether you provide custom or ready made
            flower arrangements, the flower ordering system within Enatega helps
            streamline operations, from tracking deliveries to managing multiple
            orders simultaneously. This ensures your business remains efficient
            and organized, even during peak seasons.
          </p>
        </motion.div>
        <motion.div
          variants={fadeIn("up", 0.2, "in")}
        ...
        >
          <p className="font-inter mt-6 sm:text-[28px] tablet:text-[31px] desktop:text-[33px] iox:text-[35px] text-[#1A1D1E] leading-7.5 desktop:w-[800px] iox:w-[950px] font-bold mx-auto">
            Apps to Deliver Flowers for Any Occasion
          </p>
          <p className="text-[#222222] sm:mt-2 tablet:mt-3 font-[400] font-inter sm:text-base tablet:text-[17px] desktop:w-[800px] iox:w-[950px] mx-auto leading-[1.3rem]">
            With Enatega, you can develop custom apps for ordering flowers for
            any event, whether it’s a wedding, birthday, or corporate
            celebration. The flower delivery service app provides your customers
            with all the tools they need to place their orders quickly and
            effortlessly, while giving your delivery team the support required
            to fulfill orders efficiently.
          </p>
        </motion.div>
      </div>

      {/* With Enatega, you can develop custom apps for ordering flowers for any event, whether it’s a wedding, birthday, or corporate celebration. The flower delivery service app provides your customers with all the tools they need to place their orders quickly and effortlessly, while giving your delivery team the support required to fulfill orders efficiently. */}

      {/* Enatega- Accelerating Your Floral Delivery Happiness */}
        ...
        <div className="sm:w-[280px] mymob:w-[335px] myiphone:w-[385px] tablet:w-[728px] desktop:w-[964px] iox:w-[1140px] py-[50px] mx-auto">
          ...
          >
            ...
            <p className="sm:text-base tablet:text-[17px] font-inter text-center mt-[5px] desktop:w-[475px] iox:w-[500px] mx-auto text-[#222222] ">
              Launching an online floral delivery store is a breeze with
              Enatega. With a minimum launch time and a set of exciting
              features, Enatega is all set to take your business to new heights.
            </p>
            <p className="sm:text-base tablet:text-[17px] font-inter mt-[2px] text-center desktop:w-[475px] iox:w-[500px] mx-auto  text-[#222222] ">
              Here’s what makes Enatega stand out amongst its competitors:
            </p>
          </motion.div>
          ...
          >
            {/* 1st box */}
            <div className="w-full tablet:w-[96%]  tablet:flex tablet:justify-between  iox:space-x-80 iox:justify-start mx-auto">
              {/* part 1 */}
              <div>
                {/* 1st row Start */}
      ...
      {/* End Enatega- Accelerating Your Floral Delivery Happiness*/}

      {/*Section Enatega’s On-Demand Flower Delivery App Package */}
      ...
      <div className="sm:my-10 desktop:mt-20 sm:w-[280px] mymob:w-[335px] myiphone:w-[385px]  tablet:w-[708px] desktop:w-[820px] iox:w-[1000px] mx-auto rounded-xl  ">
        <div>
          <motion.p
            ...
            whileInView="show"
            viewport={{ once: true, amount: 0.2 }}
            className="font-inter sm:text-[28px] tablet:text-[31px] desktop:text-[33px] iox:text-[35px] text-[#1A1D1E] sm:leading-7 tablet:leading-9 desktop:leading-10 desktop:w-[800px] iox:w-[700px]  font-bold mb-4"
          >
            Enatega’s On-Demand Flower Delivery App Package
          </motion.p>
          ...
          <ul>
            ...
            >
              The on-demand flower delivery app provides customers with an
              intuitive interface where they can easily browse floral
              arrangements, place orders, and track deliveries in real-time.
              Features like discounts, tipping, and customer feedback create an
              exceptional ordering experience, making Enatega the perfect flower
              ordering platform for your business.
            </motion.p>
            ...
            <motion.p
              ...
              className="text-[#222222]  font-[400] font-inter sm:text-base tablet:text-[17px]    desktop:w-[800px] iox:w-[980px] leading-[1.3rem]"
            >
              For your delivery team, Enatega offers a dedicated rider app
              equipped with a dual-alert system, real-time address mapping, and
              access to order history. This ensures timely and accurate
              deliveries, meeting the demands of swift on-demand flower delivery
            ...
            <motion.p
              ...
              className="text-[#222222]  font-[400] font-inter sm:text-base tablet:text-[17px]    desktop:w-[800px] iox:w-[980px] leading-[1.3rem]"
            >
              Managing your delivery operations is streamlined with Enatega’s
              admin dashboard. Oversee delivery zones, vendors, and order
              statuses while ensuring smooth operations across the board. This
              centralized tool supports the growth of your online flower
              delivery platform, keeping your business organized and efficient.
            </motion.p>
            ...
            <motion.p
              ...
              className="text-[#222222]  font-[400] font-inter sm:text-base tablet:text-[17px]    desktop:w-[800px] iox:w-[980px] leading-[1.3rem]"
            >
              Whether you’re managing a single florist or a network of vendors,
              Enatega’s vendor app simplifies the management of orders and
              deliveries. It centralizes product availability, updates order
              statuses in real-time, and keeps your delivery service running
              smoothly, helping you make sure your customers receive their
              flowers on time.
            </motion.p>
          </ul>
          ...
          <motion.p
            ...
            whileInView="show"
            viewport={{ once: true, amount: 0.2 }}
            className="font-inter sm:text-[28px] tablet:text-[31px] desktop:text-[33px] iox:text-[35px] text-[#1A1D1E] sm:leading-7.5 tablet:leading-9 desktop:w-[800px] iox:w-[740px]  font-bold"
          >
            Why Choose Enatega for Delivering Flowers?
          </motion.p>
          <motion.p
            variants={fadeIn("up", 0.2, "in")}
            initial="hidden"
          ...
          >
            Enatega’s adaptability and comprehensive feature set make it the
            ideal solution for flower delivery services. Whether you’re an
            independent florist or managing a large network of vendors, Enatega
            is designed to handle your unique operational needs. With
            capabilities like real-time tracking, customizable offerings, and
            easy vendor management, the platform ensures smooth and efficient
          ...
          <motion.p
            ...
            className="text-[#222222] font-[400] font-inter sm:text-base tablet:text-[17px]    desktop:w-[800px] iox:w-[980px] leading-[1.3rem]"
          >
            Start your online flower ordering system with Enatega’s multivendor
            solution and expand your business with ease!
          </motion.p>
        </div>
      </div>
...
export default FlowerDelievery;
