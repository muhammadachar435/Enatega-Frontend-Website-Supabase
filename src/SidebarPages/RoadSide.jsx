...
function RoadSide() {
  ...
  return (
    ...
    <>
      ...
      {/* Content Start  */}
      <div className="sm:mt-26 desktop:mt-33 relative w-full sm:h-[350px] mymob:h-[270px] myiphone:h-[230px] tablet:h-[260px] desktop:h-[320px]">
        <img
          src="/Pictures/roadsidebgColor.jpg"
          alt=""
          className="w-full sm:h-[350px] mymob:h-[270px] myiphone:h-[230px]  tablet:h-[260px]  desktop:h-[320px] "
        />
        <div className="absolute sm:px-[20px] mymob:px-[15px] tablet:px-[20px] desktop:px-8 iox:px-4 sm:w-[290px] mymob:w-[355px] myiphone:w-[420px] tablet:w-[728px] desktop:w-[964px] iox:w-[1150px] h-auto font-inter text-[#1A1D1E] iox:left-1/2 iox:-translate-x-1/2 top-1/2 -translate-y-1/2">
          ...
          <p className="sm:text-[32px] mymob:text-[33.5px] capitalize myiphone:text-[34.5px] tablet:text-[39px] desktop:text-[43.5px] iox:text-[50px] font-bold sm:leading-10 tablet:leading-11 desktop:leading-13.5 desktop:w-[964px] iox:w-[1140px] ">
            Vehicle Assistance With The Touch of a Button!
          </p>
          <p className="sm:text-base tablet:text-[16.5px] font-[400] sm:my-2 desktop:my-[10px]">
            {" "}
            Expand your roadside assistance services with Enatega’s roadside
            assistance app.
          </p>
        </div>
      </div>
      ...
      >
        <img
          ...
          alt=""
          className="sm:w-[260px] mymob:w-[335px] myiphone:w-[365px] sm:h-[550px] mymob:h-[460px] myiphone:h-[450px] tablet:w-[708px] tablet:h-[260px] desktop:h-[300px] desktop:w-[964px] iox:w-[1180px]  mx-auto  rounded-xl "
        />
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 ">
          <p className="text-white font-[400] font-inter sm:text-base tablet:text-[17px] sm:w-[200px] mymob:w-[255px] myiphone:w-[285px] tablet:w-[660px] desktop:w-[560px] iox:w-[660px]">
            The demand for reliable and fast roadside assistance has slowly been
            increasing with the uptick in vehicles being driven by people around
            the world. Enatega’s platform can be tailored into a powerful
            roadside assistance services solution that enables businesses to
            deliver immediate help to drivers in need. Whether it’s a flat tire,
            battery jump-start, or towing service, Enatega’s customizable
            platform allows businesses to offer a seamless on demand roadside
            emergency app experience.
          </p>
        </div>
      </motion.div>
      ...
      {/*  Get Help for Your Vehicle Quickly and Efficiently */}
      <motion.div
        variants={fadeIn("up", 0.2, "in")}
        initial="hidden"
        whileInView="show"
      ...
      >
        ...
        <div className="desktop:w-[457px] iox:w-[700px] h-auto sm:mt-8 desktop:mt-0">
          ...
          <p className="text-[#222222] sm:text-base  iox:text-[17px]  mt-[12px] mb-[20px] leading-5.5 font-[400]  desktop:w-[90%] iox:w-[98%]">
            Enatega provides a scalable roadside assistance solution for
            companies looking to improve how they deliver services. Through the
            platform, businesses can offer an on-demand roadside services that
            allow users to request help instantly. The app connects drivers with
            nearby assistance providers who can offer real-time updates and
            arrival tracking.
          </p>

          <p className="text-[#222222] sm:text-base  iox:text-[17px]  mt-[12px] mb-[20px] leading-5.5 font-[400]  desktop:w-[90%] iox:w-[98%]">
            Drivers can request help with just a few taps, ensuring that
            assistance arrives quickly when they need it most. This platform
            includes features such as location tracking, secure payments, and
            service provider ratings, all designed to enhance the user
            experience.
          </p>
          ...
          >
            {" "}
            Get Started now with for our roadside assistance app solution
          </Link>
        </div>
      ...
      <div className="mx-auto relative   ">
        ...
        >
          <p className="font-inter sm:text-[28px] tablet:text-[31px] desktop:text-[33px] iox:text-[35px] text-[#1A1D1E] leading-7.5 sm:w-[250px] mymob:w-[305px] myiphone:w-[355px] tablet:w-[699px] desktop:w-[800px] iox:w-[950px] font-bold mx-auto">
            A Customizable Roadside Services Solution
          </p>
          <p className="text-[#222222] sm:mt-2 tablet:mt-3 font-[400] font-inter sm:text-base tablet:text-[17px] sm:w-[250px]  mymob:w-[305px]  myiphone:w-[355px] tablet:w-[699px]  desktop:w-[800px] iox:w-[950px] mx-auto leading-[1.3rem]">
            Enatega allows businesses to build their own white label roadside
            services app that reflects their brand identity. This customizable
            roadside service solution can be tailored to offer various services,
            including towing, fuel delivery, lockout assistance, and more.
            Businesses can also choose to offer specialized services for cars,
            motorcycles, or trucks, depending on their customer base.
          </p>
          <p className="text-[#222222] sm:mt-2 tablet:mt-3 font-[400] font-inter sm:text-base tablet:text-[17px] sm:w-[250px]  mymob:w-[305px]  myiphone:w-[355px] tablet:w-[699px]  desktop:w-[800px] iox:w-[950px] mx-auto leading-[1.3rem]">
            By using Enatega’s platform, businesses can launch a fully branded
            app with the same level of functionality and reliability as leading
            on-demand platforms. Customers can request assistance anytime, with
            access to real-time tracking and status updates.
          </p>
      ...
      {/*Section "On-Demand Vehicle Assistance for All Situations" */}
      ...
      <div className="sm:my-10 desktop:my-16 sm:w-[280px] mymob:w-[335px] myiphone:w-[385px] h-auto tablet:w-[728px] desktop:w-[964px] iox:w-[1140px] mx-auto rounded-xl  ">
        ...
        >
          <p className="font-inter sm:text-[28px] tablet:text-[31px] desktop:text-[33px] iox:text-[35px] text-[#1A1D1E] leading-7.5 desktop:w-[800px] iox:w-[950px] font-bold mx-auto">
            On-Demand Vehicle Assistance for All Situations
          </p>
          <p className="text-[#222222] sm:mt-2 tablet:mt-3 font-[400] font-inter sm:text-base tablet:text-[17px]    desktop:w-[800px] iox:w-[950px] mx-auto leading-[1.3rem]">
            With Enatega’s on demand roadside assistance solution, drivers no
            longer need to worry about long waits or uncertain service
            providers. The platform connects users to nearby assistance
            providers, allowing them to track the exact location of the service
            vehicle and receive updates on the estimated time of arrival.
          </p>
          <p className="text-[#222222] sm:mt-2 tablet:mt-3 font-[400] font-inter sm:text-base tablet:text-[17px]    desktop:w-[800px] iox:w-[950px] mx-auto leading-[1.3rem]">
            This vehicle roadside assistance solution ensures that whether it’s
            a minor issue like a flat tire or a major emergency, help is always
            just a click away. The on demand roadside assistance app empowers
            drivers to handle unexpected vehicle problems without stress.
          </p>
        </motion.div>
        <motion.div
          variants={fadeIn("up", 0.2, "in")}
        ...
        >
          ...
          <p className="text-[#222222] sm:mt-2 tablet:mt-3 font-[400] font-inter sm:text-base tablet:text-[17px] desktop:w-[800px] iox:w-[950px] mx-auto leading-[1.3rem]">
            Whether you’re an established roadside assistance company or
            launching a new service, Enatega’s platform is designed to scale
            with your business. As your customer base grows, Enatega’s roadside
            assistance solution ensures you can expand without sacrificing
            quality or efficiency. The platform’s flexibility also allows
            businesses to add new services or providers as needed, making it the
      ...
      {/*Section "What Makes Enatega The Leading Roadside Assistance Delivery App" */}
        ...
        <div className="sm:w-[280px] mymob:w-[335px] myiphone:w-[385px] tablet:w-[728px] desktop:w-[964px] iox:w-[1140px] py-[50px] mx-auto">
          ...
          >
            <p className="sm:text-[28px] tablet:text-[31.5px] desktop:text-[32.5px] iox:text-[35.5px] font-inter font-bold text-center sm:leading-7.5 desktop:leading-10 tablet:w-[96%] desktop:w-[86%] iox:w-[850px] mx-auto">
              What Makes Enatega The Leading Roadside Assistance Delivery App
            </p>
          </motion.div>
      ...
      {/* Section "What’s Included in Enatega’s Customizable Package" */}
      ...
      <div className="sm:my-10 desktop:mt-20 sm:w-[280px] mymob:w-[335px] myiphone:w-[385px]  tablet:w-[708px] desktop:w-[820px] iox:w-[1000px] mx-auto rounded-xl  ">
        <div>
          ...
          >
            What’s Included in Enatega’s Customizable Package
          </motion.p>
          ...
          <ul>
            ...
            >
              The customer app provides a simple, user-friendly interface where
              customers can request help, choose their required service, and
              track assistance vehicles in real-time. It includes secure payment
              options and customer support, ensuring a hassle-free experience.
            </motion.p>
            ...
            <motion.p
              ...
              className="text-[#222222]  font-[400] font-inter sm:text-base tablet:text-[17px]    desktop:w-[800px] iox:w-[980px] leading-[1.3rem]"
            >
              Enatega’s service provider app allows roadside mechanics to
              receive job alerts, manage multiple requests, and communicate
              directly with customers. This white label app ensures that
              providers can deliver fast, efficient service.
            </motion.p>
            ...
            <motion.p
              ...
              className="text-[#222222]  font-[400] font-inter sm:text-base tablet:text-[17px]    desktop:w-[800px] iox:w-[980px] leading-[1.3rem]"
            >
              For business owners, the solution includes a comprehensive admin
              dashboard that offers full control over operations. Track service
              requests, manage providers, review performance analytics, and
              update service offerings, all from a single platform.
            </motion.p>
          </ul>
          ...
          >
            Why Choose Enatega for Your Roadside Services App?
          </motion.p>
          <motion.p
            variants={fadeIn("up", 0.2, "in")}
            initial="hidden"
          ...
          >
            Enatega can be fully modified to create a complete roadside services
            app that combines real-time service delivery, customization, and
            scalability. With their own white label roadside assistance service,
            businesses can provide a branded, reliable experience that meets the
            needs of modern drivers. From real-time tracking to secure payment
            systems, Enatega provides everything a business needs to
            successfully cater to its customers’ car related emergencies.
          </motion.p>
          <motion.p
            variants={fadeIn("up", 0.2, "in")}
            initial="hidden"
          ...
          >
            Launch your own AAA style app today with Enatega and provide drivers
            with the quick, reliable support they need, wherever they are!
          </motion.p>
        </div>
      </div>
