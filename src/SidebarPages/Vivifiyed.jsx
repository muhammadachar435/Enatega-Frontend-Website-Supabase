    ...
    <>
      ...
      <div className="relative  sm:mt-26 iox:mt-[130px] w-full sm:h-[95vh] mymob:h-[70vh] tablet:h-[75vh]">
        <div>
          <img
            loading="lazy"
            src="/Pictures/VinifyndBannerColor.jpg"
            alt=""
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
          ...
          {/* Text */}
          <div className="sm:leading-9 tablet:leading-11 font-inter mt-2 sm:w-[280px]  mymob:w-[335px] myiphone:w-[376px] tablet:w-[708px] desktop:w-[525px] desktop:h-auto desktop:mx-auto iox:w-[660px] iox:h-auto iox:leading-14 biglap:w-[1280px] biglap:h-auto mb-5 text-center ">
            ...
            <p className="text-[#222222] text-[17px] leading-6 mt-2 ">
              Vinifynd is a wine retail and delivery business that aims to
              provide high quality wines to its customers.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="relative sm:w-[280px] mymob:w-[335px] myiphone:w-[385px] tablet:w-[728px] desktop:w-[954px] iox:w-[1140px] h-auto  mx-auto sm:mt-7 mymob:mt-0">
        <img
          loading="lazy"
          src="/Pictures/Vinifynbackdrop.jpg"
          alt="Sample"
          className="sm:w-[280px] mymob:w-[335px] sm:h-[200px] mymob:h-[230px] myiphone:h-[220px] myiphone:w-[385px]  tablet:w-[728px] desktop:w-[954px] iox:w-[1140px]  bg-no-repeat bg-center bg-fixed bg-cover rounded-2xl"
        />
        <motion.div
          ...
          className="absolute sm:top-2 mymob:top-6 sm:px-5 mymob:px-3 myiphone:px-5 desktop:px-10 iox:px-26 font-inter "
        >
          <p className=" text-white sm:text-2xl tablet:text-[31.5px] iox:text-4xl font-bold bg-transparent py-1 tracking-wide tablet:w-[668px] desktop:w-[850px] iox:w-[950px] sm:mt-3 mymob:mt-2 tablet:mt-4 iox:mt-5 tablet:mx-auto capitalize">
            What is Vinifynd
          </p>
          <p className=" text-white sm:text-[10px] mymob:text-[12.5px] tablet:text-base tablet:w-[668px] desktop:w-[850px] iox:w-[950px] sm:mt-3 mymob:mt-2  font-inter bg-transparent py-1 rounded">
            It operates in the highly competitive wine retail and delivery
            industry, with a focus on providing a convenient and efficient
            delivery service. Vinifynd identified a market gap where quality and
            affordability intersected, as none of the existing wine delivery
            services provided efficient delivery at affordable prices.
          </p>
        </motion.div>
      </div>
      {/* End Section What is Vivifiyed */}
      ...
      >
        ...
        <p className="text-[#222222] text-base mt-[10px] mb-[20px] leading-5.5 font-[400] iox:w-[964px]">
          Vinifynd’s strategy was to differentiate itself from other wine
          retailers by focusing on the quality of its products and the
          efficiency of its delivery service. To achieve this, Vinifynd took the
          following steps:
        </p>
        <ul className="">
          ...
          <p className="text-[#222222] text-base mt-[10px] mb-[20px] leading-5.5 font-[400] iox:w-[964px]">
            Vinifynd focused on sourcing high-quality wines from small and
            medium-sized vineyards and wineries. It allowed the business to
            offer unique wines that were not available at other retailers. The
            company also offered a personalized wine selection service, where
            customers could describe their preferences, and Vinifynd would
            recommend wines that matched their taste
          </p>
          <li className="text-[#1A1D1E] text-lg font-semibold leading-5">
            Convenient And Efficient Delivery
          </li>
          <p className="text-[#222222] text-base mt-[10px] mb-[20px] leading-5.5  font-[400]  iox:w-[964px]">
            By offering same-day delivery in selected cities and next-day
            delivery across the country, Vinifynd facilitated retailers with
            quick delivery services. The company also provided a tracking
            system, so customers could see where their wine was in real-time.
            Real-time tracking feature acted as a differentiator that gave
            Vinifynd an edge over other wine retailers that often have longer
            delivery times.
          </p>
          <li className="text-[#1A1D1E] text-lg font-semibold leading-5">
          ...
          <p className="text-[#222222] text-base mt-[12px] mb-[20px] leading-5.5 font-[400]  iox:w-[964px]">
            Vinifynd invested in building a strong online presence, with a
            user-friendly website and mobile apps that allowed customers to
            browse and purchase wines easily. The company also had a strong
            social media presence that provided regular updates on new products
            and promotions.
          </p>
          <li className="text-[#1A1D1E] text-lg font-semibold leading-5">
          ...
          <p className="text-[#222222] text-base mt-[12px] mb-[20px] leading-5.5 font-[400]  iox:w-[964px]">
            Vinifynd placed a strong emphasis on customer service, with a
            dedicated customer service team that was available to answer
            customer queries and resolve any issues.
          </p>
        </ul>
        <div className="text-[#222222] font-[500] italic bg-[#F8F8F8] border-l-4 border-l-[#ab2d2d] p-[20px] rounded-xl  sm:text-[19px] leading-6 desktop:w-[811px] iox:w-[864px]">
          <p>
            Finally, the business was also looking to implement its online
            delivery services as quickly as possible to stay ahead of the curve.
            It included delivery platforms for the web, android and iOS.
          </p>
        </div>
        <hr className="text-gray-100 border-[1.8px] sm:mt-8 tablet:mt-18" />
      </motion.div>

      {/* End Section Vinifynd’s Business Strategy */}
      ...
      >
        ...
        <p className="text-[#222222] text-base mt-[10px] mb-[20px] leading-5.5 font-[400] iox:w-[964px]">
          Enatega’s delivery solution allowed Vinifynd to to offer fast and
          efficient delivery to its customers, which proved to be a
          differentiator from other wine delivery services.
        </p>
        <p className="text-[#222222] text-base mt-[10px] mb-[20px] leading-5.5 font-[400] iox:w-[964px]">
          Consequently, Enatega helped Vinifynd build customer trust and
          loyalty, which was critical for a new business in the market.
        </p>
        <hr className="text-gray-100 border-[1.8px] sm:mt-8 tablet:mt-18" />
      </motion.div>
      {/* End Section Enatega's Collaboration To Overcome The Challenges */}
      ...
      >
        ...
        <p className="text-[#222222] sm:text-base  iox:text-[17px]  mt-[12px] mb-[20px] leading-5.5 font-[400]  desktop:w-[90%]">
          Enatega’s ready-made solution facilitated the swift implementation and
          deployment of multiple modules necessary for wine delivery. It
          provided Vinifynd with the web, android and iOS app. Thanks to
          Enatega, Vinifynd was able to deploy its own customized and branded
          apps two months before their expected launch date.
        </p>
        <p className="text-[#222222] sm:text-base iox:text-[17px] mt-[12px] mb-[20px] leading-5.5 font-[400]  desktop:w-[90%]">
          Vinifynd was also able to scale its operations rapidly, as the company
          focused on its core business of sourcing and selling high-quality
          wines, while leaving the logistics and delivery to Enatega. It freed
          up resources and time for Vinifynd to invest in marketing and building
          brand awareness, which helped the company establish itself as a
          reliable and trustworthy wine retailer.
        </p>
      </motion.div>
      ...
      >
        <div className="desktop:hidden">
          ...
          <img
            loading="lazy"
            src="/Pictures/Vinifynd-conclusion.jpg"
            alt=""
            className=""
          />
        </div>
        <div className="desktop:w-[457px] iox:w-[545px] h-auto">
          ...
          <p className="text-[#222222] sm:text-base  iox:text-[17px]  mt-[12px] mb-[20px] leading-5.5 font-[400]  desktop:w-[90%]">
            Enatega’s delivery solution helped Vinifynd overcome challenges such
            as competition and building brand awareness, allowing the company to
            focus on its core business of providing high-quality wines and
            excellent customer service.
          </p>
          <p className="text-[#222222] sm:text-base iox:text-[17px] mt-[12px] mb-[20px] leading-5.5 font-[400]  desktop:w-[90%]">
            As a result, Vinifynd was able to scale its operations rapidly,
            build customer trust and loyalty, and establish itself as a reliable
            and trustworthy wine retailer in the highly competitive wine
            delivery industry.
          </p>
        </div>
