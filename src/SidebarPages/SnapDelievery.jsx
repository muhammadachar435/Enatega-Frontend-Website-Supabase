...
function SnapDelievery() {
  ...
  return (
    ...
    <>
      ...
      <div className="relative sm:mt-26 iox:mt-[130px] w-full sm:h-[72vh] mymob:h-[70vh] myiphone:h-[74vh] tablet:h-[70vh] desktop:h-[75vh] biglap:h-[80vh] ">
        <div>
          <img
            loading="lazy"
            src="/Pictures/SnapColor.jpg"
            alt=""
            className="w-full sm:h-[72vh] mymob:h-[70vh] myiphone:h-[74vh]  tablet:h-[70vh] desktop:h-[75vh]  biglap:h-[80vh] "
          />
        </div>
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
          <div>
            <img
              loading="lazy"
              src="/Pictures/SnapDelieveryLogo.png"
              alt=""
          ...
          {/* Text */}
          <div className="sm:leading-9 tablet:leading-11 font-inter mt-2 sm:w-[280px]  mymob:w-[335px] myiphone:w-[376px] tablet:w-[728px] desktop:w-[525px] desktop:h-auto desktop:mx-auto iox:w-[660px] iox:h-auto iox:leading-14 biglap:w-[1280px] biglap:h-auto mb-5 text-center ">
            ...
            <p className="text-[#222222] text-[17px] leading-6 mt-2 sm:mb-2 iox:mb-0">
              Eliminate the surprise delivery fee and order meals from your
              favorite restaurants in no time!
            </p>
            <Link
              to="https://ibos.snapdelivered.com/"
              target="blank"
              className="sm:text-[14px] bg-black text-white mt-6 transition-all inline py-[10px] px-[14px] rounded-md hover:scale-101 hover:duration-200 font-[500] "
            >
              Go to Website
            </Link>
          </div>
      ...
      {/* Section What is SnapDelievery */}
      <div className="fixed sm:top-[80px] tablet:top-[100px] bottom-10 left-1/2  -translate-x-1/2   sm:w-[280px] mymob:w-[335px] z-[-1] myiphone:w-[385px] tablet:w-[728px] desktop:w-[954px] iox:w-[1140px] h-auto  mx-auto sm:mt-7 mymob:mt-0 ">
        <img
          loading="lazy"
          src="/Pictures/SnapDelievery2.jpg"
          alt="Sample"
          className=" sm:w-[265px] mx-auto sm:h-[550px] mymob:w-[320px] mymob:h-[650px] myiphone:h-[680px] myiphone:w-[370px]  tablet:h-[550px] tablet:w-[715px] desktop:h-[650px] desktop:w-[939px] iox:h-[850px] iox:w-[1090px] biglap:h-[1800px]"
        />
      </div>
      <motion.div
        ...
        className="opacity-80 sm:w-[280px] mymob:w-[335px] myiphone:w-[385px]  tablet:w-[668px] desktop:w-[850px] iox:w-[950px] mx-auto  px-[20px] py-[30px] "
      >
        <p className=" text-white sm:text-2xl tablet:text-[31.5px] iox:text-4xl font-bold bg-transparent  tracking-wide capitalize">
          What is Snap Delivered?
        </p>
        <p className=" text-white sm:text-sm mymob:text-base tablet:text-base tablet:w-[668px] desktop:w-[850px] iox:w-[950px] sm:mt-3 mymob:mt-2 font-inter bg-transparent py-1 ">
          Snap Delivered is a food delivery platform powered by Enatega, similar
          to other big name companies like Foodpanda and UberEats. Snap
          Delivered began its operations in 2019 with one big goal in mind: to
          disrupt the food delivery industry and challenge the standards and
          precedents already set by the industry leaders.
        </p>
        <p className=" text-white sm:text-sm mymob:text-base tablet:text-base tablet:w-[668px] desktop:w-[850px] iox:w-[950px] sm:mt-3 mymob:mt-2  font-inter bg-transparent py-1">
          These standards include things like how much riders get paid, along
          with how much business owners are charged per delivery. Snap Delivered
          provided an easy and transparent way to handle deliveries by charging
          business owners a set rate of only $2 per delivery. This flat rate not
          only allowed new business owners to use a service like snap delivered
          to automate deliveries, it also helped level the playing field for
          restaurants of all sizes.
        </p>
      </motion.div>
      {/* </div> */}
      {/* End Section What is SnapDelievery */}

      {/* Challenges faced by Snap Delivered */}
      <div className="bg-white border-white border pb-5">
        <div className="bg-white z-1">
          <motion.div
            ...
            className="z-[1] bg-white sm:w-[278px] mymob:w-[333px] myiphone:w-[383px] tablet:w-[728px] desktop:w-[964px] iox:w-[1090px] h-auto font-inter mx-auto  sm:pt-8 sm:mt-2 tablet:mt-3 desktop:mt-6 desktop:pt-18 iox:px-7"
          >
            ...
            <p className="text-[#222222] text-base mt-[10px] mb-[20px] leading-5.5 font-[400] iox:w-[964px]">
              Despite its ambitious goals and innovative approach, Snap
              Delivered faced several challenges in its journey to disrupt the
            ...
            <ul className="">
              ...
              <p className="text-[#222222] text-base mt-[10px] mb-[20px] leading-5.5 font-[400] iox:w-[964px]">
                The food delivery industry is highly competitive, with
                established players like UberEats, Grubhub, and DoorDash
                dominating the market. Snap Delivered had to contend with these
                giants, making it challenging to gain significant market share.
              </p>
              <li className="text-[#1A1D1E] text-lg font-semibold leading-5">
                The Marketplace Dilemma
              </li>
              <p className="text-[#222222] text-base mt-[10px] mb-[20px] leading-5.5  font-[400]  iox:w-[964px]">
                Attracting both customers and restaurants to the platform proved
                to be a daunting task. Convincing users to switch from their
                existing preferences and habits with other platforms required
                substantial marketing efforts. Moreover, retaining both sides of
                the marketplace posed an ongoing challenge.
              </p>
              <li className="text-[#1A1D1E] text-lg font-semibold leading-5">
                Rider Management
              </li>
              <p className="text-[#222222] text-base mt-[12px] mb-[20px] leading-5.5 font-[400]  iox:w-[964px]">
                Managing a vast network of delivery riders and ensuring timely
                and accurate deliveries is a complex operational challenge. Snap
                Delivered had to invest in the latest and most reliable
                logistics and coordination systems to maintain efficiency and
              ...
              <p className="text-[#222222] text-base mt-[12px] mb-[20px] leading-5.5 font-[400]  iox:w-[964px]">
                Offering a flat rate of $2 per delivery to business owners was a
                bold move, but it also put pressure on Snap Delivered’s
                profitability. Balancing the need to attract businesses with
                affordable rates while maintaining a sustainable business model
            ...
            <div className="text-[#222222] font-[500] italic bg-[#F8F8F8] border-l-4 border-l-[#ab2d2d] p-[20px] rounded-xl  sm:text-[19px] leading-6 desktop:w-[811px] iox:w-[864px]">
              <p>
                ...
                traditional delivery options, which is where Snap Delivered came
                in.
              </p>
            </div>
        ...
        {/* End Section Challenges faced by Snap Deliveredy */}
        ...
        <motion.div
          ...
          whileInView={"show"}
          viewport={{ once: true, amount: 0.1 }}
          className="z-1 bg-white sm:w-[278px] mymob:w-[333px] myiphone:w-[383px] tablet:w-[728px] desktop:w-[964px] iox:w-[1090px] h-auto font-inter mx-auto sm:py-10  iox:px-7"
        >
          <p className="text-[#1A1D1E] sm:text-[28px] tablet:text-[31px] desktop:text-[32px] iox:text-[35px] mb-[12px] font-bold capitalize leading-8">
            Overcoming The Challenges
          </p>
          <p className="text-[#222222] text-base mt-[10px] mb-[20px] leading-5.5 font-[400] iox:w-[964px]">
            To overcome these challenges, Snap Delivered employed various
            strategies
          </p>
          <ul className="">
            <li className="text-[#1A1D1E] text-lg font-semibold leading-5">
            ...
            <p className="text-[#222222] text-base mt-[10px] mb-[20px] leading-5.5 font-[400] iox:w-[964px]">
              Snap Delivered forged strategic partnerships with local
              restaurants, offering them a unique value proposition. By
              collaborating closely with small and medium-sized businesses, Snap
              Delivered differentiated itself from larger competitors and
              created a more inclusive platform.
            </p>
            <li className="text-[#1A1D1E] text-lg font-semibold leading-5">
              Introduced Customer Incentives
            </li>
            <p className="text-[#222222] text-base mt-[10px] mb-[20px] leading-5.5 font-[400] iox:w-[964px]">
              To address user acquisition and retention challenges, Snap
              Delivered implemented customer incentives and loyalty programs.
              Discounts, exclusive deals, and a user-friendly rewards system
              helped attract and retain both individual customers and
              restaurants.
            </p>
            <li className="text-[#1A1D1E] text-lg font-semibold leading-5">
            ...
            <p className="text-[#222222] text-base mt-[10px] mb-[20px] leading-5.5 font-[400] iox:w-[964px]">
              Recognizing the importance of technology in the industry, Snap
              Delivered continually invested in upgrading its platform. It
              included improving the user experience, optimizing delivery
              routes, and implementing advanced data analytics to enhance
            ...
            <p className="text-[#222222] text-base mt-[10px] mb-[20px] leading-5.5 font-[400] iox:w-[964px]">
              While maintaining an affordable flat rate, Snap Delivered
              introduced referral programs allowing anyone to increase their
              income. The various options provided to individuals as well as
              businesses meant that anyone who was involved with Snap Delivered
              to earn money via recruitment, word of mouth advertisement or
              referrals.
            </p>
          </ul>
          <hr className="text-gray-100 border-[1.8px] sm:mt-8 tablet:mt-18" />
        ...
        {/* End Section Overcoming The Challenges */}
        ...
        <motion.div
          ...
          whileInView={"show"}
          viewport={{ once: true, amount: 0.1 }}
          className="sm:w-full  iox:w-[1030px] h-auto font-inter mx-auto bg-[#fef2f2] py-[60px] sm:px-[30px] desktop:px-[34px] iox:px-[60px] rounded-xl"
        >
          <p className="text-[#1A1D1E] sm:text-[28px] tablet:text-[31px] desktop:text-[32px] iox:text-[35px] mb-[12px] font-bold capitalize leading-8">
            Launching Version 1.0
          </p>
          <p className="text-[#222222] sm:text-base  iox:text-[17px]  mt-[12px] mb-[20px] leading-5.5 font-[400]  desktop:w-[90%]">
            The development of Snap first version was a race against time. With
            a tight deadline, the Ninjas Code team adopted an agile development
            approach, which allowed them to prioritize features and make
            adjustments on the fly. Regular feedback sessions with the Snap team
            ensured that the project stayed on track and aligned with the
            initial vision.
          </p>
        </motion.div>

        {/* End Launching Version 1.0 */}
        ...
        <motion.div
          ...
          whileInView={"show"}
          viewport={{ once: true, amount: 0.1 }}
          className="sm:w-full h-auto font-inter border-none mx-auto my-10 bg-[#f3f4f7] z-1 py-[60px] sm:px-[30px] desktop:px-[34px] iox:px-[60px] desktop:flex desktop:justify-evenly desktop:items-center"
        >
          ...
          <div className="desktop:w-[457px] iox:w-[545px] h-auto">
            ...
            <p className="text-[#222222] sm:text-base  iox:text-[17px]  mt-[12px] mb-[20px] leading-5.5 font-[400]  desktop:w-[90%]">
              Snap Delivered’s strategic efforts to overcome challenges has
              since shown positive results.
            </p>
            <p className="text-[#222222] sm:text-base iox:text-[17px] mt-[12px] mb-[20px] leading-5.5 font-[400]  desktop:w-[90%]">
              The platform has gained traction among local businesses and
              consumers, carving out a niche in the competitive food delivery
              landscape.
            </p>
            <p className="text-[#222222] sm:text-base iox:text-[17px] mt-[12px] mb-[20px] leading-5.5 font-[400]  desktop:w-[90%]">
              The flexible pricing models and emphasis on community engagement
              have contributed to a growing user base.
            </p>
            <p className="text-[#222222] sm:text-base iox:text-[17px] mt-[12px] mb-[20px] leading-5.5 font-[400]  desktop:w-[90%]">
              Looking forward, Snap Delivered continues to focus on innovation,
              sustainability, and user satisfaction.
            </p>
            <p className="text-[#222222] sm:text-base iox:text-[17px] mt-[12px] mb-[20px] leading-5.5 font-[400]  desktop:w-[90%]">
              By staying on top of technological trends within the industry and
              creating a collaborative environment with their partners, Snap
              Delivered aims to further disrupt the industry and position itself
              as a viable alternative to the established players.
            </p>
          </div>
      ...
      {/* Section 15 Footer */}
      <footer>
        <div className="sm:pt-20 desktop:pt-30 pb-4 z-1 bg-white">
