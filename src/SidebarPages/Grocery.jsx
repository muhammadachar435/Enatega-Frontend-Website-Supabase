...
function Grocery() {
  ...
  return (
    ...
    <>
      ...
      {/* Content Start  */}
      <div className="sm:mt-26 desktop:mt-33 relative w-full sm:h-[420px] mymob:h-[360px] myiphone:h-[290px] tablet:h-[290px] desktop:h-[390px] iox:h-[380px]">
        <img
          src="/Pictures/groceryBgcolor.jpg"
          alt=""
          className="w-full sm:h-[380px] mymob:h-[320px] myiphone:h-[280px] tablet:h-[290px] desktop:h-[320px] iox:h-[380px]"
        />
        <div className="absolute sm:px-[20px] mymob:px-[15px] tablet:px-[20px] desktop:px-8 iox:px-4 sm:w-[290px] mymob:w-[355px] myiphone:w-[420px] tablet:w-[728px] desktop:w-[964px] iox:w-[1150px] h-auto font-inter text-[#1A1D1E] iox:left-1/2 iox:-translate-x-1/2 top-1/2 -translate-y-1/2">
          ...
          <p className="sm:text-[32px] mymob:text-[33.5px] capitalize  myiphone:text-[34.5px] tablet:text-[39px] desktop:text-[43.5px] iox:text-[50px] font-bold sm:leading-10 tablet:leading-11 desktop:leading-13.5 desktop:w-[964px] iox:w-[1140px] ">
            Only Make One Trip for the Ultimate Grocery Delivery Solution
          </p>
          <p className="sm:text-base tablet:text-[16.5px] font-[400] sm:my-2 desktop:my-[10px]">
            {" "}
            Experience the ultimate convenience with Enatega’s grocery ordering
            app.
          </p>
        </div>
      </div>
      ...
      >
        <img
          ...
          alt=""
          className="sm:w-[260px] mymob:w-[335px] myiphone:w-[365px] sm:h-[560px] mymob:h-[480px] myiphone:h-[450px] tablet:w-[708px] tablet:h-[260px] desktop:h-[280px] desktop:w-[964px] iox:w-[1180px]  mx-auto  rounded-xl "
        />
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 ">
          <p className="text-white font-[400] font-inter sm:text-base tablet:text-[17px] sm:w-[200px] mymob:w-[255px] myiphone:w-[285px] tablet:w-[650px] desktop:w-[542px] iox:w-[640px]">
            Grocery shopping has evolved, and so has the demand for efficient
            delivery services. Enatega stands out as a powerful multi-vendor
            platform tailored not only for food delivery but also as an
            excellent grocery delivery solution. With its adaptable features,
            Enatega empowers businesses to thrive in the competitive grocery
            market. Plus, the current version of Enatega already includes the
            option to deliver groceries but it can be further customized to turn
            it into a complete grocery ordering and delivery platform!
          </p>
        </div>
      </motion.div>
      ...
      {/*  Customizable Grocery Delivering Software*/}
      <motion.div
        variants={fadeIn("up", 0.2, "in")}
        initial="hidden"
        whileInView="show"
      ...
      >
        <div className="desktop:hidden">
          <img
            src="/Pictures/groceryCart.jpg"
            alt=""
            className="mymob:w-[251px] myiphone:w-[288px] tablet:w-[545px] h-auto mx-auto sm:mt-2 desktop:mt-0"
          />
        </div>
        <div className="desktop:w-[457px] iox:w-[645px] h-auto">
          ...
          <p className="text-[#222222] sm:text-base  iox:text-[17px]  mt-[12px] mb-[20px] leading-5.5 font-[400]  desktop:w-[90%]">
            Enatega allows businesses to develop a unique grocery shopping app
            solution that aligns with their branding and customer needs. Whether
            you’re an independent grocery store or an entrepreneur aiming to
            create a network of vendors, the platform streamlines the entire
            process of order management, inventory tracking, and delivery
            logistics. With its intuitive interface, Enatega provides grocery
            shopping software that connects customers to a diverse range of
            grocery products effortlessly.
          </p>
          <Link
            to="/contactus"
          ...
          >
            {" "}
            Get Started with our grocery ordering app solution
          </Link>
        </div>
        <div className="sm:hidden desktop:flex desktop:w-[450px] iox:w-[545px] h-auto">
          <img
            src="/Pictures/giftCart.jpg"
            alt=""
            className=" desktop:w-[354px] iox:w-[420px] h-auto"
          />
        </div>
      </motion.div>
      {/* End  Customizable Grocery Delivering Software*/}

      {/* Section  Grocery Ordering at Your Fingertips*/}
      <div className="mx-auto relative   ">
        ...
        >
          <p className="font-inter sm:text-[28px] tablet:text-[31px] desktop:text-[33px] iox:text-[35px] text-[#1A1D1E] leading-7.5 sm:w-[250px] mymob:w-[305px] myiphone:w-[355px] tablet:w-[699px] desktop:w-[800px] iox:w-[950px] font-bold mx-auto">
            Grocery Ordering at Your Fingertips
          </p>
          <p className="text-[#222222] sm:mt-2 tablet:mt-3 font-[400] font-inter sm:text-base tablet:text-[17px] sm:w-[250px]  mymob:w-[305px]  myiphone:w-[355px] tablet:w-[699px]  desktop:w-[800px] iox:w-[950px] mx-auto leading-[1.3rem]">
            As more consumers seek the convenience of online shopping, on-demand
            grocery shopping apps have become essential. Enatega enables you to
            offer a reliable and user-friendly grocery delivery service,
            allowing customers to easily browse and order their groceries from
            the comfort of their homes. By implementing this extensive grocery
            online ordering system, your business can adapt to modern shopping
            habits and maintain a competitive edge.
          </p>
          <Link
            to="/contactus"
      ...
      {/* End Section Grocery Ordering at Your Fingertips */}

      {/*Section "Tailored for Growth and Flexibility" */}
      ...
      <div className="sm:my-10 desktop:my-16 sm:w-[280px] mymob:w-[335px] myiphone:w-[385px] h-auto tablet:w-[728px] desktop:w-[810px] iox:w-[950px] mx-auto rounded-xl  ">
        <motion.div
          ...
          viewport={{ once: true, amount: 0.2 }}
        >
          <p className="font-inter sm:text-[28px] tablet:text-[31px] desktop:text-[33px] iox:text-[35px] text-[#1A1D1E] sm:leading-7.5 desktop:leading-9 desktop:w-[600px] desktop:mx-0 iox:w-[750px] font-bold mx-auto desktop:tracking-wide">
            Tailored for Growth and Flexibility
          </p>
          <p className="text-[#222222] sm:mt-2 tablet:mt-3 font-[400] font-inter sm:text-base tablet:text-[17px]    desktop:w-[800px] iox:w-[850px] desktop:mx-0 mx-auto leading-[1.3rem]">
            Whether you are looking to expand from a traditional food delivery
            service or launching a white label grocery shopping app, Enatega
            provides the adaptability needed for success. The platform’s strong
            infrastructure supports businesses of all sizes, ensuring a smooth
            operational experience for vendors while enhancing customer
            satisfaction.
          </p>
          <p className="text-[#222222] sm:mt-2 tablet:mt-3 font-[400] font-inter sm:text-base tablet:text-[17px]    desktop:w-[800px] iox:w-[850px] desktop:mx-0 mx-auto leading-[1.3rem]">
            Enatega not only helps in optimizing business processes but also
            facilitates compliance with relevant regulations, making it the
            ideal choice for enterprises entering the grocery delivery space.
          </p>
        </motion.div>
      </div>
      ...
      {/* Revolutionize Your Grocery Delivery Experience With Enatega*/}
        ...
        <div className="sm:w-[280px] mymob:w-[335px] myiphone:w-[385px] tablet:w-[728px] desktop:w-[964px] iox:w-[1140px] py-[50px] mx-auto">
          ...
          >
            ...
            <p className="sm:text-base tablet:text-[17px] font-inter text-center mt-[5px] desktop:w-[475px] iox:w-[500px] mx-auto text-[#222222] ">
              Launching a grocery delivery app has never been easier. Here’s
              what makes Enatega your go-to grocery store app provider:
            </p>
          </motion.div>

          {/*  Revolutionize Your Grocery Delivery Experience With Enatega [Part] */}
          <motion.div
            variants={fadeIn("up", 0.2, "in")}
            initial="hidden"
            whileInView="show"
            viewport={{ once: true, amount: 0.2 }}
            className="bg-white shadow-lg rounded-2xl sm:mt-4 tablet:mt-8 sm:p-4 tablet:py-6 iox:py-7 iox:w-[1140px]  mx-auto "
          >
            {/* 1st box */}
            <div className="w-full tablet:w-[96%] tablet:grid tablet:grid-cols-3 mx-auto">
              ...
              <div className="iox:w-[400px]">
                ...
                <div className="flex items-center sm:space-x-3 tablet:space-x-3  my-3 ">
                  ...
                  <div>
                    <p className="text-[#1A1D1E] sm:text-[14px] tablet:text-[14.6px] font-sans font-medium">
                      Complete access to reporting and analytics
                    </p>
                  </div>
                </div>
                {/* 6th end */}
      ...
      {/* End Enabling Your Grocery Delivery Service’s Success With Enatega.....*/}

      {/*Section Enatega's On-Demand Grocery Shopping App Package */}
      ...
      <div className="sm:my-10 desktop:mt-20 sm:w-[280px] mymob:w-[335px] myiphone:w-[385px]  tablet:w-[708px] desktop:w-[820px] iox:w-[1000px] mx-auto rounded-xl   ">
        <div>
          ...
          >
            Enatega's On-Demand Grocery Shopping App Package
          </motion.p>
          ...
          <ul>
            ...
            >
              Enatega’s grocery delivery app delivers a seamless experience for
              customers, allowing them to easily browse products and place
              orders through a user-friendly interface. Features such as
              real-time order tracking, exclusive discounts, and customer
              feedback options ensure a smooth and satisfying shopping
            ...
            <motion.p
              ...
              className="text-[#222222]  font-[400] font-inter sm:text-base tablet:text-[17px]    desktop:w-[800px] iox:w-[980px] leading-[1.3rem]"
            >
              Equip your delivery personnel with Enatega’s dedicated rider app,
              which includes features like a dual-alert system, time management
              tools, access to order history, and accurate address mapping. This
              app guarantees timely and efficient grocery deliveries, empowering
              your team to tackle the unique challenges of grocery delivery
              services.
            </motion.p>
            ...
            <motion.p
              ...
              className="text-[#222222]  font-[400] font-inter sm:text-base tablet:text-[17px]    desktop:w-[800px] iox:w-[980px] leading-[1.3rem]"
            >
              Simplify your grocery delivery operations with Enatega’s
              comprehensive admin dashboard. This centralized tool allows you to
              manage your entire delivery business, including delivery zones,
              schedules, and order statuses, all from one platform. It’s ideal
              for overseeing grocery delivery apps, giving you complete control
            ...
            <motion.p
              ...
              className="text-[#222222]  font-[400] font-inter sm:text-base tablet:text-[17px]    desktop:w-[800px] iox:w-[980px] leading-[1.3rem]"
            >
              For grocery stores and suppliers offering delivery services,
              Enatega’s vendor app serves as a comprehensive solution. It allows
              you to manage orders, update product availability, and keep
              customers informed with real-time status updates, all from a
              single platform. This app is essential for maintaining an
              effective grocery ordering system and ensures smooth communication
          ...
          >
            Why Choose Enatega for Delivering Groceries?
          </motion.p>
          <motion.p
            variants={fadeIn("up", 0.2, "in")}
            initial="hidden"
          ...
          >
            Enatega’s flexibility and comprehensive features make it the go-to
            solution for grocery delivery services. Whether you’re a small local
            grocer or a large grocery chain, Enatega adapts to various business
            models with ease. With functionalities such as real-time tracking,
            customizable delivery options, and streamlined vendor management,
            the platform ensures efficient operations while enhancing the
            customer experience.
          </motion.p>
          <motion.p
            variants={fadeIn("up", 0.2, "in")}
            ...
            className="text-[#222222] font-[400] font-inter sm:text-base tablet:text-[17px]    desktop:w-[800px] iox:w-[980px] leading-[1.3rem]"
          >
            Start your journey for your Grocery empire with Enatega’s
            multivendor solution and unlock new revenue opportunities today!
          </motion.p>
        </div>
      </div>
