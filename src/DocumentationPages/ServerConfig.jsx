...
function ServerConfig() {
  ...
  return (
    <>
      <div className="flex iox:space-x-16 iox:mt-1  biglap:-space-y-56 sm:h-[600px] biglap:h-[630px] ">
        <div
          key="setup"
        ...
        >
          ...
          <section ref={(el) => (sectionRef.current[0] = el)}>
            <h1 className="sm:text-2xl capitalize font-bold text-[#1A1D1E] font-inter  my-4">
              Deploying API to Digital Ocean Server video walk-through
            </h1>
          </section>
          <div className="relative mt-4">
            <iframe
              ...
              src="https://www.youtube.com/embed/auPmHL6XmgY?si=pCPUd6CP4qZfZK7B"
