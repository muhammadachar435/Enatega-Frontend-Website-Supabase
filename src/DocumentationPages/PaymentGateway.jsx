...
function PaymentGateway() {
  ...
  return (
    <>
      <div className="flex iox:space-x-16 iox:mt-1 biglap:-space-y-56 sm:h-[1250px] mymob:h-[1150px] myiphone:h-[1200px] tablet:h-[1140px] biglap:h-[1400px] ">
        <div
          key="setup"
        ...
        >
          ...
          <section ref={(el) => (sectionRef.current[0] = el)}>
            <h1 className="sm:text-2xl capitalize font-bold text-[#1A1D1E] font-inter  my-4">
              Video walkthrough of integrating Stripe Checkout
            </h1>
          </section>
          <div className="relative mt-4">
            <iframe
              ...
              src="https://www.youtube.com/embed/3iK2eArMzDQ?si=SnikM0ZzArCFOKPz"
          ...
          <p className="my-6 text-gray-500 text-center ">
            Enatega Multivendor | Configuring Stripe
          </p>
          ...
          <p className="font-inter text-left text-[#0C0C0C] text-[18px] tablet:w-[728px] desktop:w-[639px] biglap:w-[1000px] my-4 ">
            You must register for Paypal and paste your Client ID and Client
            Secret credentials in the configurations area of the admin
            dashboard.
          </p>
          <div className="relative mt-4">
            <iframe
              loading="lazy"
              className="sm:w-[285px] sm:h-[300px] mymob:w-[335px] myiphone:w-[381px] myiphone:h-[350px] tablet:w-[690px] desktop:w-[635px]  tablet:h-[360px] biglap:w-[1000px] biglap:h-[460px] h-full max-h-[950px]"
              src="https://www.youtube.com/embed/MQ6pBiQ2KUk?si=V1XgHU52eBx3hTOk"
              title="YouTube video player"
              allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
            ></iframe>
          </div>
          ...
          <p className="my-6 text-gray-500 text-center ">
            Enatega Multivendor | Configuring Paypal
          </p>
        </div>
        {/* end content  */}
