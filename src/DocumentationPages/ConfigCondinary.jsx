...
function ConfigCondinary() {
  ...
  return (
    <>
      <div className="flex iox:space-x-16 iox:mt-1 biglap:-space-y-56 sm:h-[1000px] mymob:h-[950px] myiphone:h-[1050px] tablet:h-[1080px] biglap:h-[1320px] ">
        <div
          key="setup"
        ...
        >
          ...
          <div className="relative mt-4">
            <iframe
              ...
              src="https://www.youtube.com/embed/GOmnM83Awds?si=yStGG9nzwsm3T5Ro"
              title="YouTube video player"
              allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
            ></iframe>
          </div>

          <p className="my-6 text-gray-500 text-center ">Cloudinary Overview</p>
          ...
          <div className="relative mt-4">
            <iframe
              loading="lazy"
              className="sm:w-[285px] sm:h-[300px] mymob:w-[335px] myiphone:w-[381px] myiphone:h-[350px] tablet:w-[690px] desktop:w-[635px]  tablet:h-[360px] biglap:w-[1000px] biglap:h-[460px] h-full max-h-[950px]"
              src="https://www.youtube.com/embed/1XoRLWcqAlw?si=08NXpIpogazJQBvp"
              title="YouTube video player"
              allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
            ></iframe>
          </div>
...
export default ConfigCondinary;
