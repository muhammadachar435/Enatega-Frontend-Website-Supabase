...
function Customer() {
  return (
    <>
      <div className="iox:mt-1 biglap:-space-y-56 iox:px-3 biglap:px-32 sm:h-[2965px] mymob:h-[2850px] myiphone:h-[2780px] tablet:h-[2955px] desktop:h-[3085px] iox:h-[2970px] biglap:h-[3800px] ">
        <div
        ...
        >
          ...
          <div className="bg-[#F6F7F9] text-lg flex items-start gap-2 p-2 text-[#0C0C0C] font-inter iox:w-[700px]  biglap:mx-auto">
          ...
          <ul className="list-disc font-[500] my-2 font-inter text-[16px] px-8  text-[#0C0C0C] biglap:mx-0 ">
            ...
            <ul className="list-decimal font-[500] my-2 font-inter text-[16px] tablet:px-0 text-[#0C0C0C] biglap:mx-0 ">
              ...
              <li>
                To run the enatega-multivendor-Customer, open it in the
                integrated terminal by:
              </li>
              <ul className="list-disc font-[500] my-2 font-inter text-[16px] tablet:px-8 text-[#0C0C0C]  biglap:w-full ">
                <li>
          ...
          <div className="bg-[#F6F7F9] text-base flex items-start gap-2 text-[#1A1E1A]  font-mono my-4 iox:w-[700px] biglap:w-full  biglap:mx-auto">
            <p className="py-2 sm:px-[6px] tablet:px-6 iox:px-8 ">{`  cd enatega-multivendor-Customer`}</p>
          </div>
          {/* End 6th Section */}
          ...
          {/* 6th Section List */}
          <ul className="list-disc font-[500] my-2 font-inter text-[16px] sm:px-8 tablet:px-16 text-[#0C0C0C] ">
            <li>
          ...
          <div className="bg-[#F6F7F9] text-lg flex flex-col items-start gap-2 sm:px-2 tablet:px-4 py-4 text-[#0C0C0C] font-inter iox:w-[700px] biglap:w-full biglap:mx-auto">
            <span className="flex space-x-2">
              <IoWarningSharp className="text-yellow-600 w-6 h-[22px] flex-shrink-0" />
              <span className="font-bold ">Note:</span>
            </span>

            <p>
              The “Continue with Google” feature may not work in the Expo Go app
              due to certain limitations. The package react-native-google-signin
              used for Google login does not work on Expo managed projects. For
              a seamless experience, and to easily run the app in the Expo Go
              app and Expo simulator, we have removed it. “Continue with Google”
              is available in production. <br />
              Reference:{" "}
              <a
