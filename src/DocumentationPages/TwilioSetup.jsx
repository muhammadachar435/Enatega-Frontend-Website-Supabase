...
function TwilioSetup() {
  ...
  return (
    <>
      <div className="flex iox:space-x-16 iox:px-3 iox:mt-1  biglap:-space-y-56 sm:h-[500px] myiphone:h-[540px] biglap:h-[670px] ">
        <div
          key="setup"
        ...
        >
          ...
          <div className="relative mt-4">
            <iframe
              ...
              src="https://www.youtube.com/embed/9gKxLjfwUWw?si=IndUnhalUvu_I0jC"
          ...
          <p className="my-6 text-gray-500 text-center ">
            Enatega Multivendor | Twillio Setup
          </p>
        </div>
