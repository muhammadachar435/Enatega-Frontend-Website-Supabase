function Nodemail() {
  return (
    <>
      <div className="flex iox:space-x-16 iox:px-3 iox:mt-1  biglap:-space-y-56 sm:h-[460px] myiphone:h-[520px] tablet:h-[530px] biglap:h-[630px] ">
        <div
          key="setup"
        ...
        >
          ...
          <div className="relative mt-4">
            <iframe
              ...
              src="https://www.youtube.com/embed/T5sBTxc1QtM?si=Oi_pjwqIzyyizqJ5"
          ...
          <p className="my-6 text-gray-500 text-center ">
            Enatega Multivendor | Nodemailer Setup
          </p>
        </div>
